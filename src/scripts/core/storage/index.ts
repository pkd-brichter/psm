...
interface StorageDriver {
  isSupported: () => boolean;
  create: (initialData: any, suggestedName?: string) => Promise<{ data: any; context: any }>;
...
export async function createDatabase(initialData: any): Promise<{ data: any; context: any }> {
