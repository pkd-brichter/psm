...
function injectToastStyles(): void {
  ...
  style.textContent = `
    ...
    .toast {
      ...
      box-shadow: var(--shadow-2, 0 8px 24px rgba(16, 24, 40, 0.12));
      opacity: 0;
