(function(){"use strict";let N=null,t=null,W=!1,$="memory";const re="https://cdn.jsdelivr.net/npm/@sqlite.org/sqlite-wasm@3.46.1-build1/sqlite-wasm/jswasm/",w="gps_active_point";function q(e,n=50,s=500){const a=Number(e);return!Number.isFinite(a)||a<=0?n:Math.min(Math.max(1,Math.floor(a)),s)}function Se(e){if(typeof e!="string")return null;try{return JSON.parse(e)}catch(n){return console.warn("Failed to parse payload JSON",n),null}}function le(e=t){e&&e.exec(`
  ...
  `)}function U(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`km_${Date.now()}_${Math.random().toString(16).slice(2)}`}function de(e){return e?{id:String(e.id),kultur:e.kultur!=null?String(e.kultur):"",anbau:e.anbau??null,problem:e.problem??null,mittelName:e.mittel_name!=null?String(e.mittel_name):"",kennr:e.kennr??null,wirkstoff:e.wirkstoff??null,eppoCode:e.eppo_code??null,bbchDefault:e.bbch_default??null,bbch:e.bbch??null,wartezeit:e.wartezeit??null,aufwandWert:e.aufwand_wert??null,aufwandEinheit:e.aufwand_einheit??null,aufwandBezug:e.aufwand_bezug??null,maxAnwendungen:e.max_anwendungen??null,bemerkung:e.bemerkung??null,istPsm:e.ist_psm?1:0,istKupfer:e.ist_kupfer?1:0,sortOrder:e.sort_order!=null?Number(e.sort_order):0,createdAt:e.created_at||null,updatedAt:e.updated_at||null}:null}async function De(){if(!t)throw new Error("Database not initialized");D();const e=[];return t.exec({sql:`SELECT kultur, anbau, COUNT(*) AS anzahl,
         ...
         VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`);for(const l of i)r.bind([String(l.id),String(l.kultur??""),l.anbau??null,l.problem??null,String(l.mittel_name??""),l.kennr??null,l.wirkstoff??null,l.eppo_code??null,l.bbch_default??null,l.bbch??null,l.wartezeit??null,l.aufwand_wert??null,l.aufwand_einheit??null,l.aufwand_bezug??null,l.max_anwendungen??null,l.bemerkung??null,l.ist_psm!=null?Number(l.ist_psm):1,l.ist_kupfer!=null?Number(l.ist_kupfer):0,l.sort_order!=null?Number(l.sort_order):0,l.created_at||n,l.updated_at||n]),r.step(),r.reset();r.finalize(),t.exec("COMMIT"),s.kulturMittel=i.length}catch(r){throw t.exec("ROLLBACK"),r}}return s}async function xe(){if(!t)throw new Error("Database not initialized");D();const e=[];return t.exec({sql:`SELECT mittel_name, kennr, MAX(wirkstoff) AS wirkstoff,
          ...
          ORDER BY mittel_name COLLATE NOCASE`,rowMode:"object",callback:n=>{e.push({name:n.mittel_name!=null?String(n.mittel_name):"",kennr:n.kennr??null,wirkstoff:n.wirkstoff??null,einheit:n.einheit??null})}}),{rows:e}}function K(e=t){e&&e.exec(`
  ...
  `)}function Ee(e){return e?{id:String(e.id),flaecheTyp:e.flaeche_typ??null,flaecheId:e.flaeche_id!=null?String(e.flaeche_id):null,kultur:e.kultur??null,eppoCode:e.eppo_code??null,status:e.status??"geplant",pflanzDatum:e.pflanz_datum??null,ernteDatum:e.ernte_datum??null,ernteVon:e.ernte_von??null,ernteBis:e.ernte_bis??e.ernte_datum??null,color:e.color??null,notes:e.notes??null,createdAt:e.created_at||null,updatedAt:e.updated_at||null}:null}function _e(e){return e?{id:String(e.id),flaecheTyp:e.flaeche_typ??null,flaecheId:e.flaeche_id!=null?String(e.flaeche_id):null,anbauId:e.anbau_id??null,art:e.art??"sonstiges",status:e.status??"geplant",planDatum:e.plan_datum??null,erledigtDatum:e.erledigt_datum??null,menge:e.menge!=null?Number(e.menge):null,einheit:e.einheit??null,mittel:e.mittel??null,historyId:e.history_id!=null?Number(e.history_id):null,notes:e.notes??null,createdAt:e.created_at||null,updatedAt:e.updated_at||null}:null}async function qe(e={}){if(!t)throw new Error("Database not initialized");B();const n=[],s=[];e.flaecheTyp&&(n.push("flaeche_typ = ?"),s.push(String(e.flaecheTyp))),e.flaecheId&&(n.push("flaeche_id = ?"),s.push(String(e.flaecheId))),e.status&&(n.push("status = ?"),s.push(String(e.status)));const a="SELECT * FROM anbau_kultur"+(n.length?" WHERE "+n.join(" AND "):"")+" ORDER BY COALESCE(pflanz_datum, created_at) ASC",i=[];return t.exec({sql:a,bind:s,rowMode:"object",callback:r=>i.push(Ee(r))}),{rows:i}}async function Be(e={}){if(!t)throw new Error("Database not initialized");B();const n=String(e.id||U()),s=new Date().toISOString(),a=[String(e.flaecheTyp||""),String(e.flaecheId||""),e.kultur!=null?String(e.kultur):null,e.eppoCode!=null?String(e.eppoCode):null,String(e.status||"geplant"),e.pflanzDatum!=null?String(e.pflanzDatum):null,e.ernteDatum!=null?String(e.ernteDatum):null,e.ernteVon!=null?String(e.ernteVon):null,e.ernteBis!=null?String(e.ernteBis):null,e.color!=null?String(e.color):null,e.notes!=null?String(e.notes):null];if(t.selectValue("SELECT 1 FROM anbau_kultur WHERE id = ? LIMIT 1",[n])){const l=t.prepare("UPDATE anbau_kultur SET flaeche_typ=?, flaeche_id=?, kultur=?, eppo_code=?, status=?, pflanz_datum=?, ernte_datum=?, ernte_von=?, ernte_bis=?, color=?, notes=?, updated_at=? WHERE id=?");l.bind([...a,s,n]),l.step(),l.finalize()}else{const l=t.prepare("INSERT INTO anbau_kultur (flaeche_typ, flaeche_id, kultur, eppo_code, status, pflanz_datum, ernte_datum, ernte_von, ernte_bis, color, notes, created_at, updated_at, id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");l.bind([...a,s,s,n]),l.step(),l.finalize()}let r=null;return t.exec({sql:"SELECT * FROM anbau_kultur WHERE id = ? LIMIT 1",bind:[n],rowMode:"object",callback:l=>{r||(r=Ee(l))}}),r}async function He(e={}){if(!t)throw new Error("Database not initialized");B(),P();const n=String(e.id??"").trim();if(!n)throw new Error("ID fehlt.");const s=t.prepare("UPDATE massnahme SET anbau_id = NULL WHERE anbau_id = ?");s.bind([n]),s.step(),s.finalize();const a=t.prepare("DELETE FROM anbau_kultur WHERE id = ?");return a.bind([n]),a.step(),a.finalize(),{success:!0}}async function Ge(e={}){if(!t)throw new Error("Database not initialized");P();const n=[],s=[];e.flaecheTyp&&(n.push("flaeche_typ = ?"),s.push(String(e.flaecheTyp))),e.flaecheId&&(n.push("flaeche_id = ?"),s.push(String(e.flaecheId))),e.anbauId&&(n.push("anbau_id = ?"),s.push(String(e.anbauId))),e.art&&(n.push("art = ?"),s.push(String(e.art))),e.status&&(n.push("status = ?"),s.push(String(e.status))),e.from&&(n.push("COALESCE(plan_datum, erledigt_datum) >= ?"),s.push(String(e.from))),e.to&&(n.push("COALESCE(plan_datum, erledigt_datum) <= ?"),s.push(String(e.to)));const a="SELECT * FROM massnahme"+(n.length?" WHERE "+n.join(" AND "):"")+" ORDER BY COALESCE(plan_datum, erledigt_datum, created_at) ASC",i=[];return t.exec({sql:a,bind:s,rowMode:"object",callback:r=>i.push(_e(r))}),{rows:i}}async function je(e={}){if(!t)throw new Error("Database not initialized");P();const n=String(e.id||U()),s=new Date().toISOString(),a=o=>o!=null&&Number.isFinite(Number(o))?Number(o):null,i=[String(e.flaecheTyp||""),String(e.flaecheId||""),e.anbauId!=null?String(e.anbauId):null,String(e.art||"sonstiges"),String(e.status||"geplant"),e.planDatum!=null?String(e.planDatum):null,e.erledigtDatum!=null?String(e.erledigtDatum):null,a(e.menge),e.einheit!=null?String(e.einheit):null,e.mittel!=null?String(e.mittel):null,a(e.historyId),e.notes!=null?String(e.notes):null];if(t.selectValue("SELECT 1 FROM massnahme WHERE id = ? LIMIT 1",[n])){const o=t.prepare("UPDATE massnahme SET flaeche_typ=?, flaeche_id=?, anbau_id=?, art=?, status=?, plan_datum=?, erledigt_datum=?, menge=?, einheit=?, mittel=?, history_id=?, notes=?, updated_at=? WHERE id=?");o.bind([...i,s,n]),o.step(),o.finalize()}else{const o=t.prepare("INSERT INTO massnahme (flaeche_typ, flaeche_id, anbau_id, art, status, plan_datum, erledigt_datum, menge, einheit, mittel, history_id, notes, created_at, updated_at, id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");o.bind([...i,s,s,n]),o.step(),o.finalize()}let l=null;return t.exec({sql:"SELECT * FROM massnahme WHERE id = ? LIMIT 1",bind:[n],rowMode:"object",callback:o=>{l||(l=_e(o))}}),l}async function We(e={}){if(!t)throw new Error("Database not initialized");P();const n=String(e.id??"").trim();if(!n)throw new Error("ID fehlt.");const s=t.prepare("DELETE FROM massnahme WHERE id = ?");return s.bind([n]),s.step(),s.finalize(),{success:!0}}async function $e(){if(!t)throw new Error("Database not initialized");P();const e=new Set;t.exec({sql:"SELECT DISTINCT history_id AS h FROM massnahme WHERE history_id IS NOT NULL",rowMode:"object",callback:o=>{o.h!=null&&e.add(Number(o.h))}});const n=new Set;try{t.exec({sql:"SELECT id FROM gps_points WHERE kind = 'gewaechshaus'",rowMode:"object",callback:o=>n.add(String(o.id))})}catch{}const s=new Map;try{t.exec({sql:"SELECT id, standort_id FROM ackerflaechen WHERE standort_id IS NOT NULL",rowMode:"object",callback:o=>{const u=String(o.standort_id);s.has(u)||s.set(u,[]),s.get(u).push(String(o.id))}})}catch{}const a=[];try{t.exec({sql:"SELECT id, date_iso, kultur, gps_point_id FROM history WHERE gps_point_id IS NOT NULL ORDER BY id ASC",rowMode:"object",callback:o=>a.push(o)})}catch{return{imported:0,skipped:0,total:0}}let i=0,r=0;const l=new Date().toISOString();for(const o of a){const u=Number(o.id);if(e.has(u))continue;const c=o.gps_point_id!=null?String(o.gps_point_id):"";let g=null,E=null;if(c&&n.has(c)?(g="haus",E=c):c&&s.has(c)&&s.get(c).length===1&&(g="acker",E=s.get(c)[0]),!g){r++;continue}const p=U(),S=t.prepare("INSERT INTO massnahme (flaeche_typ, flaeche_id, anbau_id, art, status, plan_datum, erledigt_datum, menge, einheit, mittel, history_id, notes, created_at, updated_at, id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");S.bind([g,E,null,"chemisch_psm","erledigt",null,o.date_iso||null,null,null,null,u,o.kultur!=null?String(o.kultur):null,l,l,p]),S.step(),S.finalize(),e.add(u),i++}return{imported:i,skipped:r,total:a.length}}function H(e=t){e&&e.exec(`
  ...
  `)}function Y(e){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`${e}_${Date.now()}_${Math.random().toString(16).slice(2)}`}async function Qe(e={}){if(!t)throw new Error("Database not initialized");G();const{favoritesOnly:n=!1,limit:s=100}=e,a=n?"WHERE is_favorite = 1":"",i=[];return t.exec({sql:`SELECT id, code, name, language, dtcode, usage_count, is_favorite, created_at, updated_at
          FROM saved_eppo_codes
          ${a}
          ORDER BY is_favorite DESC, usage_count DESC, name ASC
          LIMIT ?`,bind:[s],rowMode:"object",callback:r=>i.push({id:r.id,code:r.code,name:r.name,language:r.language,dtcode:r.dtcode,usageCount:r.usage_count,isFavorite:!!r.is_favorite,createdAt:r.created_at,updatedAt:r.updated_at})}),{items:i}}async function Ze(e={}){if(!t)throw new Error("Database not initialized");G();const n=String(e.code??"").trim(),s=String(e.name??"").trim();if(!n||!s)throw new Error("EPPO-Code und Name sind erforderlich.");const a=e.id||Y("eppo"),i=e.language||null,r=e.dtcode||null,l=e.isFavorite?1:0,o=new Date().toISOString(),u=t.selectValue("SELECT id FROM saved_eppo_codes WHERE code = ? LIMIT 1",[n]);if(u){const c=t.prepare(`
    ...
    `);return c.bind([s,i,r,l,o,n]),c.step(),c.finalize(),{id:u,code:n,name:s,updated:!0}}else{const c=t.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, 0, ?, ?, ?)
    `);return c.bind([a,n,s,i,r,l,o,o]),c.step(),c.finalize(),{id:a,code:n,name:s,created:!0}}}async function et(e={}){if(!t)throw new Error("Database not initialized");G();const n=String(e.id??"").trim();if(!n)throw new Error("ID erforderlich.");const s=t.prepare("DELETE FROM saved_eppo_codes WHERE id = ?");return s.bind([n]),s.step(),s.finalize(),{success:!0}}async function tt(e={}){if(!t)throw new Error("Database not initialized");G();const n=String(e.code??"").trim(),s=String(e.name??"").trim();if(!n)return{success:!1};const a=new Date().toISOString();if(t.selectValue("SELECT id FROM saved_eppo_codes WHERE code = ? LIMIT 1",[n])){const r=t.prepare(`
    ...
    `);r.bind([a,n]),r.step(),r.finalize()}else if(s){const r=Y("eppo"),l=t.prepare(`
      INSERT INTO saved_eppo_codes (id, code, name, language, dtcode, usage_count, is_favorite, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, 1, 0, ?, ?)
    `);l.bind([r,n,s,e.language||null,e.dtcode||null,a,a]),l.step(),l.finalize()}return{success:!0}}async function nt(e={}){if(!t)throw new Error("Database not initialized");j();const{favoritesOnly:n=!1,limit:s=100}=e,a=n?"WHERE is_favorite = 1":"",i=[];return t.exec({sql:`SELECT id, code, label, principal_stage, secondary_stage, usage_count, is_favorite, created_at, updated_at
          FROM saved_bbch_stages
          ${a}
          ORDER BY is_favorite DESC, usage_count DESC, code ASC
          LIMIT ?`,bind:[s],rowMode:"object",callback:r=>i.push({id:r.id,code:r.code,label:r.label,principalStage:r.principal_stage,secondaryStage:r.secondary_stage,usageCount:r.usage_count,isFavorite:!!r.is_favorite,createdAt:r.created_at,updatedAt:r.updated_at})}),{items:i}}async function at(e={}){if(!t)throw new Error("Database not initialized");j();const n=String(e.code??"").trim(),s=String(e.label??"").trim();if(!n||!s)throw new Error("BBCH-Code und Bezeichnung sind erforderlich.");const a=e.id||Y("bbch"),i=e.principalStage!=null?Number(e.principalStage):null,r=e.secondaryStage!=null?Number(e.secondaryStage):null,l=e.isFavorite?1:0,o=new Date().toISOString(),u=t.selectValue("SELECT id FROM saved_bbch_stages WHERE code = ? LIMIT 1",[n]);if(u){const c=t.prepare(`
    ...
    `);return c.bind([s,i,r,l,o,n]),c.step(),c.finalize(),{id:u,code:n,label:s,updated:!0}}else{const c=t.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, 0, ?, ?, ?)
    `);return c.bind([a,n,s,i,r,l,o,o]),c.step(),c.finalize(),{id:a,code:n,label:s,created:!0}}}async function it(e={}){if(!t)throw new Error("Database not initialized");j();const n=String(e.id??"").trim();if(!n)throw new Error("ID erforderlich.");const s=t.prepare("DELETE FROM saved_bbch_stages WHERE id = ?");return s.bind([n]),s.step(),s.finalize(),{success:!0}}async function st(e={}){if(!t)throw new Error("Database not initialized");j();const n=String(e.code??"").trim(),s=String(e.label??"").trim();if(!n)return{success:!1};const a=new Date().toISOString();if(t.selectValue("SELECT id FROM saved_bbch_stages WHERE code = ? LIMIT 1",[n])){const r=t.prepare(`
    ...
    `);r.bind([a,n]),r.step(),r.finalize()}else if(s){const r=Y("bbch"),l=t.prepare(`
      INSERT INTO saved_bbch_stages (id, code, label, principal_stage, secondary_stage, usage_count, is_favorite, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, 1, 0, ?, ?)
    `);l.bind([r,n,s,e.principalStage||null,e.secondaryStage||null,a,a]),l.step(),l.finalize()}return{success:!0}}async function rt(e={}){if(!t)throw new Error("Database not initialized");G();const n=e.limit||10,s=[];return t.exec({sql:`SELECT code, name, language, dtcode, usage_count, is_favorite
          FROM saved_eppo_codes
          WHERE usage_count > 0
          ORDER BY usage_count DESC, name ASC
          LIMIT ?`,bind:[n],rowMode:"object",callback:a=>s.push({code:a.code,name:a.name,language:a.language,dtcode:a.dtcode,usageCount:a.usage_count,isFavorite:!!a.is_favorite})}),{items:s}}async function lt(e={}){if(!t)throw new Error("Database not initialized");j();const n=e.limit||10,s=[];return t.exec({sql:`SELECT code, label, principal_stage, secondary_stage, usage_count, is_favorite
          FROM saved_bbch_stages
          WHERE usage_count > 0
          ORDER BY usage_count DESC, code ASC
          LIMIT ?`,bind:[n],rowMode:"object",callback:a=>s.push({code:a.code,label:a.label,principalStage:a.principal_stage,secondaryStage:a.secondary_stage,usageCount:a.usage_count,isFavorite:!!a.is_favorite})}),{items:s}}function z(e,n,s=t){if(!s||!e)return;const a=s.prepare("INSERT OR REPLACE INTO meta (key, value) VALUES (?, ?)");a.bind([e,typeof n=="string"?n:JSON.stringify(n)]).step(),a.finalize()}function ge(e,n=t){if(!n||!e)return;const s=n.prepare("DELETE FROM meta WHERE key = ?");s.bind([e]).step(),s.finalize()}function x(e,n=t){return!n||!e?null:n.selectValue("SELECT value FROM meta WHERE key = ?",[e])??null}function Te(e){if(!N)throw new Error("SQLite not initialized");const n=new N.oo1.DB(":memory:"),s=N.wasm.scopedAllocPush();try{const a=N.wasm.allocFromTypedArray(e),i=N.wasm.allocCString("main"),r=(N.capi.SQLITE_DESERIALIZE_FREEONCLOSE||0)|(N.capi.SQLITE_DESERIALIZE_RESIZEABLE||0),l=N.capi.sqlite3_deserialize(n.pointer,i,a,e.byteLength,e.byteLength,r);if(l!==N.capi.SQLITE_OK)throw n.close(),new Error(`sqlite3_deserialize failed: ${N.capi.sqlite3_js_rc_str(l)||l}`)}finally{N.wasm.scopedAllocPop(s)}return n}self.onmessage=async function(e){const{id:n,action:s,payload:a}=e.data;try{let i;switch(s){case"init":i=await ot(a);break;case"importSnapshot":i=await ct(a);break;case"exportSnapshot":i=await dt();break;case"upsertMedium":i=await mt(a);break;case"deleteMedium":i=await Et(a);break;case"listMediums":i=await _t();break;case"listMediumsPaged":i=await gt(a);break;case"listHistory":i=await ht(a);break;case"listHistoryPaged":i=await fe(a);break;case"streamHistoryChunk":i=await ft(a);break;case"exportHistoryRange":i=await bt(a);break;case"getHistoryEntry":i=await qt(a);break;case"appendHistoryEntry":i=await Bt(a);break;case"deleteHistoryEntry":i=await Ht(a);break;case"deleteHistoryRange":i=await St(a);break;case"vacuumDatabase":i=await Nt();break;case"setArchiveLogs":i=await Lt(a);break;case"listArchiveLogs":i=await At(a);break;case"insertArchiveLog":i=await Rt(a);break;case"appendImportLog":i=await It(a);break;case"listImportLog":i=await Ot(a);break;case"appendFoto":i=await kt(a);break;case"listFotos":i=await Ct(a);break;case"getFotoData":i=await Xt(a);break;case"exportFotos":i=await xt();break;case"deleteFoto":i=await Ft(a);break;case"updateFoto":i=await wt(a);break;case"setFotoThumb":i=await Mt(a);break;case"getFotoCounts":i=await yt();break;case"deleteFotosByIds":i=await Dt(a);break;case"bulkUpdateFotoKategorie":i=await vt(a);break;case"exportFotosByIds":i=await zt(a);break;case"clearFotos":i=await Ut();break;case"deleteArchiveLog":i=await Pt(a);break;case"exportDB":i=await Gt();break;case"importDB":i=await jt(a);break;case"importLookupEppo":i=await Wt(a);break;case"importLookupBbch":i=await $t(a);break;case"searchEppoCodes":i=await Vt(a);break;case"searchBbchStages":i=await Jt(a);break;case"listLookupLanguages":i=Yt();break;case"getLookupStats":i=await Qt();break;case"listGpsPoints":i=await Ie();break;case"listGpsPointsPaged":i=await Oe(a);break;case"upsertGpsPoint":i=await ke(a);break;case"deleteGpsPoint":i=await Ce(a);break;case"setActiveGpsPointId":i=await Me(a);break;case"getActiveGpsPointId":i=await ye();break;case"listKulturen":i=await De();break;case"listKulturMittel":i=await ve(a);break;case"upsertKulturMittel":i=await ze(a);break;case"deleteKulturMittel":i=await we(a);break;case"seedInitialData":i=await Xe(a);break;case"listLagerBewegungen":i=await Ve(a);break;case"upsertLagerBewegung":i=await Ke(a);break;case"deleteLagerBewegung":i=await Ye(a);break;case"getLagerUebersicht":i=await Je();break;case"listMittelStammdaten":i=await xe();break;case"listAckerflaechen":i=await Fe();break;case"upsertAckerflaeche":i=await Ue(a);break;case"deleteAckerflaeche":i=await Pe(a);break;case"listAnbau":i=await qe(a);break;case"upsertAnbau":i=await Be(a);break;case"deleteAnbau":i=await He(a);break;case"listMassnahmen":i=await Ge(a);break;case"upsertMassnahme":i=await je(a);break;case"deleteMassnahme":i=await We(a);break;case"importPsmAsMassnahmen":i=await $e();break;case"listSavedEppo":i=await Qe(a);break;case"upsertSavedEppo":i=await Ze(a);break;case"deleteSavedEppo":i=await et(a);break;case"incrementEppoUsage":i=await tt(a);break;case"listSavedBbch":i=await nt(a);break;case"upsertSavedBbch":i=await at(a);break;case"deleteSavedBbch":i=await it(a);break;case"incrementBbchUsage":i=await st(a);break;case"getFrequentEppo":i=await rt(a);break;case"getFrequentBbch":i=await lt(a);break;default:throw new Error(`Unknown action: ${s}`)}self.postMessage({id:n,ok:!0,result:i})}catch(i){self.postMessage({id:n,ok:!1,error:i.message||String(i)})}};async function ot(e={}){if(W)return{success:!0,message:"Already initialized"};try{N=await(await import(re+"sqlite3.mjs").then(a=>a.default))({print:console.log,printErr:console.error,locateFile:a=>re+a});const s=e.mode||ut();return t=he(s),$=s,ae(),await ie(),W=!0,{success:!0,mode:s,message:`Database initialized in ${s} mode`}}catch(n){throw console.error("Failed to initialize database:",n),new Error(`Database initialization failed: ${n.message}`)}}function ut(){return typeof N?.opfs<"u"?"opfs":"memory"}function he(e="memory"){return e==="opfs"&&N?.opfs?new N.oo1.OpfsDb("/pflanzenschutz.sqlite"):new N.oo1.DB}function ae(e=t){if(!e)throw new Error("Database not initialized");e.exec(`
  ...
  `)}async function ie(){if(!t)throw new Error("Database not initialized");(t.selectValue("PRAGMA user_version")||0)===0&&t.exec(`
    ...
    `);let n=t.selectValue("PRAGMA user_version")||0;const s=!L(t,"mediums","zulassungsnummer");if(s||n<4){console.log("Migrating database to version 4..."),t.exec("BEGIN TRANSACTION");try{s&&Ne(t),t.exec("PRAGMA user_version = 4"),t.exec("COMMIT")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 4 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,n<5){console.log("Migrating database to version 5..."),t.exec("BEGIN TRANSACTION");try{X(t),t.exec("PRAGMA user_version = 5"),t.exec("COMMIT")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 5 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"gps_points")||n<6){console.log("Migrating database to version 6..."),t.exec("BEGIN TRANSACTION");try{v(t),t.exec("PRAGMA user_version = 6"),t.exec("COMMIT")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 6 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"medium_profiles")||!k(t,"medium_profile_mediums")||n<7){console.log("Migrating database to version 7..."),t.exec("BEGIN TRANSACTION");try{le(t),t.exec("PRAGMA user_version = 7"),t.exec("COMMIT")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 7 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"archive_logs")||n<8){console.log("Migrating database to version 8..."),t.exec("BEGIN TRANSACTION");try{F(t);const m=x("archives",t);if(m)try{const I=JSON.parse(m),h=Array.isArray(I?.logs)?I.logs:[];h.length&&Z(h,t)}catch(I){console.warn("Archiv-Logs konnten nicht migriert werden",I)}t.exec("PRAGMA user_version = 8"),t.exec("COMMIT")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 8 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!L(t,"mediums","wartezeit")||!L(t,"mediums","wirkstoff")||n<9){console.log("Migrating database to version 9 (QS columns)..."),t.exec("BEGIN TRANSACTION");try{V(t),t.exec("PRAGMA user_version = 9"),t.exec("COMMIT")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 9 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!L(t,"history","ersteller")||n<10){console.log("Migrating database to version 10 (normalized history)..."),t.exec("BEGIN TRANSACTION");try{const m=[{name:"ersteller",type:"TEXT"},{name:"standort",type:"TEXT"},{name:"kultur",type:"TEXT"},{name:"eppo_code",type:"TEXT"},{name:"bbch",type:"TEXT"},{name:"datum",type:"TEXT"},{name:"date_iso",type:"TEXT"},{name:"uhrzeit",type:"TEXT"},{name:"usage_type",type:"TEXT"},{name:"area_ha",type:"REAL"},{name:"area_ar",type:"REAL"},{name:"area_sqm",type:"REAL"},{name:"water_volume",type:"REAL"},{name:"invekos",type:"TEXT"},{name:"gps",type:"TEXT"},{name:"gps_latitude",type:"REAL"},{name:"gps_longitude",type:"REAL"},{name:"gps_point_id",type:"TEXT"},{name:"qs_maschine",type:"TEXT"},{name:"qs_schaderreger",type:"TEXT"},{name:"qs_verantwortlicher",type:"TEXT"},{name:"qs_wetter",type:"TEXT"},{name:"qs_behandlungsart",type:"TEXT"}];for(const d of m)L(t,"history",d.name)||t.exec(`ALTER TABLE history ADD COLUMN ${d.name} ${d.type}`);const I=[{name:"medium_name",type:"TEXT"},{name:"medium_unit",type:"TEXT"},{name:"method_id",type:"TEXT"},{name:"method_label",type:"TEXT"},{name:"medium_value",type:"REAL"},{name:"calculated_total",type:"REAL"},{name:"zulassungsnummer",type:"TEXT"},{name:"wartezeit",type:"INTEGER"},{name:"wirkstoff",type:"TEXT"},{name:"input_area_ha",type:"REAL"},{name:"input_area_ar",type:"REAL"},{name:"input_area_sqm",type:"REAL"},{name:"input_water_volume",type:"REAL"}];for(const d of I)L(t,"history_items",d.name)||t.exec(`ALTER TABLE history_items ADD COLUMN ${d.name} ${d.type}`);t.exec(`
      ...
      `);const h=[];if(t.exec({sql:"SELECT id, header_json FROM history WHERE header_json IS NOT NULL",rowMode:"object",callback:d=>h.push(d)}),h.length>0){console.log(`Migrating ${h.length} history entries to normalized format...`);const d=t.prepare(`
          UPDATE history SET
            ...
            qs_behandlungsart = ?
          WHERE id = ?
        `);for(const _ of h)try{const T=JSON.parse(_.header_json||"{}"),f=T.gpsCoordinates||{};d.bind([T.ersteller||null,T.standort||null,T.kultur||null,T.eppoCode||null,T.bbch||null,T.datum||null,T.dateIso||null,T.uhrzeit||null,T.usageType||null,T.areaHa??null,T.areaAr??null,T.areaSqm??null,T.waterVolume??null,T.invekos||null,T.gps||null,f.latitude??null,f.longitude??null,T.gpsPointId||null,T.qsMaschine||null,T.qsSchaderreger||null,T.qsVerantwortlicher||null,T.qsWetter||null,T.qsBehandlungsart||null,_.id]).step(),d.reset()}catch(T){console.warn(`Could not migrate history entry ${_.id}:`,T)}d.finalize()}const R=[];if(t.exec({sql:"SELECT id, payload_json FROM history_items WHERE payload_json IS NOT NULL",rowMode:"object",callback:d=>R.push(d)}),R.length>0){console.log(`Migrating ${R.length} history items to normalized format...`);const d=t.prepare(`
          UPDATE history_items SET
            ...
            input_water_volume = ?
          WHERE id = ?
        `);for(const _ of R)try{const T=JSON.parse(_.payload_json||"{}"),f=T.inputs||{};d.bind([T.name||null,T.unit||null,T.methodId||null,T.methodLabel||null,T.value??null,T.total??null,T.zulassungsnummer||null,T.wartezeit??null,T.wirkstoff||null,f.areaHa??null,f.areaAr??null,f.areaSqm??null,f.waterVolume??null,_.id]).step(),d.reset()}catch(T){console.warn(`Could not migrate history item ${_.id}:`,T)}d.finalize()}t.exec("PRAGMA user_version = 10"),t.exec("COMMIT"),console.log("Database migrated to version 10 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 10 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!L(t,"history","company_name")||n<11){console.log("Migrating database to version 11 (company data in history)..."),t.exec("BEGIN TRANSACTION");try{const m=[{name:"company_name",type:"TEXT"},{name:"company_address",type:"TEXT"},{name:"company_headline",type:"TEXT"},{name:"company_email",type:"TEXT"}];for(const h of m)L(t,"history",h.name)||t.exec(`ALTER TABLE history ADD COLUMN ${h.name} ${h.type}`);const I=[];if(t.exec({sql:"SELECT id, header_json FROM history WHERE header_json IS NOT NULL AND company_name IS NULL",rowMode:"object",callback:h=>I.push(h)}),I.length>0){console.log(`Migrating ${I.length} history entries for company data...`);const h=t.prepare(`
          UPDATE history SET
            company_name = ?,
            company_address = ?,
            company_headline = ?,
            company_email = ?
          WHERE id = ?
        `);for(const R of I)try{const _=JSON.parse(R.header_json||"{}").company||{};h.bind([_.name||null,_.address||null,_.headline||null,_.contactEmail||null,R.id]).step(),h.reset()}catch(d){console.warn(`Could not migrate company data for history entry ${R.id}:`,d)}h.finalize()}t.exec("PRAGMA user_version = 11"),t.exec("COMMIT"),console.log("Database migrated to version 11 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 11 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!L(t,"gps_points","nutzflaeche_qm")||!L(t,"gps_points","kind")||n<12){console.log("Migrating database to version 12 (gps_points Nutzfläche/Typ)..."),t.exec("BEGIN TRANSACTION");try{v(t),L(t,"gps_points","nutzflaeche_qm")||t.exec("ALTER TABLE gps_points ADD COLUMN nutzflaeche_qm REAL"),L(t,"gps_points","kind")||t.exec("ALTER TABLE gps_points ADD COLUMN kind TEXT"),t.exec("PRAGMA user_version = 12"),t.exec("COMMIT"),console.log("Database migrated to version 12 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 12 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"kultur_mittel")||n<13){console.log("Migrating database to version 13 (kultur_mittel)..."),t.exec("BEGIN TRANSACTION");try{D(t),t.exec("PRAGMA user_version = 13"),t.exec("COMMIT"),console.log("Database migrated to version 13 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 13 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!(k(t,"kultur_mittel")&&L(t,"kultur_mittel","eppo_code"))||n<14){console.log("Migrating database to version 14 (kultur_mittel EPPO/BBCH)..."),t.exec("BEGIN TRANSACTION");try{D(t),k(t,"kultur_mittel")&&!L(t,"kultur_mittel","eppo_code")&&t.exec("ALTER TABLE kultur_mittel ADD COLUMN eppo_code TEXT"),k(t,"kultur_mittel")&&!L(t,"kultur_mittel","bbch_default")&&t.exec("ALTER TABLE kultur_mittel ADD COLUMN bbch_default TEXT"),t.exec("PRAGMA user_version = 14"),t.exec("COMMIT"),console.log("Database migrated to version 14 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 14 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!(k(t,"kultur_mittel")&&L(t,"kultur_mittel","bbch"))||n<15){console.log("Migrating database to version 15 (kultur_mittel BBCH)..."),t.exec("BEGIN TRANSACTION");try{D(t),k(t,"kultur_mittel")&&!L(t,"kultur_mittel","bbch")&&t.exec("ALTER TABLE kultur_mittel ADD COLUMN bbch TEXT"),t.exec("PRAGMA user_version = 15"),t.exec("COMMIT"),console.log("Database migrated to version 15 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 15 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"lager_bewegungen")||n<16){console.log("Migrating database to version 16 (lager_bewegungen)..."),t.exec("BEGIN TRANSACTION");try{H(t),t.exec("PRAGMA user_version = 16"),t.exec("COMMIT"),console.log("Database migrated to version 16 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 16 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"ackerflaechen")||n<17){console.log("Migrating database to version 17 (ackerflaechen)..."),t.exec("BEGIN TRANSACTION");try{K(t),t.exec("PRAGMA user_version = 17"),t.exec("COMMIT"),console.log("Database migrated to version 17 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 17 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"import_log")||n<18){console.log("Migrating database to version 18 (import_log)..."),t.exec("BEGIN TRANSACTION");try{ne(t),t.exec("PRAGMA user_version = 18"),t.exec("COMMIT"),console.log("Database migrated to version 18 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 18 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"fotos")||n<19){console.log("Migrating database to version 19 (fotos)..."),t.exec("BEGIN TRANSACTION");try{y(t),t.exec("PRAGMA user_version = 19"),t.exec("COMMIT"),console.log("Database migrated to version 19 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 19 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,n<20){console.log("Migrating database to version 20 (foto notiz)..."),t.exec("BEGIN TRANSACTION");try{y(t),L(t,"fotos","notiz")||t.exec("ALTER TABLE fotos ADD COLUMN notiz TEXT"),t.exec("PRAGMA user_version = 20"),t.exec("COMMIT"),console.log("Database migrated to version 20 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 20 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,n<21){console.log("Migrating database to version 21 (foto thumbnail)..."),t.exec("BEGIN TRANSACTION");try{y(t),L(t,"fotos","data_thumb")||t.exec("ALTER TABLE fotos ADD COLUMN data_thumb TEXT"),t.exec("CREATE INDEX IF NOT EXISTS idx_fotos_kategorie ON fotos(kategorie, created_at DESC)"),t.exec("PRAGMA user_version = 21"),t.exec("COMMIT"),console.log("Database migrated to version 21 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 21 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,!k(t,"anbau_kultur")||!k(t,"massnahme")||n<22){console.log("Migrating database to version 22 (Kulturführung)..."),t.exec("BEGIN TRANSACTION");try{B(t),P(t),t.exec("PRAGMA user_version = 22"),t.exec("COMMIT"),console.log("Database migrated to version 22 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 22 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,n<23){console.log("Migrating database to version 23 (Ernte-Zeitraum)..."),t.exec("BEGIN TRANSACTION");try{B(t),L(t,"anbau_kultur","ernte_von")||t.exec("ALTER TABLE anbau_kultur ADD COLUMN ernte_von TEXT"),L(t,"anbau_kultur","ernte_bis")||t.exec("ALTER TABLE anbau_kultur ADD COLUMN ernte_bis TEXT"),t.exec("UPDATE anbau_kultur SET ernte_bis = ernte_datum WHERE ernte_bis IS NULL AND ernte_datum IS NOT NULL"),t.exec("PRAGMA user_version = 23"),t.exec("COMMIT"),console.log("Database migrated to version 23 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 23 failed:",m),m}}if(n=t.selectValue("PRAGMA user_version")||0,n<24){console.log("Migrating database to version 24 (client_uuid dedup)..."),t.exec("BEGIN TRANSACTION");try{k(t,"history")&&(L(t,"history","client_uuid")||t.exec("ALTER TABLE history ADD COLUMN client_uuid TEXT"),t.exec("UPDATE history SET client_uuid = json_extract(header_json, '$.clientUuid') WHERE client_uuid IS NULL AND header_json IS NOT NULL"),t.exec("DELETE FROM history WHERE client_uuid IS NOT NULL AND id NOT IN (SELECT MIN(id) FROM history WHERE client_uuid IS NOT NULL GROUP BY client_uuid)"),k(t,"history_items")&&t.exec("DELETE FROM history_items WHERE history_id NOT IN (SELECT id FROM history)"),t.exec("CREATE UNIQUE INDEX IF NOT EXISTS idx_history_client_uuid ON history(client_uuid) WHERE client_uuid IS NOT NULL")),k(t,"fotos")&&(t.exec("DELETE FROM fotos WHERE client_uuid IS NOT NULL AND id NOT IN (SELECT MIN(id) FROM fotos WHERE client_uuid IS NOT NULL GROUP BY client_uuid)"),t.exec("DROP INDEX IF EXISTS idx_fotos_uuid"),t.exec("CREATE UNIQUE INDEX IF NOT EXISTS idx_fotos_uuid ON fotos(client_uuid) WHERE client_uuid IS NOT NULL")),t.exec("PRAGMA user_version = 24"),t.exec("COMMIT"),console.log("Database migrated to version 24 successfully")}catch(m){throw t.exec("ROLLBACK"),console.error("Migration to version 24 failed:",m),m}}}async function ct(e){if(!t)throw new Error("Database not initialized");t.exec("BEGIN TRANSACTION");try{if(Array.isArray(e.history)&&t.exec(`
    ...
    `),e.meta){const s={version:e.meta.version||1,company:JSON.stringify(e.meta.company||{}),defaults:JSON.stringify(e.meta.defaults||{}),fieldLabels:JSON.stringify(e.meta.fieldLabels||{}),measurementMethods:JSON.stringify(e.meta.measurementMethods||[]),archives:JSON.stringify(e.archives||{logs:[]})},a=t.prepare("INSERT OR REPLACE INTO meta (key, value) VALUES (?, ?)");for(const[l,o]of Object.entries(s))a.bind([l,typeof o=="string"?o:JSON.stringify(o)]).step(),a.reset();if(a.finalize(),e.meta.measurementMethods&&Array.isArray(e.meta.measurementMethods)){const l=t.prepare("INSERT OR REPLACE INTO measurement_methods (id, label, type, unit, requires, config) VALUES (?, ?, ?, ?, ?, ?)");for(const o of e.meta.measurementMethods)l.bind([o.id,o.label,o.type,o.unit,JSON.stringify(o.requires||[]),JSON.stringify(o.config||{})]).step(),l.reset();l.finalize()}const i=Array.isArray(e.archives?.logs)?e.archives.logs:[],r=Z(i,t);z("archives",JSON.stringify({logs:r}),t)}if(e.mediums&&Array.isArray(e.mediums)){V(t);const s=t.prepare("INSERT OR REPLACE INTO mediums (id, name, unit, method_id, value, zulassungsnummer, wartezeit, wirkstoff) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");for(const a of e.mediums){const i=a.zulassungsnummer??a.approvalNumber??a.zulassung??null;s.bind([a.id,a.name,a.unit,a.methodId||a.method_id,a.value,i,a.wartezeit??null,a.wirkstoff??null]).step(),s.reset()}s.finalize()}if(e.mediumProfiles&&Array.isArray(e.mediumProfiles)){le(),t.exec("DELETE FROM medium_profile_mediums"),t.exec("DELETE FROM medium_profiles");const s=t.prepare("INSERT INTO medium_profiles (id, name, created_at, updated_at) VALUES (?, ?, ?, ?)"),a=t.prepare("INSERT INTO medium_profile_mediums (profile_id, medium_id, sort_order) VALUES (?, ?, ?)");for(const i of e.mediumProfiles){const r=String(i.id||"").trim();if(!r)continue;const l=String(i.name||"Profil ohne Namen"),o=i.createdAt||i.created_at||new Date().toISOString(),u=i.updatedAt||i.updated_at||o;s.bind([r,l,o,u]).step(),s.reset(),(Array.isArray(i.mediumIds)?i.mediumIds:[]).forEach((g,E)=>{g&&(a.bind([r,String(g),E]).step(),a.reset())})}s.finalize(),a.finalize()}if(e.history&&Array.isArray(e.history)){const s=t.prepare(`
      ...
      `);for(const i of e.history){const r=i.header?{...i.header}:{...i};delete r.items;const l=i.savedAt||r.savedAt||r.createdAt||new Date().toISOString();r.createdAt||(r.createdAt=l);const o=r.gpsCoordinates||{};s.bind([l,r.clientUuid||null,JSON.stringify(r),r.ersteller||null,r.standort||null,r.kultur||null,r.eppoCode||null,r.bbch||null,r.datum||null,r.dateIso||null,r.uhrzeit||null,r.usageType||null,r.areaHa??null,r.areaAr??null,r.areaSqm??null,r.waterVolume??null,r.invekos||null,r.gps||null,o.latitude??null,o.longitude??null,r.gpsPointId||null,r.qsMaschine||null,r.qsSchaderreger||null,r.qsVerantwortlicher||null,r.qsWetter||null,r.qsBehandlungsart||null]).step();const u=(t.selectValue("SELECT changes()")||0)>0,c=u?t.selectValue("SELECT last_insert_rowid()"):null;if(s.reset(),!u)continue;const g=i.items&&Array.isArray(i.items)?i.items:[];for(const E of g){const p=E.inputs||{};a.bind([c,E.mediumId||E.medium_id||E.id||"",JSON.stringify(E),E.name||null,E.unit||null,E.methodId||null,E.methodLabel||null,E.value??null,E.total??null,E.zulassungsnummer||null,E.wartezeit??null,E.wirkstoff||null,p.areaHa??null,p.areaAr??null,p.areaSqm??null,p.waterVolume??null]).step(),a.reset()}}s.finalize(),a.finalize()}return t.exec("COMMIT"),{success:!0,message:"Snapshot imported successfully"}}catch(n){throw t.exec("ROLLBACK"),n}}async function dt(){if(!t)throw new Error("Database not initialized");const e={meta:{version:1,company:{},defaults:{},fieldLabels:{},measurementMethods:[]},mediums:[],mediumProfiles:[],history:[],archives:{logs:[]}};t.exec({sql:"SELECT key, value FROM meta",callback:i=>{const r=i[0],l=i[1];if(!(r&&r.startsWith("lookup:")))try{const o=JSON.parse(l);r==="company"?e.meta.company=o:r==="defaults"?e.meta.defaults=o:r==="fieldLabels"?e.meta.fieldLabels=o:r==="version"?e.meta.version=o:r==="archives"&&(e.archives=o)}catch{}}}),t.exec({sql:"SELECT id, label, type, unit, requires, config FROM measurement_methods",callback:i=>{e.meta.measurementMethods.push({id:i[0],label:i[1],type:i[2],unit:i[3],requires:JSON.parse(i[4]||"[]"),config:JSON.parse(i[5]||"{}")})}}),t.exec({sql:"SELECT id, name, unit, method_id, value, zulassungsnummer, wartezeit, wirkstoff FROM mediums",callback:i=>{e.mediums.push({id:i[0],name:i[1],unit:i[2],methodId:i[3],value:i[4],zulassungsnummer:i[5]||null,wartezeit:i[6]||null,wirkstoff:i[7]||null})}});const n=new Map;t.exec({sql:`SELECT id, name, created_at, updated_at
          ...
          ORDER BY name COLLATE NOCASE`,rowMode:"object",callback:i=>{n.set(i.id,{id:String(i.id),name:String(i.name??""),createdAt:i.created_at||new Date().toISOString(),updatedAt:i.updated_at||new Date().toISOString(),mediumIds:[]})}}),n.size&&t.exec({sql:`SELECT profile_id, medium_id, sort_order
            ...
            ORDER BY profile_id, sort_order, rowid`,rowMode:"object",callback:i=>{const r=n.get(i.profile_id);r&&r.mediumIds.push(String(i.medium_id))}}),e.mediumProfiles=Array.from(n.values());const s=ue();s.length&&(e.archives={logs:s.map(i=>Q(i))});const a=new Map;return t.exec({sql:`SELECT id, created_at, header_json, client_uuid,
            ersteller, standort, kultur, eppo_code, bbch, datum, date_iso,
            uhrzeit, usage_type, area_ha, area_ar, area_sqm, water_volume,
            invekos, gps, gps_latitude, gps_longitude, gps_point_id,
            qs_maschine, qs_schaderreger, qs_verantwortlicher, qs_wetter, qs_behandlungsart
          FROM history ORDER BY created_at DESC`,rowMode:"object",callback:i=>{let r={};try{r=JSON.parse(i.header_json||"{}")}catch(l){console.warn("Could not parse header_json",l)}a.set(i.id,{header:{createdAt:i.created_at,ersteller:i.ersteller??r.ersteller,standort:i.standort??r.standort,kultur:i.kultur??r.kultur,eppoCode:i.eppo_code??r.eppoCode,bbch:i.bbch??r.bbch,datum:i.datum??r.datum,dateIso:i.date_iso??r.dateIso,uhrzeit:i.uhrzeit??r.uhrzeit,usageType:i.usage_type??r.usageType,areaHa:i.area_ha??r.areaHa,areaAr:i.area_ar??r.areaAr,areaSqm:i.area_sqm??r.areaSqm,waterVolume:i.water_volume??r.waterVolume,invekos:i.invekos??r.invekos,gps:i.gps??r.gps,gpsCoordinates:i.gps_latitude!=null&&i.gps_longitude!=null?{latitude:i.gps_latitude,longitude:i.gps_longitude}:r.gpsCoordinates||null,gpsPointId:i.gps_point_id??r.gpsPointId,qsMaschine:i.qs_maschine??r.qsMaschine,qsSchaderreger:i.qs_schaderreger??r.qsSchaderreger,qsVerantwortlicher:i.qs_verantwortlicher??r.qsVerantwortlicher,qsWetter:i.qs_wetter??r.qsWetter,qsBehandlungsart:i.qs_behandlungsart??r.qsBehandlungsart,savedAt:r.savedAt||i.created_at,clientUuid:i.client_uuid??r.clientUuid??null},items:[]})}}),t.exec({sql:`SELECT history_id, medium_id, payload_json,
            ...
            calculated_total, zulassungsnummer, wartezeit, wirkstoff,
            input_area_ha, input_area_ar, input_area_sqm, input_water_volume
          FROM history_items`,rowMode:"object",callback:i=>{const r=i.history_id;if(a.has(r)){let l={};try{l=JSON.parse(i.payload_json||"{}")}catch(o){console.warn("Could not parse payload_json",o)}a.get(r).items.push({id:i.medium_id??l.id,mediumId:i.medium_id??l.mediumId,name:i.medium_name??l.name,unit:i.medium_unit??l.unit,methodId:i.method_id??l.methodId,methodLabel:i.method_label??l.methodLabel,value:i.medium_value??l.value,total:i.calculated_total??l.total,zulassungsnummer:i.zulassungsnummer??l.zulassungsnummer,wartezeit:i.wartezeit??l.wartezeit,wirkstoff:i.wirkstoff??l.wirkstoff,inputs:{areaHa:i.input_area_ha??l.inputs?.areaHa,areaAr:i.input_area_ar??l.inputs?.areaAr,areaSqm:i.input_area_sqm??l.inputs?.areaSqm,waterVolume:i.input_water_volume??l.inputs?.waterVolume}})}}}),e.history=Array.from(a.values()).map(i=>({...i.header,items:i.items})),e}async function mt(e){if(!t)throw new Error("Database not initialized");V();const n=t.prepare("INSERT OR REPLACE INTO mediums (id, name, unit, method_id, value, zulassungsnummer, wartezeit, wirkstoff) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");return n.bind([e.id,e.name,e.unit,e.methodId||e.method_id,e.value,e.zulassungsnummer??e.approvalNumber??e.zulassung??null,e.wartezeit??null,e.wirkstoff??null]).step(),n.finalize(),{success:!0,id:e.id}}async function Et(e){if(!t)throw new Error("Database not initialized");const n=t.prepare("DELETE FROM mediums WHERE id = ?");return n.bind([e]).step(),n.finalize(),{success:!0}}async function _t(){if(!t)throw new Error("Database not initialized");V();const e=[];return t.exec({sql:"SELECT id, name, unit, method_id, value, zulassungsnummer, wartezeit, wirkstoff FROM mediums",callback:n=>{e.push({id:n[0],name:n[1],unit:n[2],methodId:n[3],value:n[4],zulassungsnummer:n[5]||null,wartezeit:n[6]||null,wirkstoff:n[7]||null})}}),e}function pt(e){return e?{id:e.id!=null?String(e.id):"",name:e.name!=null?String(e.name):"",unit:e.unit!=null?String(e.unit):"",methodId:e.method_id!=null?String(e.method_id):e.methodId!=null?String(e.methodId):null,value:Number(e.value??0),zulassungsnummer:e.zulassungsnummer!=null?String(e.zulassungsnummer):e.zulassung!=null?String(e.zulassung):null,wartezeit:e.wartezeit!=null?Number(e.wartezeit):null,wirkstoff:e.wirkstoff!=null?String(e.wirkstoff):null}:null}async function gt(e={}){if(!t)throw new Error("Database not initialized");const{cursor:n=null,limit:s,pageSize:a,search:i,includeTotal:r=!1}=e||{},l=q(a??s,50,500),o=typeof i=="string"?i.trim():"",u=[],c=[];if(o){u.push("(LOWER(name) LIKE LOWER(?) OR LOWER(COALESCE(zulassungsnummer, '')) LIKE LOWER(?))");const d=`%${o}%`;c.push(d,d)}const g=n&&Number.isFinite(Number(n.rowid))?Number(n.rowid):null,E=[...u],p=[...c];g!==null&&(E.push("rowid > ?"),p.push(g));const S=E.length?`WHERE ${E.join(" AND ")}`:"",b=t.prepare(`SELECT rowid AS cursor_rowid, id, name, unit, method_id, value, zulassungsnummer
     FROM mediums
     ${S}
     ORDER BY rowid ASC
     LIMIT ?`);b.bind([...p,l+1]);const O=[];for(;b.step();)O.push(b.getAsObject());b.finalize();const A=O.length>l,C=A?O.slice(0,l):O,m=C.map(d=>pt(d)).filter(d=>d!==null),I=C.length?C[C.length-1]:null,h=A&&I?{rowid:Number(I.cursor_rowid)||Number(I.rowid||0)}:null;let R;if(r){const d=u.length?`WHERE ${u.join(" AND ")}`:"",_=t.prepare(`SELECT COUNT(*) AS total FROM mediums ${d}`);if(c.length&&_.bind(c),_.step()){const T=_.getAsObject();R=Number(T?.total)||0}else R=0;_.finalize()}return{items:m,nextCursor:h,hasMore:A,pageSize:l,totalCount:R}}function J(e={}){const n=`COALESCE(
    ...
    )`,params:[i,i,r]}}async function ht({page:e=1,pageSize:n=50,filters:s={},sortDirection:a="desc"}={}){if(!t)throw new Error("Database not initialized");const i=String(a).toLowerCase()==="asc"?"ASC":"DESC",r=q(n,50,500),l=Number.isFinite(Number(e))?Math.max(1,Number(e)):1,o=(l-1)*r,{historyDateExpr:u,whereSql:c,whereParams:g}=J(s),E=[],p={sql:`
      SELECT id, created_at, header_json
      FROM history
      ${c}
      ORDER BY datetime(${u}) ${i}, rowid ${i}
      LIMIT ${r} OFFSET ${o}
    `,callback:b=>{const O=JSON.parse(b[2]||"{}");E.push({id:b[0],...O})}};g.length&&(p.bind=[...g]),t.exec(p);const S=t.selectValue(`SELECT COUNT(*) FROM history ${c}`,g.length?[...g]:void 0);return{items:E,page:l,pageSize:r,totalCount:Number(S)||0,totalPages:Math.ceil((Number(S)||0)/r)}}async function fe({cursor:e=null,pageSize:n=50,filters:s={},sortDirection:a="desc",includeItems:i=!1,includeTotal:r=!1}={}){if(!t)throw new Error("Database not initialized");const l=String(a).toLowerCase()==="asc"?"ASC":"DESC",o=q(n,50,500),u=o+1,{historyDateExpr:c,whereSql:g,whereParams:E}=J(s),p=Tt(e,c,l),S=[],b=[];g?.trim()&&(S.push(g.replace(/^\s*WHERE\s+/i,"")),E.length&&b.push(...E)),p&&(S.push(p.clause),b.push(...p.params));const O=S.length>0?`WHERE ${S.join(" AND ")}`:"",A=[];t.exec({sql:`
      SELECT
        history.id AS id,
    ...
    `,bind:[...b,u],rowMode:"object",callback:d=>A.push(d)});const C=A.length>o,m=C?A.slice(0,-1):A;let I=null;if(C&&m.length){const d=m[m.length-1];I={id:d.id,createdAt:d.cursor_created_at||d.created_at||new Date().toISOString()}}const h=m.map(d=>{let _={};try{_=JSON.parse(d.header_json||"{}")}catch(f){console.warn("Konnte History-Header nicht parsen",f)}const T={company:{name:d.company_name??_.company?.name??null,address:d.company_address??_.company?.address??null,headline:d.company_headline??_.company?.headline??null,contactEmail:d.company_email??_.company?.contactEmail??null},id:d.id,createdAt:d.created_at,ersteller:d.ersteller??_.ersteller,standort:d.standort??_.standort,kultur:d.kultur??_.kultur,eppoCode:d.eppo_code??_.eppoCode,bbch:d.bbch??_.bbch,datum:d.datum??_.datum,dateIso:d.date_iso??_.dateIso,uhrzeit:d.uhrzeit??_.uhrzeit,usageType:d.usage_type??_.usageType,areaHa:d.area_ha??_.areaHa,areaAr:d.area_ar??_.areaAr,areaSqm:d.area_sqm??_.areaSqm,waterVolume:d.water_volume??_.waterVolume,invekos:d.invekos??_.invekos,gps:d.gps??_.gps,gpsCoordinates:d.gps_latitude!=null&&d.gps_longitude!=null?{latitude:d.gps_latitude,longitude:d.gps_longitude}:_.gpsCoordinates||null,gpsPointId:d.gps_point_id??_.gpsPointId,qsMaschine:d.qs_maschine??_.qsMaschine,qsSchaderreger:d.qs_schaderreger??_.qsSchaderreger,qsVerantwortlicher:d.qs_verantwortlicher??_.qsVerantwortlicher,qsWetter:d.qs_wetter??_.qsWetter,qsBehandlungsart:d.qs_behandlungsart??_.qsBehandlungsart,savedAt:_.savedAt||d.created_at,clientUuid:d.client_uuid??_.clientUuid??null};return i&&(T.items=[]),T});if(i&&h.length){const d=h.map(f=>f.id),_=d.map(()=>"?").join(","),T=new Map;t.exec({sql:`
      ...
      `,bind:d,rowMode:"object",callback:f=>{const se=f.history_id;T.has(se)||T.set(se,[]);let M={};try{M=JSON.parse(f.payload_json||"{}")}catch(Zt){console.warn("Konnte History-Item nicht parsen",Zt)}T.get(se).push({id:f.medium_id??M.id,mediumId:f.medium_id??M.mediumId,name:f.medium_name??M.name,unit:f.medium_unit??M.unit,methodId:f.method_id??M.methodId,methodLabel:f.method_label??M.methodLabel,value:f.medium_value??M.value,total:f.calculated_total??M.total,zulassungsnummer:f.zulassungsnummer??M.zulassungsnummer,wartezeit:f.wartezeit??M.wartezeit,wirkstoff:f.wirkstoff??M.wirkstoff,inputs:{areaHa:f.input_area_ha??M.inputs?.areaHa,areaAr:f.input_area_ar??M.inputs?.areaAr,areaSqm:f.input_area_sqm??M.inputs?.areaSqm,waterVolume:f.input_water_volume??M.inputs?.waterVolume}})}}),h.forEach(f=>{f.items=T.get(f.id)||[]})}let R;return r&&(R=Number(t.selectValue(`SELECT COUNT(*) FROM history ${g||""}`,E.length?[...E]:void 0))||0),{items:h,nextCursor:I,pageSize:o,sortDirection:l==="ASC"?"asc":"desc",hasMore:C,totalCount:R}}async function ft(e={}){if(!t)throw new Error("Database not initialized");const{pageSize:n,chunkSize:s,includeItems:a=!0,includeTotal:i=!1,...r}=e||{},l=q(s??n??100,100,1e3);return await fe({pageSize:l,includeItems:a,includeTotal:i,...r})}async function bt({filters:e={},limit:n=5e3,sortDirection:s="asc"}={}){if(!t)throw new Error("Database not initialized");const a=Number.isFinite(Number(n))?Math.min(Math.max(Number(n),1),1e4):5e3,i=String(s).toLowerCase()==="desc"?"DESC":"ASC",{historyDateExpr:r,whereSql:l,whereParams:o}=J(e),u=[],c=[],g=`
    ...
    LIMIT ?
  `,E=o.length?[...o,a]:[a];return t.exec({sql:g,bind:E,rowMode:"object",callback:p=>{try{const S=JSON.parse(p.header_json||"{}"),b=JSON.parse(p.items_json||"[]"),O=Array.isArray(b)?b.map(A=>{if(A==null)return null;if(typeof A=="string")try{return JSON.parse(A)}catch(C){return console.warn("Konnte History-Item nicht parsen",C),null}return A}).filter(A=>A!==null):[];c.push(p.history_id),u.push({...S,items:O})}catch(S){console.warn("Archiv-Export konnte nicht gelesen werden",S)}}}),{entries:u,historyIds:c}}async function St({filters:e={}}={}){if(!t)throw new Error("Database not initialized");const{whereSql:n,whereParams:s}=J(e);t.exec("BEGIN TRANSACTION");try{const a={sql:`DELETE FROM history ${n}`};return s.length&&(a.bind=[...s]),t.exec(a),t.exec("COMMIT"),{success:!0}}catch(a){throw t.exec("ROLLBACK"),a}}async function Nt(){if(!t)throw new Error("Database not initialized");return t.exec("VACUUM"),{success:!0}}async function Lt(e={}){if(!t)throw new Error("Database not initialized");const n=Array.isArray(e.logs)?e.logs:[];t.exec("BEGIN TRANSACTION");try{const s=Z(n,t);return z("archives",JSON.stringify({logs:s}),t),t.exec("COMMIT"),{success:!0,count:s.length}}catch(s){throw t.exec("ROLLBACK"),s}}async function At({limit:e=50,cursor:n=null,sortDirection:s="desc"}={}){if(!t)throw new Error("Database not initialized");F();const a=String(s).toLowerCase()==="asc"?"ASC":"DESC",i=Math.min(Math.max(Number(e)||1,1),500),r=i+1,l=(()=>{if(!n||!n.archivedAt)return null;const b=a==="ASC"?">":"<",O=b,A=String(n.archivedAt),C=n.id?String(n.id):"";return{clause:`(
        datetime(archived_at) ${b} datetime(?)
        OR (datetime(archived_at) = datetime(?) AND id ${O} ?)
      )`,params:[A,A,C]}})(),o=[],u=[];l&&(o.push(l.clause),u.push(...l.params));const c=o.length?`WHERE ${o.join(" AND ")}`:"",g=[];t.exec({sql:`SELECT id, archived_at, start_date, end_date, entry_count, file_name, storage_hint, note, metadata_json
          FROM archive_logs
          ${c}
          ORDER BY datetime(archived_at) ${a}, id ${a}
          LIMIT ?`,bind:[...u,r],rowMode:"object",callback:b=>g.push(b)});let E=null;const p=g.length>i;if(p){const b=g.pop();b&&(E={id:String(b.id),archivedAt:b.archived_at})}return{items:g.map(b=>ee(b)).filter(b=>!!b),nextCursor:E,hasMore:p,pageSize:i,sortDirection:a}}async function Rt(e={}){if(!t)throw new Error("Database not initialized");F();const n=oe(e);if(!n)throw new Error("Ungültiger Archiv-Eintrag");const s=t.prepare(`INSERT OR REPLACE INTO archive_logs
      (id, archived_at, start_date, end_date, entry_count, file_name, storage_hint, note, metadata_json)
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`);try{a.bind([n,s,e.entryUuid!=null?String(e.entryUuid):null,e.kategorie!=null?String(e.kategorie):null,e.titel!=null?String(e.titel):null,e.standort!=null?String(e.standort):null,e.kultur!=null?String(e.kultur):null,e.gpsLatitude??null,e.gpsLongitude??null,e.notiz!=null?String(e.notiz):null,e.device!=null?String(e.device):null,e.mime!=null?String(e.mime):"image/jpeg",e.width??null,e.height??null,e.bytes??null,String(e.data),e.thumb!=null?String(e.thumb):null]).step(),a.finalize()}catch(r){try{a.finalize()}catch{}if(n&&/UNIQUE|constraint/i.test(String(r&&r.message))){const l=t.selectValue("SELECT id FROM fotos WHERE client_uuid = ? LIMIT 1",[n]);if(l!=null)return{id:l,duplicate:!0}}throw r}return{id:t.selectValue("SELECT last_insert_rowid()"),duplicate:!1}}async function Ct(e={}){if(!t)throw new Error("Database not initialized");y();const n=Math.min(Math.max(Number(e?.limit)||200,1),1e5),s=[];return t.exec({sql:`SELECT id, client_uuid, created_at, entry_uuid, kategorie, titel,
          ...
          FROM fotos WHERE id IN (${s}) ORDER BY created_at ASC, id ASC`,bind:n,rowMode:"object",callback:i=>{a.push({clientUuid:i.client_uuid,createdAt:i.created_at,entryUuid:i.entry_uuid,kategorie:i.kategorie,titel:i.titel,standort:i.standort,kultur:i.kultur,gpsLatitude:i.gps_latitude,gpsLongitude:i.gps_longitude,notiz:i.notiz,device:i.device,mime:i.mime,width:i.width,height:i.height,bytes:i.bytes,data:i.data})}}),{items:a}}async function wt(e={}){if(!t)throw new Error("Database not initialized");y();const n=e&&e.id!=null?Number(e.id):null;if(n==null)throw new Error("Foto-ID fehlt");const s=[],a=[],i=(l,o)=>{if(Object.prototype.hasOwnProperty.call(e,l)){s.push(`${o} = ?`);const u=e[l];a.push(u==null||u===""?null:u)}};if(i("titel","titel"),i("kategorie","kategorie"),i("kultur","kultur"),i("standort","standort"),i("notiz","notiz"),i("gpsLatitude","gps_latitude"),i("gpsLongitude","gps_longitude"),!s.length)return{success:!0};a.push(n);const r=t.prepare(`UPDATE fotos SET ${s.join(", ")} WHERE id = ?`);return r.bind(a).step(),r.finalize(),{success:!0}}async function Xt(e={}){if(!t)throw new Error("Database not initialized");y();const n=e&&e.id!=null?Number(e.id):null;if(n==null)return{data:null};let s=null,a="image/jpeg";return t.exec({sql:"SELECT data, mime FROM fotos WHERE id = ? LIMIT 1",bind:[n],rowMode:"object",callback:i=>{s=i.data??null,a=i.mime||"image/jpeg"}}),{data:s,mime:a}}async function xt(){if(!t)throw new Error("Database not initialized");y();const e=[];return t.exec({sql:`SELECT client_uuid, created_at, entry_uuid, kategorie, titel, standort,
                 kultur, gps_latitude, gps_longitude, notiz, device, mime, width, height, bytes, data
          FROM fotos ORDER BY created_at ASC, id ASC`,rowMode:"object",callback:n=>{e.push({clientUuid:n.client_uuid,createdAt:n.created_at,entryUuid:n.entry_uuid,kategorie:n.kategorie,titel:n.titel,standort:n.standort,kultur:n.kultur,gpsLatitude:n.gps_latitude,gpsLongitude:n.gps_longitude,notiz:n.notiz,device:n.device,mime:n.mime,width:n.width,height:n.height,bytes:n.bytes,data:n.data})}}),{items:e}}async function Ft(e={}){if(!t)throw new Error("Database not initialized");y();const n=e&&e.id!=null?Number(e.id):null;if(n==null)throw new Error("Foto-ID fehlt");const s=t.prepare("DELETE FROM fotos WHERE id = ?");return s.bind([n]).step(),s.finalize(),{success:!0}}async function Ut(){if(!t)throw new Error("Database not initialized");y();const e=t.selectValue("SELECT COUNT(*) FROM fotos")||0;return t.exec("DELETE FROM fotos"),{success:!0,deleted:Number(e)}}async function Pt(e={}){if(!t)throw new Error("Database not initialized");F();const n=e&&e.id?String(e.id):"";if(!n)throw new Error("Archiv-Log-ID fehlt");const s=t.prepare("DELETE FROM archive_logs WHERE id = ?");return s.bind([n]).step(),s.finalize(),ce(),{success:!0}}async function qt(e){if(!t)throw new Error("Database not initialized");let n=null;if(t.exec({sql:`SELECT id, created_at, header_json,
            ersteller, standort, kultur, eppo_code, bbch, datum, date_iso,
            uhrzeit, usage_type, area_ha, area_ar, area_sqm, water_volume,
            invekos, gps, gps_latitude, gps_longitude, gps_point_id,
            qs_maschine, qs_schaderreger, qs_verantwortlicher, qs_wetter, qs_behandlungsart,
  ...
  `,c="UPPER(IFNULL(language, '')) = ?",g=h=>{r&&h.push(i)};if(!n){const h=r?`WHERE ${c}`:"",R=[];g(R),R.push(s,a),t.exec({sql:`${u}
        ${h}
        ORDER BY name
        LIMIT ? OFFSET ?
      `,bind:R,callback:f=>{l.push({code:f[0],name:f[1],dtcode:f[2]||null,language:f[3]||null,dtLabel:f[4]||null,languageLabel:f[5]||null,authority:f[6]||null,nameDe:f[7]||null,nameEn:f[8]||null,nameLa:f[9]||null})}});const d=r?`SELECT COUNT(*) FROM lookup_eppo_codes WHERE ${c}`:"SELECT COUNT(*) FROM lookup_eppo_codes",_=[];g(_);const T=Number(t.selectValue(d,_))||0;return{rows:l,total:T}}const E=n.toUpperCase(),p=`%${E}%`,S=["(code LIKE ? OR UPPER(name) LIKE ? OR UPPER(IFNULL(name_de, '')) LIKE ?)"];r&&S.push(c);const b=`WHERE ${S.join(" AND ")}`,O=[p,p,p];g(O);const A=Number(t.selectValue(`SELECT COUNT(*) FROM lookup_eppo_codes ${b}`,O))||0,C=[p,p,p];g(C);const m=[`${E}%`,p],I=[s,a];return t.exec({sql:`${u}
      ${b}
      ORDER BY CASE WHEN code LIKE ? THEN 0 ELSE 1 END,
               CASE WHEN UPPER(IFNULL(name_de, '')) LIKE ? THEN 0 ELSE 1 END,
               name
      LIMIT ? OFFSET ?
    `,bind:[...C,...m,...I],callback:h=>{l.push({code:h[0],name:h[1],dtcode:h[2]||null,language:h[3]||null,dtLabel:h[4]||null,languageLabel:h[5]||null,authority:h[6]||null,nameDe:h[7]||null,nameEn:h[8]||null,nameLa:h[9]||null})}}),{rows:l,total:A}}function Kt(e={}){const n=(e.query||"").trim(),s=Math.min(Math.max(Number(e.limit)||10,1),50),a=Math.max(Number(e.offset)||0,0),i=[],r=be(),l=`(${r}) AS german_lookup`;if(!n){t.exec({sql:`
        SELECT code, name, dtcode, language, dt_label, language_label, authority, name_de, name_en, name_la
        FROM ${l}
        ORDER BY name
        LIMIT ? OFFSET ?
      `,bind:[s,a],callback:p=>{p&&i.push({code:p[0],name:p[1],dtcode:p[2]||null,language:p[3]||"DE",dtLabel:p[4]||null,languageLabel:p[5]||"Deutsch",authority:p[6]||null,nameDe:p[7]||null,nameEn:p[8]||null,nameLa:p[9]||null})}});const E=Number(t.selectValue(`SELECT COUNT(*) FROM (${r}) AS german_lookup`))||0;return{rows:i,total:E}}const o=n.toUpperCase(),u=`%${o}%`,c=Number(t.selectValue(`SELECT COUNT(*) FROM ${l} WHERE code LIKE ? OR UPPER(name) LIKE ?`,[u,u]))||0,g=[u,u,`${o}%`,s,a];return t.exec({sql:`
      SELECT code, name, dtcode, language, dt_label, language_label, authority, name_de, name_en, name_la
      FROM ${l}
      WHERE code LIKE ? OR UPPER(name) LIKE ?
      ORDER BY CASE WHEN code LIKE ? THEN 0 ELSE 1 END, name
      LIMIT ? OFFSET ?
    `,bind:g,callback:E=>{E&&i.push({code:E[0],name:E[1],dtcode:E[2]||null,language:E[3]||"DE",dtLabel:E[4]||null,languageLabel:E[5]||"Deutsch",authority:E[6]||null,nameDe:E[7]||null,nameEn:E[8]||null,nameLa:E[9]||null})}}),{rows:i,total:c}}function Yt(){if(!t)throw new Error("Database not initialized");X(t);const e=[];t.exec({sql:`
      SELECT
