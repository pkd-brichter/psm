...
import{M as ce,N as Ms,J as it,O as To,P as qo,Q as Cs,h as Bt,l as Ho,a as Is,s as mt,n as Ro,q as Bs,p as Li,e as U,r as Rn,C as On,u as Qe,_ as Dt,R as Oo,S as _o,w as v,t as N,m as Di,T as Wo,j as hn,k as $i,U as Ko,V as jo,W as Ue,X as Go,Y as Fs,Z as Ns,H as Ts,G as _n,$ as Uo,a0 as Vo,a1 as Zo,a2 as Qo,a3 as Jo,a4 as rn,z as Ja,a5 as Yo,x as Xo,a6 as at,a7 as nt,a8 as el,a9 as sn,aa as tl,ab as al,D as nl,ac as qs,ad as Hs,ae as Ya,af as rl,ag as il,ah as sl,ai as zi,aj as fr,ak as gr,al as ol,am as ll,an as cl,ao as dl,ap as ul,aq as pl,ar as ml,as as Rs,at as fl,au as Os,av as gl,aw as Jr,ax as $r,ay as Pn,az as Yr,aA as bl,aB as hl,aC as Wn,aD as Ai,aE as vl,aF as Pi,aG as Ia,aH as Mi,aI as yl,aJ as Ci,aK as Ii,aL as kl,aM as wl,aN as xl,aO as Sl,aP as zr,v as _s,i as El,b as Ll,c as Dl}from"./index.D1c2XijN.js";const Ar="__psl_history_seeded",Pr=200,Bi=["Salat","Apfel","Wein","Tomate","Kartoffel","Hopfen","Raps","Birne"],Fi=["Spritzung","Düngung","Pflege","Behandlung"],Ni=["LACES","MALDO","VITVI","SOLTU","PRNUS","CUPAR","CYNCR","ALLCE"],Ti=["BBCH 10","BBCH 31","BBCH 41","BBCH 55","BBCH 65","BBCH 71","BBCH 81"],$l=[{mediumId:"seed-water",name:"Wasser",unit:"L",methodId:"perKiste",methodLabel:"pro Kiste",value:.02,zulassungsnummer:"N/A"},{mediumId:"seed-tonikum",name:"Tonikum X",unit:"ml",methodId:"perKiste",methodLabel:"pro Kiste",value:.85,zulassungsnummer:"Z-123456"},{mediumId:"seed-oel",name:"Pflegeöl Y",unit:"ml",methodId:"percentWater",methodLabel:"% vom Wasser",value:.12,zulassungsnummer:"Z-654321"}];function zl(e){if(typeof window>"u")return;const a=new URLSearchParams(window.location.search).has("seedHistory");if(!a)return;const n=window;n.__PSL||(n.__PSL={});const r=n.__PSL;r.seedHistoryEntries=(o=Pr)=>qi(e,{count:o}),r.resetHistorySeedFlag=()=>localStorage.removeItem(Ar),!a&&!localStorage.getItem(Ar)&&ce()==="sqlite"&&qi(e,{count:Pr,setFlag:!0}).catch(o=>{console.error("History seeding failed",o)})}async function Al(e){if(!e.state.getState().app?.hasDatabase){if(typeof e.state.subscribe!="function")throw new Error("SQLite-Datenbank ist noch nicht initialisiert.");await new Promise((t,a)=>{const n=window.setTimeout(()=>{s(),a(new Error("SQLite-Datenbank wurde nicht rechtzeitig initialisiert."))},1e4),r=e.state.subscribe?.(o=>{o.app?.hasDatabase&&(s(),t())}),s=()=>{window.clearTimeout(n),typeof r=="function"&&r()}})}}async function qi(e,t={}){const a=t.count??Pr;if(ce()!=="sqlite")throw new Error("SQLite-Treiber muss aktiv sein, bevor Daten befüllt werden können.");await Al(e);const n=performance.now();let r=0;for(let s=0;s<a;s+=1){const o=Pl(s);await Ms(o),r+=1}try{await it()}catch(s){console.warn("Seed-Daten konnten nicht persistent gespeichert werden",s)}return e.events.emit("history:data-changed",{source:"dev-history-seed"}),t.setFlag&&localStorage.setItem(Ar,"1"),{inserted:r,durationMs:performance.now()-n}}function Pl(e){const t=new Date;t.setDate(t.getDate()-e);const a=t.toLocaleDateString("de-DE"),n=t.toISOString(),r=20+e%30,s=Number((r*.5).toFixed(2));return{datum:a,dateIso:n,ersteller:`Seeder ${1+e%5}`,standort:`Test-Ort ${String.fromCharCode(65+e%6)}`,kultur:Bi[e%Bi.length],usageType:Fi[e%Fi.length],kisten:r,eppoCode:Ni[e%Ni.length],bbch:Ti[e%Ti.length],gps:`GPS-Notiz ${e}`,gpsCoordinates:{latitude:48+e%10*.01,longitude:11+e%10*.01},gpsPointId:`seed-gps-${e}`,invekos:`INV-${String(1e3+e).padStart(4,"0")}`,uhrzeit:`${String(6+e%12).padStart(2,"0")}:${String(e*7%60).padStart(2,"0")}`,savedAt:n,items:Ml(e,r,s)}}function Ml(e,t,a){return $l.map((n,r)=>{const s=1+(e+r)%4*.05,o=Number((n.value*s).toFixed(4)),l=Number((o*t).toFixed(2));return{id:`seed-item-${e}-${r}`,name:n.name,unit:n.unit,methodLabel:n.methodLabel,methodId:n.methodId,value:o,total:l,inputs:{kisten:t,waterVolume:a},zulassungsnummer:n.zulassungsnummer,mediumId:n.mediumId}})}let ea=null,Ba=null,Hi=!1,Ri=!1;async function Cl(){if(!("serviceWorker"in navigator))return console.warn("[PWA] Service Workers nicht unterstützt"),null;try{return Ba=await navigator.serviceWorker.register("/psm/sw.js",{scope:"/psm/",updateViaCache:"none"}),console.log("[PWA] Service Worker registriert:",Ba.scope),Ba.addEventListener("updatefound",()=>{const e=Ba?.installing;e&&e.addEventListener("statechange",()=>{e.state==="installed"&&navigator.serviceWorker.controller&&(console.log("[PWA] Neues Update verfügbar"),wa("pwa:update-available"))})}),navigator.serviceWorker.addEventListener("message",Il),Hi||(Hi=!0,navigator.serviceWorker.addEventListener("controllerchange",()=>{Ri||(Ri=!0,window.location.reload())})),Ba}catch(e){return console.error("[PWA] Service Worker Registrierung fehlgeschlagen:",e),null}}function Il(e){const{type:t,payload:a}=e.data||{};switch(t){case"DB_STATE":wa("pwa:db-state",a);break;case"CACHES_CLEARED":wa("pwa:caches-cleared");break}}async function tr(e){if(!navigator.serviceWorker.controller){localStorage.setItem("psm-db-state",JSON.stringify({...e,updatedAt:new Date().toISOString()}));return}navigator.serviceWorker.controller.postMessage({type:"SET_DB_STATE",payload:e})}async function Ws(){const e=localStorage.getItem("psm-db-state");if(e)try{return JSON.parse(e)}catch{}return navigator.serviceWorker?.controller?new Promise(t=>{const a=n=>{n.data?.type==="DB_STATE"&&(navigator.serviceWorker.removeEventListener("message",a),t(n.data.payload))};navigator.serviceWorker.addEventListener("message",a),navigator.serviceWorker.controller.postMessage({type:"GET_DB_STATE"}),setTimeout(()=>{navigator.serviceWorker.removeEventListener("message",a),t(null)},1e3)}):null}async function Bl(){const e=await Ws();return!!(e?.hasDatabase&&e?.autoStartEnabled)}function Fl(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),ea=e,console.log("[PWA] Install Prompt verfügbar"),localStorage.getItem("psm-app-installed")==="true"&&(console.log("[PWA] Widerspruch erkannt: Flag sagt installiert, aber Prompt verfügbar"),localStorage.removeItem("psm-app-installed"),console.log("[PWA] Veraltetes Installations-Flag entfernt")),wa("pwa:install-available")}),window.addEventListener("appinstalled",()=>{ea=null,nr(),console.log("[PWA] App installiert - Flag gesetzt"),wa("pwa:installed")})}function ar(){return ea!==null}function na(){return window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Xr(){const e=navigator.userAgent.toLowerCase();return e.includes("edg/")?"edge":e.includes("chrome")&&!e.includes("edg")?"chrome":e.includes("firefox")?"firefox":e.includes("safari")&&!e.includes("chrome")?"safari":"other"}function ei(){return!!(na()||localStorage.getItem("psm-app-installed")==="true"||window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia("(display-mode: minimal-ui)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches)}async function Ks(){if(ei())return!0;try{if("getInstalledRelatedApps"in navigator){const e=await navigator.getInstalledRelatedApps();if(console.log("[PWA] getInstalledRelatedApps result:",e),e&&e.length>0)return nr(),!0}}catch(e){console.warn("[PWA] getInstalledRelatedApps API Fehler:",e)}return!1}function nr(){localStorage.setItem("psm-app-installed","true"),console.log("[PWA] App als installiert markiert")}function Nl(){localStorage.removeItem("psm-app-installed"),console.log("[PWA] Installations-Flag entfernt")}function js(){const e=Xr(),t=na(),a=ei();return{canInstall:ar(),isInstalled:a&&!t,isStandalone:t,browser:e,showBanner:!t}}async function Gs(){const e=Xr(),t=na(),a=await Ks();return{canInstall:ar(),isInstalled:a&&!t,isStandalone:t,browser:e,showBanner:!t}}async function Tl(){if(!ea)return console.warn("[PWA] Kein Install Prompt verfügbar"),!1;try{await ea.prompt();const{outcome:e}=await ea.userChoice;return console.log("[PWA] Install Prompt Ergebnis:",e),e==="accepted"&&nr(),ea=null,e==="accepted"}catch(e){return console.error("[PWA] Install Prompt fehlgeschlagen:",e),!1}}function ql(e){if(!("launchQueue"in window)){console.log("[PWA] Launch Queue API nicht verfügbar");return}window.launchQueue?.setConsumer(async t=>{if(!t.files?.length){console.log("[PWA] Launch ohne Dateien");return}console.log("[PWA] Datei via Launch Queue empfangen:",t.files.length);for(const a of t.files)try{await e(a),await tr({hasDatabase:!0,fileHandleName:a.name,lastAccess:new Date().toISOString(),autoStartEnabled:!0});break}catch(n){console.error("[PWA] Fehler beim Öffnen der Datei:",n)}}),console.log("[PWA] File Handling initialisiert")}const Ot="psm-file-handles",ti="last-database";async function Mr(e){try{const t=await ai(),n=t.transaction(Ot,"readwrite").objectStore(Ot);await new Promise((r,s)=>{const o=n.put({key:ti,handle:e,savedAt:new Date().toISOString()});o.onsuccess=()=>r(),o.onerror=()=>s(o.error)}),t.close(),console.log("[PWA] FileHandle gespeichert"),await tr({hasDatabase:!0,fileHandleName:e.name,lastAccess:new Date().toISOString(),autoStartEnabled:!0})}catch(t){console.error("[PWA] FileHandle speichern fehlgeschlagen:",t)}}async function Cr(){try{const e=await ai(),a=e.transaction(Ot,"readonly").objectStore(Ot),n=await new Promise((s,o)=>{const l=a.get(ti);l.onsuccess=()=>s(l.result),l.onerror=()=>o(l.error)});if(e.close(),!n?.handle)return null;const r=n.handle;return typeof r.queryPermission=="function"&&await r.queryPermission({mode:"readwrite"})==="granted"?(console.log("[PWA] FileHandle mit Berechtigung geladen"),n.handle):(console.log("[PWA] FileHandle gefunden, aber Berechtigung erforderlich"),n.handle)}catch(e){return console.error("[PWA] FileHandle laden fehlgeschlagen:",e),null}}async function Hl(e){try{const t=e;return typeof t.requestPermission!="function"?(await e.getFile(),!0):await t.requestPermission({mode:"readwrite"})==="granted"}catch{return!1}}async function Rl(){try{const e=await ai(),a=e.transaction(Ot,"readwrite").objectStore(Ot);await new Promise((n,r)=>{const s=a.delete(ti);s.onsuccess=()=>n(),s.onerror=()=>r(s.error)}),e.close(),await tr({hasDatabase:!1,autoStartEnabled:!1}),console.log("[PWA] FileHandle gelöscht")}catch(e){console.error("[PWA] FileHandle löschen fehlgeschlagen:",e)}}async function ai(){return new Promise((e,t)=>{const a=indexedDB.open("psm-file-handles",1);a.onerror=()=>t(a.error),a.onsuccess=()=>e(a.result),a.onupgradeneeded=n=>{const r=n.target.result;r.objectStoreNames.contains(Ot)||r.createObjectStore(Ot,{keyPath:"key"})}})}function wa(e,t){window.dispatchEvent(new CustomEvent(e,{detail:t}))}function Us(){return{serviceWorker:"serviceWorker"in navigator,fileSystemAccess:typeof window.showOpenFilePicker=="function",launchQueue:"launchQueue"in window,indexedDB:"indexedDB"in window,standalone:na(),installAvailable:ar()}}async function Ol(e){if(console.log("[PWA] Initialisierung..."),await Cl(),Fl(),e?.onFileOpened&&ql(e.onFileOpened),e?.onAutoStart&&await Bl()){const t=await Cr();if(t){const a=t;let n=!1;if(typeof a.queryPermission=="function"&&(n=await a.queryPermission({mode:"readwrite"})==="granted"),n){console.log("[PWA] Auto-Start mit gespeicherter Datei"),e.onFileOpened&&await e.onFileOpened(t);return}console.log("[PWA] Auto-Start: Berechtigung für Datei erforderlich"),wa("pwa:permission-required",{handle:t})}}console.log("[PWA] Capabilities:",Us())}async function _l(){if(console.group("🔧 PWA Debug Status"),console.log("📱 Standalone Mode:",na()),console.log("💾 localStorage Flag:",localStorage.getItem("psm-app-installed")),console.log("🔔 Install Prompt verfügbar:",ar()),console.log("🌐 Browser:",Xr()),console.group("📺 Display Mode Checks"),console.log("standalone:",window.matchMedia("(display-mode: standalone)").matches),console.log("fullscreen:",window.matchMedia("(display-mode: fullscreen)").matches),console.log("minimal-ui:",window.matchMedia("(display-mode: minimal-ui)").matches),console.log("window-controls-overlay:",window.matchMedia("(display-mode: window-controls-overlay)").matches),console.log("browser:",window.matchMedia("(display-mode: browser)").matches),console.groupEnd(),console.group("🔍 getInstalledRelatedApps API"),"getInstalledRelatedApps"in navigator)try{const e=await navigator.getInstalledRelatedApps();console.log("Installierte Apps:",e)}catch(e){console.log("API Fehler:",e)}else console.log("API nicht verfügbar");console.groupEnd(),console.group("📊 Status Vergleich"),console.log("Sync (isProbablyInstalled):",ei()),console.log("Async (checkIfInstalled):",await Ks()),console.log("getInstallStatus():",js()),console.log("getInstallStatusAsync():",await Gs()),console.groupEnd(),console.log("💡 Tipp: clearInstalledFlag() zum Zurücksetzen des Flags"),console.groupEnd()}typeof window<"u"&&(window.pwaDebug=_l,window.pwaClearFlag=Nl);let vn=!1;function Wl(e){const t=r=>{if(vn){vn=!1;return}return r.preventDefault(),r.returnValue="",""};let a=!1;const n=r=>{const s=!!r.app?.hasDatabase;s&&!a?(window.addEventListener("beforeunload",t),a=!0):!s&&a&&(window.removeEventListener("beforeunload",t),a=!1)};n(e.getState()),e.subscribe(n),document.addEventListener("click",r=>{const s=r.target.closest("a");s&&s.target==="_blank"&&(vn=!0,setTimeout(()=>{vn=!1},100))})}function Kl(){const e=document.getElementById("app-root");if(!e)throw new Error("app-root Container fehlt");return{startup:e.querySelector('[data-region="startup"]'),shell:e.querySelector('[data-region="shell"]'),main:e.querySelector('[data-region="main"]'),footer:e.querySelector('[data-region="footer"]')}}async function jl(){if(To()){window.location.replace("/psm/m/");return}Kl(),qo();const e=Cs();e!=="memory"&&Bt(e),await Ho();const t={state:{getState:U,patchState:Li,updateSlice:Qe,subscribe:On},events:{emit:Rn,subscribe:mt}};zl(t),Is(),Wl(t.state),Ol({onFileOpened:async a=>{const n=await Dt(()=>import("./index.D1c2XijN.js").then(s=>s.aR),[]),r=await Dt(()=>import("./index.D1c2XijN.js").then(s=>s.aQ),[]);if(r.isSupported()){n.setActiveDriver("sqlite");const s=await a.getFile(),o=await s.arrayBuffer(),l=await r.importFromArrayBuffer(o,s.name);await Mr(a);const{applyDatabase:c}=await Dt(async()=>{const{applyDatabase:p}=await import("./index.D1c2XijN.js").then(u=>u.aT);return{applyDatabase:p}},[]);c(l.data),Rn("database:connected",{driver:"sqlite",autoStarted:!0})}}}),mt("database:connected",async a=>{await tr({hasDatabase:!0,lastAccess:new Date().toISOString(),autoStartEnabled:!0})}),mt("database:connected",async a=>{if(ce()==="sqlite")try{await Ro(),await Bs()}catch(n){console.warn("GPS-Punkte konnten beim Start nicht geladen werden",n)}}),Li({app:{...U().app,ready:!0}})}const Oi="__pflanzenschutz_bootstrapped__",_i=window;function Wi(){jl().catch(e=>{console.error("bootstrap failed",e)})}_i[Oi]||(_i[Oi]=!0,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wi,{once:!0}):Wi());const Vs=[{id:"start",label:"Start",icon:"bi-grid-1x2",sections:[{section:"dashboard",label:"Übersicht",icon:"bi-grid-1x2"}]},{id:"psm",label:"PSM",icon:"bi-flower1",sections:[{section:"calc",label:"Neu erfassen",icon:"bi-pencil-square"},{section:"documentation",label:"Übersicht",icon:"bi-list-ul"},{section:"lager",label:"Lager",icon:"bi-box-seam"},{section:"settings",label:"Einstellungen",icon:"bi-gear"}]},{id:"acker",label:"Acker-Planer",icon:"bi-map",sections:[{section:"acker",label:"Karte",icon:"bi-map"},{section:"kultur",label:"Kulturführung",icon:"bi-clipboard2-pulse"}]},{id:"fotos",label:"Fotos",icon:"bi-camera",sections:[{section:"fotos",label:"Fotos",icon:"bi-camera"}]},{id:"daten",label:"Daten",icon:"bi-database",sections:[{section:"daten",label:"Import",icon:"bi-cloud-upload"}]}],Zs={dashboard:"start",calc:"psm",documentation:"psm",lager:"psm",history:"psm",report:"psm",acker:"acker",kultur:"acker",fotos:"fotos",settings:"psm",gps:"psm",lookup:"psm",import:"daten",daten:"daten"};function Qs(e){return Vs.find(t=>t.id===e)}function Gl(e){const t=Zs[e];return t?Qs(t):void 0}function Ul(){const e=document.getElementById("offline-indicator");if(!e)return;const t=()=>{const a=!navigator.onLine;e.classList.toggle("d-none",!a)};t(),window.addEventListener("online",t),window.addEventListener("offline",t)}function Ki(e){U().app.activeSection!==e&&(Qe("app",t=>({...t,activeSection:e})),Rn("app:sectionChanged",e))}function ji(){Ul();const e=document.querySelectorAll(".nav-btn[data-area]"),t=document.getElementById("brand-link"),a=document.getElementById("topnav-tabs"),n=document.getElementById("topnav-area-icon"),r=document.getElementById("topnav-area-label"),s={};for(const m of Vs)s[m.id]=m.sections[0].section;let o=null;function l(m,y){if(a){if(m.sections.length<=1){a.innerHTML="";return}a.innerHTML=m.sections.map(w=>`
  ...
  `}p(!1,na());const u=ec(l);a.innerHTML="",a.appendChild(c),a.appendChild(u.section);const g=typeof window<"u"&&typeof window.showSaveFilePicker=="function";u.saveButton&&(g?u.saveHint&&(u.saveHint.textContent='Der Browser fragt nach einem Speicherort. Die erzeugte Datei kannst du später über "Bestehende Datei verbinden" erneut laden.'):(u.saveButton.disabled=!0,u.saveButton.textContent="Datei speichern (nicht verfügbar)",u.saveHint&&(u.saveHint.textContent="Dieser Browser unterstützt keinen direkten Dateidialog. Bitte nutze einen Chromium-basierten Browser (z. B. Chrome, Edge) über HTTPS oder http://localhost.")));function h(O=t.state.getState()){const E=!!O.app?.hasDatabase;if(a.classList.toggle("d-none",E),E){c.classList.add("d-none"),u.section.classList.add("d-none");return}s==="wizard"?(c.classList.add("d-none"),u.section.classList.remove("d-none")):(c.classList.remove("d-none"),u.section.classList.add("d-none"))}async function k(O){await Fa(O,async()=>{try{const E=ce();E==="sqlite"||E==="filesystem"?Bt(E):Bt("filesystem")}catch(E){throw N.error("Dateisystemzugriff wird nicht unterstützt in diesem Browser."),E instanceof Error?E:new Error("Dateisystem nicht verfügbar")}try{const E=await Wo();hn(E.data);const $=E.context;$?.fileHandle&&await Mr($.fileHandle),t.events.emit("database:connected",{driver:ce()})}catch(E){console.error("Fehler beim Öffnen der Datenbank",E),N.error(E instanceof Error?E.message:"Öffnen der Datenbank fehlgeschlagen")}})}function m(O){Fa(O,async()=>{const E=Di(),$=["localstorage","sqlite","memory"];for(const re of $)try{Bt(re);const de=await $i(E);hn(de.data),t.events.emit("database:connected",{driver:ce()||re});return}catch(de){console.warn(`Treiber ${re} konnte nicht initialisiert werden`,de)}const Y="Keine geeignete Speicheroption verfügbar. Bitte Browserberechtigungen prüfen.";console.error(Y),N.error(Y)})}async function y(O){if(!n){N.warning("Bitte erst die Datenbank erzeugen.");return}await Fa(O,async()=>{try{const E=ce();E==="sqlite"||E==="filesystem"?Bt(E):Bt("filesystem")}catch(E){throw N.error("Dateisystemzugriff wird nicht unterstützt in diesem Browser."),E instanceof Error?E:new Error("Dateisystem nicht verfügbar")}try{const E=await $i(n);hn(E.data),t.events.emit("database:connected",{driver:ce()})}catch(E){console.error("Fehler beim Speichern der Datenbank",E),N.error(E instanceof Error?E.message:"Die Datei konnte nicht gespeichert werden")}})}function w(O){O.preventDefault();const E=new FormData(u.form),$=(E.get("wizard-company-name")||"").toString().trim();if(!$){N.warning("Bitte einen Firmennamen angeben.");return}const Y=(E.get("wizard-company-headline")||"").toString().trim(),re=(E.get("wizard-company-address")||"").toString().trim();n=Di({meta:{company:{name:$,headline:Y,logoUrl:"",contactEmail:"",address:re}}}),r=Xl($),u.preview.textContent=JSON.stringify(n,null,2),u.filenameLabel.textContent=r,u.resultCard.classList.remove("d-none"),u.resultCard.scrollIntoView({behavior:"smooth",block:"start"})}function D(){s="landing",n=null,r=Ir,u.reset(),h()}function C(){s="wizard",h()}async function M(O){await Fa(O,async()=>{try{const E=await Cr();if(!E){N.warning("Keine gespeicherte Datei gefunden.");return}if(!await Hl(E)){N.warning("Berechtigung zum Zugriff auf die Datei wurde verweigert.");return}Bt("sqlite");const Y=await E.getFile(),re=await Y.arrayBuffer(),de=await Ko(re,Y.name);jo(E),hn(de.data),await Mr(E),t.events.emit("database:connected",{driver:"sqlite",autoStarted:!0}),N.success("Datenbank erfolgreich geladen!")}catch(E){console.error("Auto-Start fehlgeschlagen:",E),N.error(E instanceof Error?E.message:"Fehler beim Laden der gespeicherten Datei")}})}async function H(){await Rl();const O=c.querySelector("#auto-start-banner");O&&O.classList.add("d-none"),N.info("Gespeicherte Datei wurde vergessen.")}async function Z(O){await Fa(O,async()=>{if(await Tl()){N.success("App wird installiert!");const $=c.querySelector("#pwa-install-banner");$&&$.classList.add("d-none")}})}if(c.addEventListener("click",O=>{const E=O.target?.closest("button[data-action]");if(!E)return;const $=E.dataset.action;if($==="start-wizard"){C();return}$==="open"?k(E):$==="useDefaults"?m(E):$==="auto-start"?M(E):$==="auto-start-forget"?H():$==="install-pwa"&&Z(E)}),u.form.addEventListener("submit",w),u.section.addEventListener("click",O=>{const E=O.target?.closest("[data-action]");if(!E)return;const $=E.dataset.action;if($==="wizard-back"){D();return}$==="wizard-save"&&y(E)}),t.state.subscribe(O=>h(O)),h(t.state.getState()),!t.state.getState().app.hasDatabase){const O=Cs();if(O&&O!==ce())try{Bt(O)}catch(E){console.warn("Bevorzugter Speicher konnte nicht gesetzt werden",E)}}(async()=>{const O=await Cr(),E=await Ws(),$=!!(O&&E?.hasDatabase),Y=na();p($,Y);const re=c.querySelector('[data-role="view-count"]');if(re&&Jl("app").then(xe=>{xe!==null&&(re.textContent=Yl(xe))}),$&&O){const xe=c.querySelector('[data-role="auto-start-filename"]');xe&&(xe.textContent=`Datei: ${O.name}`)}F(),window.addEventListener("pwa:install-available",()=>{F()}),window.addEventListener("pwa:installed",()=>{nr(),F()}),window.addEventListener("pwa:permission-required",async xe=>{const Je=xe.detail?.handle;if(Je){const Te=c.querySelector("#auto-start-banner"),gt=c.querySelector('[data-role="auto-start-filename"]');Te&&gt&&(gt.textContent=`Datei: ${Je.name} (Berechtigung erforderlich)`,Te.classList.remove("d-none"))}}),console.log("[Startup] PWA Capabilities:",Us());const de=await Gs();console.log("[Startup] PWA Install Status (async):",de),ae(de)})();function F(){const O=js();ae(O)}function ae(O){const E=c.querySelector("#pwa-install-banner"),$=c.querySelector('[data-role="pwa-content"]');if(!(!E||!$)){if(!O.showBanner){E.classList.add("d-none");return}E.classList.remove("d-none"),O.isInstalled?$.innerHTML=`
  ...
  `}function _t(e,t){ir();const a=e.querySelector('[data-role="doc-list"]');if(!a)return;const r=e.querySelector("#doc-detail")?.dataset.entryId||null;if(!$t.length)a.innerHTML=Ge?'<div class="text-center text-muted py-4">Lädt ...</div>':'<div class="text-center text-muted py-4">Noch keine Einträge</div>';else{a.innerHTML="";const s=document.createDocumentFragment();(t||U().fieldLabels).history?.detail?.usageType,$t.forEach(l=>{const c=document.createElement("div"),p=!!Ht?.highlightEntryIds?.has(l.id);c.className=`doc-sidebar-entry list-group-item${p?" doc-sidebar-entry--highlight":""}`,c.dataset.entryId=l.id;const u=io(l.entry)||"-",g=p?'<span class="badge bg-warning-subtle text-warning-emphasis badge-import">Import</span>':"";c.innerHTML=`
        <div
      ...
      `,s.appendChild(c)}),a.appendChild(s)}Hr(e,r),dc(e,t),In(e),sr(e),ro=new Date().toISOString(),yc()}function tn(e,t){const a=e.querySelector('[data-role="doc-info"]');if(!a)return;const n=He,r=!!(J.crop||J.creator);if(!n&&!Ge){a.textContent="Keine Einträge";return}if(!n&&Ge){a.textContent="Lädt...";return}if(J.startDate&&J.endDate){const s=`${J.startDate} - ${J.endDate} (${n})`;a.textContent=r?`${s} + Filter`:s;return}a.textContent=`Alle Einträge (${n})`}async function lo(e,t){const n=e.querySelector("#doc-detail")?.dataset.entryId;if(!n){Oa(e,null,t);return}const r=ta(n);if(!r){Oa(e,null,t);return}const s=await ln(r);s?Oa(e,{entry:r,detail:s},t):Oa(e,null,t)}async function ui(e,t,a=ne,n={}){const r=Math.max(0,a),s=!!n.forceReload;s&&(pt.clear(),rt.clear(),rt.set(0,null),He=0,ve=[],$t=[],ne=0,ut=null);const o=s?void 0:pt.get(r);if(o&&!n.forceReload){ne=r,ve=o,ut=null,_t(e,t),tn(e),In(e);return}const l=rt.has(r)?rt.get(r)??null:null,c=Symbol("doc-load");Na=c,Ge=!0,ut=null,In(e);try{const p=await Fs({cursor:l,pageSize:ft,filters:oi(J),sortDirection:"desc",includeTotal:s||r===0||He===0});if(Na!==c)return;const u=p.items.map(g=>bc(g));if(pt.set(r,u),Pc(r),rt.set(r,l),rt.set(r+1,p.nextCursor??null),typeof p.totalCount=="number")He=p.totalCount;else{const g=r*ft+u.length;He=Math.max(He,g)}ne=r,ve=u,ut=null,_t(e,t),tn(e,t)}catch(p){Na===c&&(console.error("Dokumentation konnte nicht geladen werden",p),ut="Dokumentation konnte nicht geladen werden. Bitte erneut versuchen.",window.alert("Dokumentation konnte nicht geladen werden. Bitte erneut versuchen."))}finally{Na===c&&(Ge=!1,Na=null,In(e))}}async function Hc(e,t){const a=Ue(t.history);ve=Ac(a.map((n,r)=>gc(n,r)).filter(n=>zc(n.entry,J))),He=ve.length,ne=0,ut=null,ir(),_t(e,t.fieldLabels),tn(e,t.fieldLabels),await lo(e,t.fieldLabels)}async function Ft(e,t){const a=Ea(t),n=!!t.app?.hasDatabase,r=a==="sqlite"&&n;if($e=r?"sqlite":"memory",ga.clear(),ne=0,ut=null,He=0,ve=[],$t=[],pt.clear(),rt.clear(),rt.set(0,null),en(e),li(e,t),rr(e),Xa(e,t.archives?.logs??[]),Cn=Nr(t.archives?.logs),r){await ui(e,t.fieldLabels,0,{forceReload:!0}),await lo(e,t.fieldLabels);return}await Hc(e,t)}async function yr(){const e=[];for(const t of Ve){const a=qt.get(t)||ta(t);if(!a)continue;const n=await ln(a);n&&e.push(n)}return e}async function Rc(e,t){if(!t){en(e),_t(e,U().fieldLabels);return}if(Ve.clear(),qt.clear(),$e==="memory")for(const a of ve)Ve.add(a.id),qt.set(a.id,a);else try{const a=await Ns({filters:oi(J),sortDirection:"desc",limit:1e4}),n=Array.isArray(a.historyIds)?a.historyIds:[];a.entries.forEach((r,s)=>{const o=Number(n[s]);if(!Number.isFinite(o))return;const l=ba("sqlite",o);Ve.add(l),qt.set(l,{id:l,entry:r,source:"sqlite",ref:o}),ga.has(l)||ga.set(l,r)})}catch(a){console.error("Alle Einträge konnten nicht ausgewählt werden",a),window.alert("Alle Einträge konnten nicht ausgewählt werden. Bitte erneut versuchen.")}_t(e,U().fieldLabels),sr(e)}async function Oc(e,t){if(!Ve.size)return;const a=Array.from(Ve).map(l=>qt.get(l)||ta(l)).filter(l=>!!l),n=[];for(const l of a){const c=await ln(l);c&&n.push(c)}const r=a.filter(l=>l.source==="sqlite"),s=!!r.length;if(s)for(const l of r)await Jo(l.ref);const o=new Set(a.filter(l=>l.source==="state").map(l=>l.ref));if(o.size&&(Qe("history",l=>{const c=rn(l),p=c.items.filter((u,g)=>!o.has(g));return p.length===c.items.length?c:{...c,items:p,totalCount:Math.min(c.totalCount,p.length),lastUpdatedAt:new Date().toISOString()}}),await _c()),n.length){const l=new Set(n.map(c=>di(c)));so(l)}if(s){try{await it()}catch(l){console.warn("SQLite-Datei konnte nach dem Löschen nicht gespeichert werden",l)}t.events?.emit?.("history:data-changed",{type:"deleted",ids:r.map(l=>l.ref)})}en(e),await Ft(e,t.state.getState())}async function co(e,t,a){const n=await ln(t);if(!n){window.alert("Details konnten nicht geladen werden.");return}Oa(e,{entry:t,detail:n},a)}async function cs(e){const t=await ln(e);t?await uo([t]):window.alert("Eintrag konnte nicht geladen werden.")}async function _c(){const e=ce();if(!(!e||e==="memory"||e==="sqlite"))try{const t=at();await nt(t)}catch(t){throw console.error("Persist history failed",t),window.alert("Historie konnte nicht gespeichert werden. Bitte erneut versuchen."),t}}async function Wc(e,t,a){if(jn)return;const n=t.state.getState();if(Ea(n)!=="sqlite"||!n.app?.hasDatabase){Pe(e,"Archivieren ist nur mit einer lokalen SQLite-Datenbank möglich.","warning");return}const s=kc(a);if(!s?.startDate||!s.endDate){Pe(e,"Bitte Start- und Enddatum für das Archiv wählen.","warning");return}const o=Kn(s.startDate),l=Kn(s.endDate);if(!o||!l){Pe(e,"Die angegebenen Daten sind ungültig.","danger");return}if(new Date(o)>new Date(l)){Pe(e,"Startdatum darf nicht nach dem Enddatum liegen.","danger");return}const c={startDate:o,endDate:l,creator:J.creator,crop:J.crop},p=oi(c);is(e,!0),Pe(e,"Prüfe Zeitraum und Eintragsmenge...","info");try{const u=await Fs({cursor:null,pageSize:1,filters:p,sortDirection:"asc",includeTotal:!0}),g=u.totalCount??u.items.length??0;if(!g){Pe(e,"Im angegebenen Zeitraum wurden keine Einträge gefunden.","warning");return}if(g>Ji){Pe(e,`Maximal ${Ji} Einträge pro Archiv erlaubt. Bitte Zeitraum verkürzen.`,"warning");return}Pe(e,`Exportiere ${g} Einträge in ein ZIP-Archiv...`,"info");const h=await Ns({filters:p,limit:g,sortDirection:"asc"}),k=h?.entries??[];if(!k.length){Pe(e,"Archiv konnte nicht erstellt werden – Export lieferte keine Einträge.","danger");return}const m=k.map(E=>({...E})),y={format:"pflanzenschutz-archive",formatVersion:1,exportedAt:new Date().toISOString(),entryCount:m.length,filters:{startDate:o,endDate:l,creator:c.creator||null,crop:c.crop||null},archive:{removeFromDatabase:s.removeAfterExport,storageHint:s.storageHint||null,note:s.note||null}},w=Ts({"pflanzenschutz.json":_n(JSON.stringify(m,null,2)),"metadata.json":_n(JSON.stringify(y,null,2))}),D=new ArrayBuffer(w.byteLength);new Uint8Array(D).set(w);const C=new Blob([D],{type:"application/zip"}),M=wc(o,l);pi(C,M);let H=!1;if(s.removeAfterExport){Pe(e,"Export abgeschlossen. Entferne Einträge und bereinige Datenbank...","info"),await Uo({filters:p});const E=new Set(m.map($=>di($)));so(E);try{await it()}catch($){console.error("SQLite-Datei konnte nach dem Archivieren nicht gespeichert werden",$)}t.events?.emit?.("history:data-changed",{type:"deleted-range",filters:p});try{await Vo()}catch($){H=!0,console.error("VACUUM fehlgeschlagen",$)}}const Z=new Date().toISOString(),F={id:`archive-${Date.now()}-${Math.random().toString(16).slice(2,8)}`,archivedAt:Z,startDate:o,endDate:l,entryCount:m.length,fileName:M,storageHint:s.storageHint||void 0,note:s.note||void 0};H&&(F.note=F.note?`${F.note} | VACUUM fehlgeschlagen`:"VACUUM fehlgeschlagen");const ae={filters:{...c},removeAfterExport:!!s.removeAfterExport,historyIdSample:h?.historyIds?.slice(0,Yi)};if(await Sc(F,ae),!s.removeAfterExport&&h?.historyIds?.length){const E=h.historyIds.slice(0,Yi).map($=>({source:"sqlite",ref:$}));t.events?.emit?.("documentation:focus-range",{startDate:o,endDate:l,label:"Archiviert",reason:"archive",entryIds:E})}Fr(e,!1),a.reset(),rr(e),await Ft(e,t.state.getState());const O=s.removeAfterExport?`Archiv ${M} erstellt und ${m.length} Einträge entfernt.`:`Archiv ${M} erstellt. ${m.length} Einträge bleiben in der Datenbank.`;Pe(e,O,H?"warning":"success")}catch(u){console.error("Archivieren fehlgeschlagen",u);const g=u instanceof Error?u.message:"Archiv konnte nicht erstellt werden.";Pe(e,g,"danger")}finally{is(e,!1),li(e,t.state.getState())}}const Kc=50;async function uo(e){if(!e.length){window.alert("Keine Einträge ausgewählt.");return}if(e.length>Kc&&!window.confirm(`Sie möchten ${e.length} Einträge drucken. Bei sehr vielen Einträgen kann das Erstellen der Druckvorschau einige Sekunden dauern und lässt sich nicht unterbrechen.

Fortfahren?`))return;const t=U().fieldLabels,a=Zo(U().company||null);await Qo(e,t,{title:"Dokumentation",headerHtml:a,chunkSize:25})}function pi(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,n.click(),URL.revokeObjectURL(a)}function jc(e){if(!e.length){window.alert("Keine Einträge ausgewählt.");return}const t=e.map(o=>({...o})),a=JSON.stringify(t,null,2),n=new TextEncoder().encode(a),r=new Blob([n],{type:"application/json; charset=utf-8"}),s=new Date().toISOString().replace(/[:.]/g,"-");pi(r,`pflanzenschutz-dokumentation-${s}.json`)}async function Gc(e,t){if(!e.length){window.alert("Keine Einträge ausgewählt.");return}const a=e.map(c=>({...c})),n={format:"pflanzenschutz-export",formatVersion:1,exportedAt:new Date().toISOString(),entryCount:a.length,filters:{startDate:t.startDate||null,endDate:t.endDate||null,creator:t.creator||null,crop:t.crop||null}},r=Ts({"pflanzenschutz.json":_n(JSON.stringify(a,null,2)),"metadata.json":_n(JSON.stringify(n,null,2))}),s=new ArrayBuffer(r.byteLength);new Uint8Array(s).set(r);const o=new Blob([s],{type:"application/zip"}),l=new Date().toISOString().replace(/[:.]/g,"-");pi(o,`pflanzenschutz-dokumentation-${l}.zip`)}function Uc(){const e=document.createElement("div"),t=si(),a=J.startDate||t.startDate||"",n=J.endDate||t.endDate||"";J={...J,startDate:a,endDate:n};const r=xa.enabled?`<button class="btn btn-outline-info btn-sm" type="button" data-action="doc-seed">+ ${xa.count} Dummy-Einträge</button>`:"";return e.className="section-inner",e.innerHTML=`
  ...
  `,e}function td(e){return{root:e,message:e.querySelector('[data-role="gps-message"]'),refreshIndicator:e.querySelector('[data-role="gps-refresh-indicator"]'),availability:e.querySelector('[data-role="gps-availability"]'),tabButtons:Array.from(e.querySelectorAll('[data-role="gps-tab"]')),panels:Array.from(e.querySelectorAll('[data-role="gps-panel"]')),listBody:e.querySelector('[data-role="gps-list"]'),emptyState:e.querySelector('[data-role="gps-empty"]'),activeInfo:e.querySelector('[data-role="gps-active-info"]'),summaryLabel:e.querySelector('[data-role="gps-summary"]'),statusBadge:e.querySelector('[data-role="gps-status"]'),form:e.querySelector('[data-role="gps-form"]'),formFields:{name:e.querySelector('[name="gps-name"]'),description:e.querySelector('[name="gps-description"]'),latitude:e.querySelector('[name="gps-latitude"]'),longitude:e.querySelector('[name="gps-longitude"]'),source:e.querySelector('[name="gps-source"]'),activate:e.querySelector('[name="gps-activate"]'),rawCoordinates:e.querySelector('[name="gps-raw-coordinates"]')},disableTargets:Array.from(e.querySelectorAll("[data-gps-disable]")),geolocationBtn:e.querySelector('[data-action="use-geolocation"]'),mapButton:e.querySelector('[data-role="gps-open-maps"]'),verifyButton:e.querySelector('[data-action="verify-coords"]')}}function Wa(e){return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(e)}`}function mo(e){const t=e.gps,a=_a(t),n=o=>{if(!o)return null;const l=sn(o)||Wa(`${o.latitude},${o.longitude}`),c=o.name?`${o.name}`:`${Sa(o.latitude)}, ${Sa(o.longitude)}`;return{url:l,label:c}};if(t.activePointId){const o=a.find(c=>c.id===t.activePointId),l=n(o||null);if(l)return l}if(a.length>0){const o=n(a[0]);if(o)return o}const r=e.company?.address?.trim();if(r)return{url:Wa(r.replace(/\n/g,", ")),label:r};const s=e.company?.name?.trim();return s?{url:Wa(s),label:s}:{url:Wa(us),label:us}}function ad(e){if(!z)return;const t=mo(e);z.mapButton&&(z.mapButton.href=t.url,z.mapButton.title=`Google Maps öffnen (${t.label})`);const a=z.root.querySelector('[data-role="gps-empty-map-link"]');a&&(a.href=t.url)}function nd(e){if(!e)return null;const a=e.trim().replace(/\s+/g," ").replace(/[,;]/g," ").match(/-?\d+(?:[.,]\d+)?/g);if(!a||a.length<2)return null;const n=o=>Number(o.replace(/,/g,".")),r=n(a[0]),s=n(a[1]);return!Number.isFinite(r)||!Number.isFinite(s)||r<-90||r>90||s<-180||s>180?null:{latitude:r,longitude:s}}function rd(){if(!z?.formFields)return null;const e=z.formFields.latitude?.value??"",t=z.formFields.longitude?.value??"";if(!e.trim()||!t.trim())return null;const a=Number(e),n=Number(t);return!Number.isFinite(a)||!Number.isFinite(n)||a<-90||a>90||n<-180||n>180?null:{latitude:a,longitude:n}}function En(e){return Number(e).toFixed(6)}function id(e,t){const a=En(e),n=En(t);return an(U()).some(r=>En(r.latitude)===a&&En(r.longitude)===n)}function Za(){if(!z?.verifyButton)return;const e=rd(),t=!!e;if(z.verifyButton.disabled=!t,e){const a=sn({latitude:e.latitude,longitude:e.longitude});z.verifyButton.dataset.targetUrl=a||Wa(`${e.latitude},${e.longitude}`)}else delete z.verifyButton.dataset.targetUrl}function Sa(e){const t=Number(e);return Number.isFinite(t)?`${Yc.format(t)}°`:"–"}function sd(e){if(!e)return"–";const t=new Date(e);return Number.isNaN(t.getTime())?"–":Xc.format(t)}function oe(e,t="info",a=4500){if(z?.message){if(Sn&&(window.clearTimeout(Sn),Sn=null),!e){z.message.classList.add("d-none"),z.message.textContent="";return}z.message.className=`alert alert-${t}`,z.message.textContent=e,z.message.classList.remove("d-none"),a>0&&(Sn=window.setTimeout(()=>{z?.message?.classList.add("d-none")},a))}}function od(e){const t=z?.refreshIndicator;if(t){if(t.classList.remove("alert-warning","alert-info"),e==="idle"){t.classList.add("d-none");return}t.classList.remove("d-none"),e==="stale"?(t.classList.add("alert-warning"),t.textContent="GPS-Daten wurden geändert. Ansicht aktualisiert sich beim Öffnen."):(t.classList.add("alert-info"),t.textContent="GPS-Daten werden aktualisiert...")}}function fo(e){z&&(po=e,z.tabButtons.forEach(t=>{const a=t.dataset.tab===e;t.classList.toggle("active",a)}),z.panels.forEach(t=>{const a=t.getAttribute("data-panel")===e;t.classList.toggle("d-none",!a)}))}function Ze(e){return e?.hasDatabase?e.storageDriver!=="sqlite"?"wrong-driver":"ok":"no-db"}function ld(e){if(z?.availability){if(e==="ok"){z.availability.classList.add("d-none"),z.availability.textContent="";return}z.availability.classList.remove("d-none"),z.availability.textContent=e==="no-db"?"Bitte verbinden Sie zuerst eine Datenbank, um GPS-Punkte zu verwalten.":"GPS-Funktionen benötigen eine aktive SQLite-Datenbank. Bitte den SQLite-Treiber in den Einstellungen auswählen."}}function ha(e,t){if(!z)return;const a=t!=="ok"||e.pending||Ya.isLocked();if(z.disableTargets.forEach(n=>{(n instanceof HTMLButtonElement||n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement||n instanceof HTMLSelectElement)&&(n.disabled=a)}),z.statusBadge){let n="badge bg-success",r="Bereit";t==="no-db"?(n="badge bg-secondary",r="Keine Datenbank"):t==="wrong-driver"?(n="badge bg-warning text-dark",r="Nur mit SQLite"):(e.pending||Ya.isLocked())&&(n="badge bg-info text-dark",r="Wird verarbeitet"),z.statusBadge.className=n,z.statusBadge.textContent=r}}function go(e){const t=e.length;if(!t)return Me=0,{total:0,start:0,end:0,items:[]};const a=Math.max(Math.ceil(t/Bn),1);Me>=a&&(Me=a-1),Me<0&&(Me=0);const n=Me*Bn,r=Math.min(n+Bn,t);return{total:t,start:n,end:r,items:e.slice(n,r)}}function cd(){if(!z?.root)return null;const e=z.root.querySelector('[data-role="gps-pager"]');return e?((!ua||Rr!==e)&&(ua?.destroy(),ua=on(e,{onPrev:()=>ud(),onNext:()=>pd(),labels:{prev:"Zurück",next:"Weiter",loading:"GPS-Punkte werden geladen...",empty:"Keine GPS-Punkte verfügbar"}}),Rr=e),ua):null}function gs(e,t){const a=cd();if(!a)return;if(t!=="ok"){Me=0;const o=t==="no-db"?"Keine Datenbank verbunden.":"Nur mit SQLite verfügbar.";a.update({status:"disabled",info:o});return}const n=an(e).length;if(!n){Me=0;const o=e.gps.initialized?"Noch keine GPS-Punkte vorhanden.":"GPS-Punkte werden geladen...";a.update({status:"disabled",info:o});return}const{start:r,end:s}=go(an(e));a.update({status:"ready",info:`Einträge ${kr.format(r+1)}–${kr.format(s)} von ${kr.format(n)}`,canPrev:Me>0,canNext:s<n})}function dd(e,t){return e.length?e.map(a=>{const n=a.id===t,r=a.description?`<div class="text-muted small">${v(a.description)}</div>`:"",s=a.source?`<span class="badge-psm badge-psm-neutral">${v(a.source)}</span>`:'<span class="text-muted">–</span>',o=n?'<span class="badge bg-success ms-2">Aktiv</span>':"",l=sn(a),c=l?`<a class="btn btn-outline-info" href="${Va(l)}" target="_blank" rel="noopener noreferrer">
              Karte
            </a>`:"";return`
      ...
      `}).join(`
`):""}function mi(e,t){if(!z)return;const a=e.gps,n=mo(e),r=t==="ok";if(z.summaryLabel){const s=_a(a).length;z.summaryLabel.textContent=r?`${s} Punkt${s===1?"":"e"} gespeichert`:"Funktion derzeit nicht verfügbar"}if(!r){z.listBody&&(z.listBody.innerHTML=""),z.emptyState&&(z.emptyState.textContent=t==="no-db"?"Keine Datenbank verbunden.":"Bitte SQLite als Speicher-Treiber aktivieren.",z.emptyState.classList.remove("d-none")),z.activeInfo&&(z.activeInfo.textContent=t==="no-db"?"Wartet auf Datenbank.":"Nur mit SQLite verfügbar."),gs(e,t);return}if(z.listBody){const{items:s}=go(_a(a));z.listBody.innerHTML=dd(s,a.activePointId)}if(z.emptyState){const s=_a(a).length>0;z.emptyState.classList.toggle("d-none",s),!s&&a.initialized?z.emptyState.innerHTML=`
      ...
      `:a.initialized||(z.emptyState.textContent="GPS-Punkte werden geladen...")}if(z.activeInfo)if(a.activePointId){const s=_a(a).find(o=>o.id===a.activePointId);if(s){const o=`${s.name||"Ohne Namen"} (${Sa(s.latitude)}, ${Sa(s.longitude)})`,l=sn(s);l?z.activeInfo.innerHTML=`${v(o)} <a class="btn btn-link btn-sm p-0 ms-2 align-baseline" href="${Va(l)}" target="_blank" rel="noopener noreferrer">Google Maps</a>`:z.activeInfo.textContent=o}else z.activeInfo.textContent="Aktiver Punkt nicht gefunden."}else z.activeInfo.innerHTML=`Kein aktiver Punkt ausgewählt. <a class="btn btn-link btn-sm p-0 ms-2 align-baseline" href="${Va(n.url)}" target="_blank" rel="noopener noreferrer">Google Maps öffnen</a>`;gs(e,t)}function ud(){if(Me===0)return;Me=Math.max(Me-1,0);const e=U(),t=Ze(e.app);mi(e,t)}function pd(){const e=U(),t=an(e).length;if(!t)return;const a=Math.max(Math.ceil(t/Bn)-1,0);if(Me>=a)return;Me=Math.min(Me+1,a);const n=Ze(e.app);mi(e,n)}function Ne(e){`${new Date().toLocaleString("de-DE")}${e}`}function cn(e){if(!e)return null;const t=U();return an(t).find(a=>a.id===e)||null}async function md(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}function fd(){if(!z?.formFields?.rawCoordinates)return;const e=z.formFields.rawCoordinates.value,t=nd(e);if(!t){oe("Koordinaten konnten nicht erkannt werden. Bitte Format 47.68952, 9.12091 verwenden.","warning",6e3);return}const a=t.latitude.toFixed(6),n=t.longitude.toFixed(6);z.formFields.latitude&&(z.formFields.latitude.value=a),z.formFields.longitude&&(z.formFields.longitude.value=n),oe("Koordinaten übernommen.","success"),Za()}function gd(){if(!z?.verifyButton)return;const e=z.verifyButton.dataset.targetUrl;if(!e){oe("Bitte zuerst gültige Koordinaten eintragen, bevor die Prüfung geöffnet wird.","warning",6e3);return}window.open(e,"_blank","noopener,noreferrer")}async function Or(e={}){const{notify:t=!1}=e;if(!(!z||Ze(U().app)!=="ok"||U().gps.pending))try{await Bs(),t&&oe("GPS-Punkte aktualisiert.","success"),Ne("GPS-Punkte synchronisiert.")}catch(n){const r=n instanceof Error?n.message:"GPS-Punkte konnten nicht geladen werden.";oe(r,"danger",7e3),Ne(`Fehler beim Laden: ${r}`)}}async function bd(e){if(!e)return;const t=cn(e);if(!t){oe("Ausgewählter GPS-Punkt wurde nicht gefunden.","warning");return}try{await Hs(t.id),oe(`"${t.name}" ist nun aktiv.`,"success"),Ne(`Aktiver GPS-Punkt: ${t.name}`)}catch(a){const n=a instanceof Error?a.message:"GPS-Punkt konnte nicht aktiviert werden.";oe(n,"danger",7e3),Ne(`Fehler beim Aktivieren: ${n}`)}}async function hd(e){if(!e)return;const t=cn(e);if(!t){oe("GPS-Punkt existiert nicht mehr.","warning");return}if(window.confirm(`"${t.name}" wirklich löschen? Dieser Schritt kann nicht rückgängig gemacht werden.`))try{await rl(t.id),oe(`"${t.name}" wurde gelöscht.`,"success"),Ne(`GPS-Punkt gelöscht: ${t.name}`)}catch(n){const r=n instanceof Error?n.message:"GPS-Punkt konnte nicht gelöscht werden.";oe(r,"danger",7e3),Ne(`Löschen fehlgeschlagen: ${r}`)}}async function vd(e){if(!e)return;const t=cn(e);if(!t){oe("GPS-Punkt nicht gefunden.","warning");return}const a=`${t.latitude}, ${t.longitude}`;try{await md(a),oe("Koordinaten in die Zwischenablage kopiert.","success")}catch(n){console.error("clipboard error",n),oe("Koordinaten konnten nicht kopiert werden.","danger",7e3)}}async function yd(e,t){const a=(e||"").trim();if(!a){ca(t,{status:"error",id:"",message:"Ungültige GPS-Anfrage ohne ID."});return}if(Ze(U().app)!=="ok"){oe("GPS-Modul ist ohne aktive SQLite-Datenbank nicht verfügbar.","warning",6e3),ca(t,{status:"error",id:a,message:"GPS-Modul ist derzeit nicht verfügbar."});return}const r=cn(a);if(!r){oe("Verknüpfter GPS-Punkt wurde nicht gefunden.","warning",6e3),ca(t,{status:"error",id:a,message:"Verknüpfter GPS-Punkt wurde nicht gefunden."});return}ca(t,{status:"pending",id:r.id,name:r.name,message:`"${r.name||"Ohne Namen"}" wird aktiviert...`});try{await Hs(r.id),oe(`"${r.name||"Ohne Namen"}" wurde aus der Historie aktiviert.`,"success"),Ne(`Aus Historie aktiviert: ${r.name||r.id}`),ca(t,{status:"success",id:r.id,name:r.name,message:`"${r.name||"Ohne Namen"}" wurde aktiviert.`})}catch(s){const o=s instanceof Error?s.message:"GPS-Punkt konnte nicht aktiviert werden.";oe(o,"danger",7e3),Ne(`Aktivierung aus Historie fehlgeschlagen: ${o}`),ca(t,{status:"error",id:r.id,name:r.name,message:o})}}async function kd(){try{await il(),Ne("Aktiver GPS-Punkt synchronisiert."),oe("Aktiver GPS-Punkt wurde synchronisiert.","success")}catch(e){const t=e instanceof Error?e.message:"Aktiver GPS-Punkt konnte nicht ermittelt werden.";oe(t,"danger",7e3),Ne(`Sync fehlgeschlagen: ${t}`)}}function wd(){if(!z?.formFields)throw new Error("Formular nicht initialisiert");const e=z.formFields.name?.value.trim()||"",t=z.formFields.description?.value.trim()||"",a=z.formFields.source?.value.trim()||"",n=Number(z.formFields.latitude?.value),r=Number(z.formFields.longitude?.value),s=!!z.formFields.activate?.checked;if(!e)throw new Error("Name darf nicht leer sein.");if(!Number.isFinite(n)||!Number.isFinite(r))throw new Error("Koordinaten sind ungültig.");return{name:e,description:t,latitude:n,longitude:r,source:a,activate:s}}async function xd(e){if(e.preventDefault(),Ya.isLocked()){oe("Speichern läuft bereits ...","info");return}try{const t=wd();if(id(t.latitude,t.longitude)){oe("Ein GPS-Punkt mit identischen Koordinaten ist bereits vorhanden.","warning",6e3);return}ha(U().gps,Ze(U().app)),await sl({name:t.name,description:t.description||null,latitude:t.latitude,longitude:t.longitude,source:t.source||null},{activate:t.activate}),N.success(`GPS-Punkt "${t.name}" gespeichert.`),Ne(`GPS-Punkt gespeichert${t.activate?" und aktiv gesetzt":""}: ${t.name}`),z?.form?.reset()}catch(t){const a=t instanceof Error?t.message:"GPS-Punkt konnte nicht gespeichert werden.";N.error(a),Ne(`Speichern fehlgeschlagen: ${a}`)}finally{ha(U().gps,Ze(U().app))}}function Sd(){if(z?.formFields){if(!navigator.geolocation){N.warning("Geolocation wird von diesem Browser nicht unterstützt.");return}if(Ya.isLocked()){N.info("Bitte warten...");return}Ya.acquire(async()=>(ha(U().gps,Ze(U().app)),new Promise(e=>{navigator.geolocation.getCurrentPosition(t=>{const{latitude:a,longitude:n}=t.coords;z?.formFields.latitude&&(z.formFields.latitude.value=a.toFixed(6)),z?.formFields.longitude&&(z.formFields.longitude.value=n.toFixed(6)),z?.formFields.source&&!z.formFields.source.value.trim()&&(z.formFields.source.value="Browser"),N.success("Koordinaten aus Browser-Position übernommen."),Ne("Browser-Geolocation übernommen"),Za(),ha(U().gps,Ze(U().app)),e()},t=>{const a=t.code===t.PERMISSION_DENIED?"Zugriff auf Standort wurde verweigert.":"Geolocation konnte nicht ermittelt werden.";N.warning(a),Ne(`Geolocation fehlgeschlagen: ${a}`),ha(U().gps,Ze(U().app)),e()},{enableHighAccuracy:!0,timeout:1e4,maximumAge:0})})))}}function Ed(){z&&(z.root.addEventListener("click",e=>{const t=e.target;if(!t)return;const a=t.closest('[data-role="gps-tab"]');if(a&&a.dataset.tab){fo(a.dataset.tab);return}const n=t.closest("[data-action]");if(!n||n.dataset.action==="")return;const s=n.closest("[data-point-id]")?.getAttribute("data-point-id")||"";switch(n.dataset.action){case"reload-points":Or({notify:!0});break;case"sync-active":kd();break;case"set-active":bd(s);break;case"delete-point":hd(s);break;case"copy-coords":vd(s);break;case"use-geolocation":Sd();break;case"apply-raw-coords":fd();break;case"verify-coords":gd();break}}),z.form?.addEventListener("submit",e=>{xd(e)}),z.form?.addEventListener("reset",()=>{window.setTimeout(()=>{Za()},0)}),z.formFields.latitude?.addEventListener("input",()=>{Za()}),z.formFields.longitude?.addEventListener("input",()=>{Za()}))}function Ld(e,t){if(!e||ps)return;ps=!0;const a=e;a.innerHTML="";const n=ed();a.appendChild(n),z=td(n),fs?.(),fs=Js({section:"gps",event:"gps:data-changed",shouldHandleEvent:()=>Ze(t.state.getState().app)==="ok",shouldRefresh:()=>Ze(t.state.getState().app)==="ok",onRefresh:()=>Or({notify:!1}),onStatusChange:o=>od(o)}),Me=0,ua?.destroy(),ua=null,Rr=null,Ed(),fo(po),typeof t.events?.subscribe=="function"&&t.events.subscribe("gps:set-active-from-history",o=>{let l="";if(o&&typeof o=="object"&&(l=String(o.id||"").trim()),!l){oe("Historische GPS-Anfrage ohne gültige ID erhalten.","warning",6e3);return}yd(l,t)});const r=t.state.getState();qa=r.gps.activePointId;const s=(o,l)=>{const c=Ze(o.app),p=o.gps;if(ld(c),mi(o,c),ha(p,c),ad(o),c==="ok"&&!p.initialized&&!p.pending&&Or({notify:!1}),c==="ok"&&ms!=="ok"&&p.initialized&&oe("GPS-Bereich ist wieder verfügbar.","success"),ms=c,o.gps.activePointId!==qa&&(qa=o.gps.activePointId,typeof t.events?.emit=="function")){const u=cn(qa);t.events.emit("gps:active-point-changed",{id:qa,point:u})}o.gps.lastError&&o.gps.lastError!==l.gps.lastError&&(oe(o.gps.lastError,"danger",7e3),Ne(`Fehler: ${o.gps.lastError}`))};t.state.subscribe(s),s(r,r)}let Re=[],Oe=[],_r=!1,Fn=null;async function vt(){try{const[e,t]=await Promise.all([ul({limit:100}),pl({limit:100})]);Re=e.items||[],Oe=t.items||[],Rn("savedCodes:changed",{eppoCount:Re.length,bbchCount:Oe.length})}catch(e){console.error("Failed to load saved codes:",e),Re=[],Oe=[]}}function Dd(){const e=Re.length>0,t=Oe.length>0;return`
    <div class="row g-4">
      <!-- EPPO Codes Section -->
      <div class="col-lg-6">
            ...
            <div class="border-top pt-3 mb-3" style="border-color: var(--border-1) !important;">
              ${e?`
                <h6 class="mb-2 text-muted small text-uppercase d-flex align-items-center">
                  ...
                  Meine Kulturen
                  <span class="badge bg-success ms-2">${Re.length}</span>
                </h6>
  ...
  `}function Wr(){return Re.length?Re.map(e=>`
  ...
  `).join(""):`
    ...
    `}function yt(e){const t=e.querySelector('[data-role="saved-eppo-list"]'),a=Re.length>0;if(t){const l=t.closest(".border-top");l&&a&&(l.innerHTML=`
          <h6 class="mb-2 text-muted small text-uppercase d-flex align-items-center">
            <i class="bi bi-bookmark-star me-1"></i>
            Meine Kulturen
            <span class="badge bg-success ms-2">${Re.length}</span>
      ...
      `)}const n=e.querySelector('[data-role="saved-bbch-list"]'),r=Oe.length>0;if(n){const l=n.closest(".border-top");l&&r&&(l.innerHTML=`
          <h6 class="mb-2 text-muted small text-uppercase d-flex align-items-center">
            <i class="bi bi-bookmark-star me-1"></i>
            Meine Stadien
            <span class="badge bg-info ms-2">${Oe.length}</span>
        ...
        `)}}const s=e.querySelector(".codes-card:first-child .card-header .badge"),o=e.querySelector(".codes-card:last-child .card-header .badge");s&&(s.textContent=`${Re.length} gespeichert`),o&&(o.textContent=`${Oe.length} gespeichert`)}function $d(e){const t=e.querySelector('[data-input="eppo-search"]'),a=e.querySelector('[data-role="eppo-search-results"]');if(t&&a){const l=zi(async()=>{const c=t.value.trim();if(c.length<2){a.innerHTML="";return}try{const p=await cl(c,10);if(!p.length){a.innerHTML=`
        ...
        `}},300);t.addEventListener("input",l)}const n=e.querySelector('[data-input="bbch-search"]'),r=e.querySelector('[data-role="bbch-search-results"]');if(n&&r){const l=zi(async()=>{const c=n.value.trim();if(c.length<1){r.innerHTML="";return}try{const p=await dl(c,10);if(!p.length){r.innerHTML=`
            <div class="list-group-item text-muted">Keine Ergebnisse für "${v(c)}"</div>
        ...
        `).join("")}catch(p){console.error("BBCH search failed:",p),r.innerHTML=`
          <div class="list-group-item text-danger">Suche fehlgeschlagen</div>
        `}},300);n.addEventListener("input",l)}e.dataset.codesClickBound!=="1"&&(e.dataset.codesClickBound="1",e.addEventListener("click",async l=>{const p=l.target.closest("[data-action]");if(!p)return;const u=p.dataset.action;if(u==="select-eppo"){const g=p.dataset.code||"",h=p.dataset.name||"",k=p.dataset.language||"",m=p.dataset.dtcode||"";if(!g||!h){console.warn("EPPO selection missing code or name");return}a&&(a.innerHTML=""),t&&(t.value="");const y=Re.find(w=>w.code.toUpperCase()===g.toUpperCase());if(y){const w=e.querySelector(`[data-eppo-id="${y.id}"]`);w&&(w.classList.add("flash-highlight"),setTimeout(()=>w.classList.remove("flash-highlight"),800));return}try{await fr({code:g,name:h,language:k||void 0,dtcode:m||void 0,isFavorite:!1});const w=at();await nt(w),await vt(),yt(e)}catch(w){console.error("Failed to save EPPO from search:",w),alert("Speichern fehlgeschlagen")}}if(u==="select-bbch"){const g=p.dataset.code||"",h=p.dataset.label||"",k=p.dataset.principal,m=p.dataset.secondary,y=k?parseInt(k,10):void 0,w=m?parseInt(m,10):void 0;if(!g||!h){console.warn("BBCH selection missing code or label");return}r&&(r.innerHTML=""),n&&(n.value="");const D=Oe.find(C=>C.code===g);if(D){const C=e.querySelector(`[data-bbch-id="${D.id}"]`);C&&(C.classList.add("flash-highlight"),setTimeout(()=>C.classList.remove("flash-highlight"),800));return}try{await gr({code:g,label:h,principalStage:Number.isNaN(y)?void 0:y,secondaryStage:Number.isNaN(w)?void 0:w,isFavorite:!1});const C=at();await nt(C),await vt(),yt(e)}catch(C){console.error("Failed to save BBCH from search:",C),alert("Speichern fehlgeschlagen")}}if(u==="toggle-favorite-eppo"){const g=p.dataset.id;if(!g)return;const h=Re.find(k=>k.id===g);if(!h)return;try{await fr({id:h.id,code:h.code,name:h.name,language:h.language,dtcode:h.dtcode,isFavorite:!h.isFavorite});const k=at();await nt(k),await vt(),yt(e)}catch(k){console.error("Failed to toggle EPPO favorite:",k)}}if(u==="toggle-favorite-bbch"){const g=p.dataset.id;if(!g)return;const h=Oe.find(k=>k.id===g);if(!h)return;try{await gr({id:h.id,code:h.code,label:h.label,principalStage:h.principalStage,secondaryStage:h.secondaryStage,isFavorite:!h.isFavorite});const k=at();await nt(k),await vt(),yt(e)}catch(k){console.error("Failed to toggle BBCH favorite:",k)}}if(u==="delete-eppo"){const g=p.dataset.id;if(!g||!confirm("EPPO-Code wirklich löschen?"))return;try{await ol({id:g});const h=at();await nt(h),await vt(),yt(e)}catch(h){console.error("Failed to delete EPPO:",h)}}if(u==="delete-bbch"){const g=p.dataset.id;if(!g||!confirm("BBCH-Stadium wirklich löschen?"))return;try{await ll({id:g});const h=at();await nt(h),await vt(),yt(e)}catch(h){console.error("Failed to delete BBCH:",h)}}}));const s=e.querySelector('[data-form="add-eppo"]');s&&s.addEventListener("submit",async l=>{l.preventDefault();const c=e.querySelector('[data-input="eppo-code"]'),p=e.querySelector('[data-input="eppo-name"]'),u=e.querySelector('[data-input="eppo-favorite"]'),g=c?.value.trim(),h=p?.value.trim();if(!g||!h){alert("Bitte Code und Name eingeben");return}try{await fr({code:g,name:h,isFavorite:u?.checked||!1});const k=at();await nt(k),await vt(),yt(e),c&&(c.value=""),p&&(p.value=""),u&&(u.checked=!1)}catch(k){console.error("Failed to save EPPO:",k),alert("Speichern fehlgeschlagen")}});const o=e.querySelector('[data-form="add-bbch"]');o&&o.addEventListener("submit",async l=>{l.preventDefault();const c=e.querySelector('[data-input="bbch-code"]'),p=e.querySelector('[data-input="bbch-label"]'),u=e.querySelector('[data-input="bbch-favorite"]'),g=c?.value.trim(),h=p?.value.trim();if(!g||!h){alert("Bitte Code und Bezeichnung eingeben");return}try{await gr({code:g,label:h,isFavorite:u?.checked||!1});const k=at();await nt(k),await vt(),yt(e),c&&(c.value=""),p&&(p.value=""),u&&(u.checked=!1)}catch(k){console.error("Failed to save BBCH:",k),alert("Speichern fehlgeschlagen")}})}function zd(e,t,a={}){if(!e||_r)return;Fn=e,_r=!0,Fn.innerHTML=`
    <div class="section-inner codes-manager">
      <h4 class="mb-3"><i class="bi bi-tags me-2"></i>EPPO & BBCH Codes</h4>
      ${Dd()}
    </div>`;const n=Fn.querySelector(".codes-manager");if(!n)return;$d(n);const r=async()=>{await vt(),yt(n)};t?.events?.subscribe?.("database:connected",()=>{r()}),t?.state?.getState?.().app?.hasDatabase&&r()}function Ad(){_r=!1,Fn=null}let bs=!1,xt=null,Ka=null,Nn=null,ja=null,Zt=null,Un=null,St=null,nn=null,Vn=null,Et=null,jr=null,kt=null,Ce=new Set,Nt=null,wr=!1,xr=!1,va=!1;const st=e=>Ue(e.mediums),Tn=25,Sr=new Intl.NumberFormat("de-DE");let Fe=0,pa=null,Gr=null,Ur=null,fi=null;function Pd(){const e=document.createElement("div");return e.className="section-inner",e.innerHTML=`
    <h2 class="text-center mb-4">
  ...
  `,e}function Md(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`profile-${Date.now()}-${Math.random().toString(16).slice(2,10)}`}function bo(e){if(!Ce.size)return;const t=new Set(st(e).map(n=>n.id));let a=!1;Ce.forEach(n=>{t.has(n)||(Ce.delete(n),a=!0)}),a&&(Ce=new Set(Ce))}function Zn(){xt&&xt.querySelectorAll('[data-role="profile-select"]').forEach(e=>{const t=e.dataset.mediumId;e.checked=!!(t&&Ce.has(t))})}function Tt(e){const t=st(e).length,a=Ce.size;let n="Noch keine Mittel ausgewählt.";t?a===t&&t>0?n=`${a} Mittel ausgewählt (alle).`:a>0&&(n=`${a} Mittel ausgewählt.`):n="Keine Mittel vorhanden.",jr&&(jr.textContent=n),kt&&(kt.disabled=t===0,kt.indeterminate=a>0&&a<t,kt.checked=t>0&&a===t)}function qn(e){Nt=null,Un&&Un.reset(),nn&&(nn.value=""),St&&(St.value=""),Et&&(Et.textContent="Profil speichern"),Ce=new Set,Zn(),Tt(e)}function Cd(e,t){Nt=e.id,nn&&(nn.value=e.id),St&&(St.value=e.name,St.focus()),Et&&(Et.textContent="Profil aktualisieren"),Ce=new Set(e.mediumIds),Zn(),Tt(t)}function hs(e,t){if(Et){if(Et.disabled=e,e){Et.textContent=t||"Speichert...";return}Et.textContent=Nt?"Profil aktualisieren":"Profil speichern"}}function Qn(e,t){if(Ka){if(Ka.disabled=e,e){Ka.textContent=t||"Speichert...";return}Ka.textContent="Hinzufügen"}}async function Id(e,t,a){if(va)return;const n=t.state.getState(),s=(st(n)[e]??null)?.id||null;va=!0,Qn(!0);const o=a?.textContent??null;a&&(a.disabled=!0,a.textContent="Lösche...");try{t.state.updateSlice("mediums",c=>{const p=rn(c),u=p.items.slice();return u.splice(e,1),{...p,items:u,totalCount:Math.min(p.totalCount,u.length),lastUpdatedAt:new Date().toISOString()}}),await Jn({silent:!0})&&s&&t.events?.emit?.("mediums:data-changed",{action:"deleted",id:s})}finally{va=!1,Qn(!1),a&&a.isConnected&&(a.disabled=!1,a.textContent=o??"Löschen")}}async function Bd(e,t,a){const n=a?.textContent??null;a&&(a.disabled=!0,a.textContent="Lösche...");try{t.state.updateSlice("mediumProfiles",(r=[])=>r.filter(s=>s.id!==e.id)),Nt===e.id&&qn(t.state.getState()),await Jn({successMessage:"Profil gelöscht."})}finally{a&&(a.disabled=!1,a.textContent=n||"Löschen")}}function Fd(e){if(!Vn)return;const t=Vn,a=e.mediumProfiles||[];if(!a.length){t.innerHTML=`
    ...
    `,xt?.appendChild(p)}),Tt(e),vs(e)}function ys(e){if(!ja)return;const t=new Set;ja.innerHTML="",e.measurementMethods.forEach(a=>{const n=(a.label??"").toLowerCase(),r=(a.id??"").toLowerCase();if(n&&!t.has(n)){t.add(n);const s=document.createElement("option");s.value=a.label,ja.appendChild(s)}if(r&&!t.has(r)){t.add(r);const s=document.createElement("option");s.value=a.id,ja.appendChild(s)}})}function Rd(e){const t=e.toLowerCase().trim().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"");return t||`method-${Date.now()}-${Math.random().toString(16).slice(2,6)}`}function Od(e,t){if(!Nn)return null;const a=Nn.value.trim();if(!a)return window.alert("Bitte eine Methode angeben."),Nn.focus(),null;const n=e.measurementMethods.find(l=>l.label?.toLowerCase()===a.toLowerCase()||l.id?.toLowerCase()===a.toLowerCase());if(n)return n.id;const r=Rd(a),s=e.fieldLabels?.calculation?.fields?.quantity?.unit||"Kiste",o={id:r,label:a,type:"factor",unit:s,requires:["areaHa"],config:{sourceField:"areaHa"}};return t.state.updateSlice("measurementMethods",l=>[...l,o]),r}async function Jn(e){try{const t=at();return await nt(t),e?.silent||window.alert(e?.successMessage??"Änderungen wurden gespeichert."),!0}catch(t){console.error("Fehler beim Speichern",t);const a=t instanceof Error?t.message:"Speichern fehlgeschlagen";return window.alert(a),!1}}function _d(e,t){const a=!!t.app?.hasDatabase,n=t.app?.activeSection==="settings";e.classList.toggle("d-none",!(a&&n))}function Wd(e,t){if(!e||bs)return;const a=e;a.innerHTML="";const n=Pd();a.appendChild(n),Ur=n,fi=t,Fe=0,pa?.destroy(),pa=null,Gr=null,xt=n.querySelector("#settings-mediums-table tbody"),Nn=n.querySelector('input[name="medium-method"]'),ja=n.querySelector("#settings-method-options"),Zt=n.querySelector("#settings-medium-form"),Ka=Zt?Zt.querySelector('button[type="submit"]'):null,Un=n.querySelector("#settings-profile-form"),St=n.querySelector("#profile-name"),nn=n.querySelector('input[name="profile-id"]'),Vn=n.querySelector("#settings-profile-table tbody"),Et=n.querySelector('[data-role="profile-submit"]'),jr=n.querySelector('[data-role="profile-selection-summary"]'),kt=n.querySelector('[data-role="profile-select-all"]');let r=!1,s=!1;function o(u){if(n.querySelectorAll("[data-settings-tab]").forEach(g=>{const h=g.dataset.settingsTab===u;g.classList.toggle("active",h)}),n.querySelectorAll("[data-pane]").forEach(g=>{const h=g.dataset.pane===u;g.style.display=h?"block":"none"}),u==="gps"&&!r){const g=n.querySelector('[data-feature="gps-embedded"]');g&&(Ld(g,t),r=!0)}if(u==="codes"&&!s){const g=n.querySelector('[data-feature="codes-embedded"]');g&&(Ad(),zd(g,{state:t.state,events:{subscribe:t.events?.subscribe}},{}),s=!0)}}n.querySelectorAll("[data-settings-tab]").forEach(u=>{u.addEventListener("click",()=>{const g=u.dataset.settingsTab;g&&o(g)})});async function l(){if(!Zt||va)return;const u=t.state.getState(),g=new FormData(Zt),h=(g.get("medium-name")||"").toString().trim(),k=(g.get("medium-unit")||"").toString().trim(),m=g.get("medium-value"),y=Number(m),w=(g.get("medium-approval")||"").toString().trim(),D=g.get("medium-wartezeit"),C=D?Number(D):null,M=(g.get("medium-wirkstoff")||"").toString().trim()||null;if(!h||!k||Number.isNaN(y)){window.alert("Bitte alle Felder korrekt ausfüllen.");return}const H=Od(u,t);if(!H)return;const Z=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`medium-${Date.now()}-${Math.random().toString(16).slice(2,8)}`,F={id:Z,name:h,unit:k,methodId:H,value:y,zulassungsnummer:w||null,wartezeit:C!=null&&!Number.isNaN(C)?C:null,wirkstoff:M};va=!0,Qn(!0,"Speichere...");try{t.state.updateSlice("mediums",O=>{const E=rn(O),$=[...E.items,F];return{...E,items:$,totalCount:$.length,lastUpdatedAt:new Date().toISOString()}}),ys(t.state.getState()),await Jn({successMessage:"Mittel gespeichert.",silent:!0})&&(Zt.reset(),t.events?.emit?.("mediums:data-changed",{action:"created",id:Z}))}finally{va=!1,Qn(!1)}}Zt?.addEventListener("submit",u=>{u.preventDefault(),l()}),xt?.addEventListener("click",u=>{const g=u.target?.closest('[data-action="delete"]');if(!g)return;const h=Number(g.dataset.index);Number.isNaN(h)||Id(h,t,g)}),xt?.addEventListener("change",u=>{const g=u.target;if(!g||g.dataset.role!=="profile-select")return;const h=g.dataset.mediumId;if(!h)return;g.checked?Ce.add(h):Ce.delete(h);const k=t.state.getState();Tt(k)}),kt?.addEventListener("change",()=>{const u=t.state.getState();kt&&(kt.indeterminate=!1,kt.checked?Ce=new Set(st(u).map(g=>g.id)):Ce=new Set,Zn(),Tt(u))});const c=async()=>{if(!St)return;const u=St.value.trim();if(!u){window.alert("Bitte einen Profilnamen eingeben."),St.focus();return}if(!Ce.size){window.alert("Bitte mindestens ein Mittel auswählen.");return}const g=t.state.getState();if(g.mediumProfiles?.some(w=>w.name.toLowerCase()===u.toLowerCase()&&w.id!==Nt)){window.alert("Ein Profil mit diesem Namen existiert bereits.");return}const k=st(g).filter(w=>Ce.has(w.id)).map(w=>w.id);if(!k.length){window.alert("Ausgewählte Mittel sind nicht mehr verfügbar. Bitte Auswahl prüfen."),bo(g),Zn(),Tt(g);return}if(xr)return;const m=!!Nt;xr=!0,hs(!0,m?"Aktualisiere...":"Speichere...");const y=new Date().toISOString();try{if(Nt)t.state.updateSlice("mediumProfiles",(D=[])=>D.map(C=>C.id===Nt?{...C,name:u,mediumIds:k,updatedAt:y}:C));else{const D={id:Md(),name:u,mediumIds:k,createdAt:y,updatedAt:y};t.state.updateSlice("mediumProfiles",(C=[])=>[...C,D])}await Jn({successMessage:m?"Profil aktualisiert und gespeichert.":"Profil gespeichert."})&&qn(t.state.getState())}finally{xr=!1,hs(!1)}};Un?.addEventListener("submit",u=>{u.preventDefault(),c()}),Vn?.addEventListener("click",u=>{const g=u.target?.closest('[data-action^="profile-"]');if(!g)return;const h=g.dataset.id;if(!h)return;const k=t.state.getState();if(g.dataset.action==="profile-edit"){const m=k.mediumProfiles?.find(y=>y.id===h);m&&Cd(m,k);return}if(g.dataset.action==="profile-delete"){const m=k.mediumProfiles?.find(y=>y.id===h);if(!m||!window.confirm(`Profil "${m.name}" wirklich löschen?`))return;Bd(m,t,g)}}),n.querySelector('[data-action="profile-reset"]')?.addEventListener("click",()=>{qn(t.state.getState())}),qn(t.state.getState());const p=u=>{Nd(u,t),_d(n,u),u.app.activeSection==="settings"&&(gi(u),ys(u),Fd(u),Tt(u))};t.state.subscribe(p),p(t.state.getState()),bs=!0}const Ha=e=>v(e),Er=(e,t=1)=>Number.isFinite(e)?e.toLocaleString("de-DE",{minimumFractionDigits:t,maximumFractionDigits:t}):"–";function ya(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString("de-DE")}function Kd(e){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return v(e);const a=Math.round((t.getTime()-Date.now())/864e5);return a<0?`<span style="color:#ef4444;">${ya(e)} · abgelaufen</span>`:a<180?`<span style="color:#f59e0b;">${ya(e)} · ${a} T</span>`:`<span class="calc-hint">${ya(e)}</span>`}function jd(){return`
    ...
    </section>`}function Gd(e,t){if(!(e instanceof HTMLElement))return;e.innerHTML=jd();const a=e.querySelector('[data-role="lager-uebersicht"]'),n=e.querySelector('[data-role="lager-bewegungen"]'),r=e.querySelector('[data-role="lager-form"]'),s=e.querySelector("#lager-mittel-options"),o=e.querySelector('[data-role="lager-empty"]'),l=new Map,c=k=>{if(a){if(!k.length){a.innerHTML='<tr><td colspan="6" class="calc-hint" style="padding:14px;">Noch keine Mittel. Erfasse unten einen Zugang oder dokumentiere Anwendungen in „Neu erfassen".</td></tr>';return}a.innerHTML=k.map(m=>{const y=m.bestand<0?"#ef4444":m.bestand===0?"#f59e0b":"inherit",w=v(m.einheit||"");return`<tr>
          <td><span class="fw-semibold">${v(m.name)}</span>${m.kennr?`<span class="d-block calc-hint">${v(m.kennr)}</span>`:""}</td>
          <td class="calc-hint">${v(m.wirkstoff||"")}</td>
          <td class="text-end">${Er(m.verbraucht)} ${w}<span class="d-block calc-hint">${m.anwendungen} Anw.</span></td>
          <td class="text-end fw-semibold" style="color:${y};">${Er(m.bestand)} ${w}</td>
          <td>${Kd(m.zulEnde)}</td>
          <td class="calc-hint">${m.naechsterAblauf?ya(m.naechsterAblauf):""}</td>
        </tr>`}).join("")}},p=k=>{if(n){if(!k.length){n.innerHTML='<div class="calc-hint">Keine Bewegungen erfasst.</div>';return}n.innerHTML=k.map(m=>`
        <div class="d-flex align-items-center gap-2 py-1" style="border-bottom:1px solid var(--border-1);">
          <span class="badge" style="background:${m.typ==="zugang"?"#16a34a":"#64748b"};">${v(m.typ)}</span>
          <span class="flex-grow-1">${v(m.mittelName)} · <b>${Er(m.menge)} ${v(m.einheit||"")}</b>${m.charge?` · Charge ${v(m.charge)}`:""}<span class="d-block calc-hint">${ya(m.datum)}${m.lieferant?" · "+v(m.lieferant):""}${m.ablauf?" · Ablauf "+ya(m.ablauf):""}</span></span>
          <button class="btn btn-sm" style="color:#ef4444;border:1px solid var(--border-1);background:transparent;" data-del="${Ha(m.id)}" title="Löschen">×</button>
        </div>`).join(""),n.querySelectorAll("[data-del]").forEach(m=>{m.addEventListener("click",async()=>{const y=m.getAttribute("data-del")||"";try{await gl({id:y}),await it().catch(()=>{}),await g()}catch{N.warning("Löschen fehlgeschlagen.")}})})}},u=()=>{s&&(s.innerHTML=Array.from(l.entries()).sort((k,m)=>k[0].localeCompare(m[0],"de")).map(([k,m])=>`<option value="${Ha(k)}" data-kennr="${Ha(m.kennr||"")}" data-einheit="${Ha(m.einheit||"")}" data-wirkstoff="${Ha(m.wirkstoff||"")}"></option>`).join(""))},g=async()=>{if(ce()!=="sqlite"){o&&(o.textContent="Bitte zuerst eine Datenbank öffnen.");return}try{const[k,m,y]=await Promise.all([Rs(),fl(),Os()]);c(k?.rows||[]),p(m?.rows||[]),l.clear(),(y?.rows||[]).forEach(w=>{w.name&&l.set(w.name,{kennr:w.kennr??null,einheit:w.einheit??null,wirkstoff:w.wirkstoff??null})}),(k?.rows||[]).forEach(w=>{w.name&&!l.has(w.name)&&l.set(w.name,{kennr:w.kennr??null,einheit:w.einheit??null,wirkstoff:w.wirkstoff??null})}),u()}catch(k){console.warn("[Lager] Laden fehlgeschlagen:",k)}};r?.addEventListener("submit",async k=>{if(k.preventDefault(),ce()!=="sqlite"){N.warning("Bitte zuerst eine Datenbank öffnen.");return}const m=new FormData(r),y=String(m.get("mittel")||"").trim(),w=Number(String(m.get("menge")||"").replace(",","."));if(!y||!Number.isFinite(w)){N.warning("Mittel und Menge angeben.");return}const D=String(m.get("preis")||"").trim();try{await ml({mittelName:y,kennr:String(m.get("kennr")||"").trim()||null,wirkstoff:l.get(y)?.wirkstoff||null,typ:String(m.get("typ")||"zugang"),menge:w,einheit:String(m.get("einheit")||"").trim()||null,datum:String(m.get("datum")||"").trim()||null,charge:String(m.get("charge")||"").trim()||null,ablauf:String(m.get("ablauf")||"").trim()||null,lieferant:String(m.get("lieferant")||"").trim()||null,preis:D?Number(D.replace(",",".")):null}),await it().catch(()=>{}),r.reset(),N.success("Bewegung gespeichert."),await g()}catch{N.warning("Speichern fehlgeschlagen.")}});const h=e.querySelector('[name="mittel"]');h?.addEventListener("change",()=>{const k=l.get(h.value);if(!k)return;const m=e.querySelector('[name="einheit"]'),y=e.querySelector('[name="kennr"]');m&&k.einheit&&(m.value=k.einheit),y&&k.kennr&&(y.value=k.kennr)}),t.state.subscribe(k=>{k?.app?.activeSection==="lager"&&g()}),g()}const Yn={mechanisch:{label:"Mechanisch",icon:"bi-tools",color:"#2563eb"},chemisch_psm:{label:"Pflanzenschutz",icon:"bi-droplet-half",color:"#dc2626"},duengung:{label:"Düngung",icon:"bi-flower1",color:"#b45309"},nuetzlinge:{label:"Nützlinge",icon:"bi-bug",color:"#7c3aed"},bewaesserung:{label:"Bewässerung",icon:"bi-moisture",color:"#0891b2"},monitoring:{label:"Monitoring",icon:"bi-eye",color:"#475569"},sonstiges:{label:"Sonstiges",icon:"bi-three-dots",color:"#64748b"}},Ud=["mechanisch","chemisch_psm","duengung","nuetzlinge","bewaesserung","monitoring","sonstiges"];function vo(e){return Yn[e]||Yn.sonstiges}const Vd={geplant:{label:"geplant",color:"#64748b"},aktiv:{label:"aktiv",color:"#16a34a"},abgeschlossen:{label:"abgeschlossen",color:"#94a3b8"}},Yt=["#16a34a","#0891b2","#7c3aed","#d97706","#dc2626","#0d9488","#65a30d","#db2777"],Zd=/^#[0-9a-fA-F]{3,8}$/;function yo(e){return typeof e=="string"&&Zd.test(e.trim())?e.trim():null}function ka(e,t=0){return yo(e&&e.color)||Yt[t%Yt.length]}function dt(){const e=new Date;return e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0")}function Ee(e){if(!e)return NaN;const t=String(e).slice(0,10).replace(/-/g,""),a=Number(t);return Number.isFinite(a)?a:NaN}function ma(e){const t=[...e||[]].sort((s,o)=>(Ee(s.pflanzDatum)||0)-(Ee(o.pflanzDatum)||0)),a=Number(dt().replace(/-/g,""));let n=t.find(s=>s.status==="aktiv")||null;if(!n){const s=t.filter(o=>o.status!=="abgeschlossen"&&Ee(o.pflanzDatum)<=a&&(!o.ernteDatum||Ee(o.ernteDatum)>=a));n=s.length?s[s.length-1]:null}let r=t.filter(s=>s!==n&&s.status!=="abgeschlossen"&&Ee(s.pflanzDatum)>a).sort((s,o)=>(Ee(s.pflanzDatum)||0)-(Ee(o.pflanzDatum)||0))[0]||null;return r||(r=t.filter(s=>s!==n&&s.status==="geplant").sort((s,o)=>(Ee(s.pflanzDatum)||0)-(Ee(o.pflanzDatum)||0))[0]||null),{current:n,next:r,all:t}}const ko=["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"];function wo(e,t){const a=[];let n=e.getFullYear(),r=e.getMonth();const s=t.getFullYear(),o=t.getMonth();let l=0;for(;(n<s||n===s&&r<=o)&&l<60;)a.push({y:n,m:r}),r++,r>11&&(r=0,n++),l++;return a}function je(e,t){if(!t||!e.length)return null;const a=new Date(String(t).slice(0,10)+"T00:00:00");if(isNaN(a.getTime()))return null;const n=e.length,r=a.getFullYear()*12+a.getMonth(),s=e[0].y*12+e[0].m,o=e[n-1].y*12+e[n-1].m;if(r<s)return 0;if(r>o)return 1;const l=r-s,c=new Date(a.getFullYear(),a.getMonth()+1,0).getDate();return(l+(a.getDate()-1)/c)/n}const Qd={anzucht:{label:"Anzucht (vorziehen)",short:"Anzucht"},direkt:{label:"Direktsaat",short:"Direkt"}},Jd=["Pflanzen","m²","Beete","lfd. m","g Saatgut"];function wt(e,t){if(!e)return null;const a=new Date(String(e).slice(0,10)+"T00:00:00");return isNaN(a.getTime())?null:(a.setDate(a.getDate()+Math.round(Number(t)||0)),a.getFullYear()+"-"+String(a.getMonth()+1).padStart(2,"0")+"-"+String(a.getDate()).padStart(2,"0"))}function Yd(e,t,a){if(!e||!a)return{};const r=(e.anbauMethode==="anzucht"?"anzucht":"direkt")==="anzucht"&&Number(e.anzuchtTage)||0,s=Number(e.kulturTage)||0,o=Number(e.ernteTage)||0;let l;t==="aussaat"?l=wt(a,r):t==="ernte"?l=s?wt(a,-s):a:l=a;const c=wt(l,-r),p=s?wt(l,s):null,u=p?wt(p,o):null;return{aussaatDatum:c,pflanzDatum:l,ernteVon:p,ernteBis:u}}function Xd(e,t){return e?{aussaatDatum:wt(e.aussaatDatum,t),pflanzDatum:wt(e.pflanzDatum,t),ernteVon:wt(e.ernteVon,t),ernteBis:wt(e.ernteBis,t)}:{}}function Ln(e,t){if(!t||!Array.isArray(e))return null;const a=String(t).trim().toLowerCase();return a&&(e.find(n=>String(n.name||"").trim().toLowerCase()===a)||e.find(n=>{const r=String(n.name||"").trim().toLowerCase();return r&&(r.startsWith(a)||a.startsWith(r))}))||null}let Dn=null;async function xo(){if(Dn)return Dn;const t=await import("/psm/vendor/psm-geo/psm_geo.js"),a=new URL("/psm/vendor/psm-geo/psm_geo_bg.wasm",globalThis.location?.href);return await t.default(a),Dn=t,Dn}async function eu(e,t){const n=(await xo()).compute_beds(JSON.stringify(e),t.bedW,t.pathW,t.rowSp,t.inRowSp,t.angle);return JSON.parse(n)}async function tu(){await xo()}const au=Math.PI/180;function ge(e,t=0){return Number.isFinite(e)?e.toLocaleString("de-DE",{minimumFractionDigits:t,maximumFractionDigits:t}):"–"}function Vr(e){if(e=Math.round(e||0),e<=0)return"0";if(e<100)return`≈ ${e}`;const t=e<1e3?50:e<1e4?100:500;return`≈ ${(Math.round(e/t)*t).toLocaleString("de-DE")}`}function nu(e){return e.replace(/[^\wäöüÄÖÜ.-]+/g,"_").replace(/^_+|_+$/g,"").slice(0,80)||"Acker"}function ru(e,t,a,n=.12){const r=e.map(E=>E[0]),s=e.map(E=>E[1]),o=(Math.min(...r)+Math.max(...r))/2,l=(Math.min(...s)+Math.max(...s))/2,c=Math.cos(o*au),p=(E,$)=>({x:($-l)*111320*c,y:(E-o)*111320}),u=e.map(([E,$])=>p(E,$)),g=u.map(E=>E.x),h=u.map(E=>E.y);let k=Math.min(...g),m=Math.max(...g),y=Math.min(...h),w=Math.max(...h);const D=Math.max((m-k)*n,1),C=Math.max((w-y)*n,1);k-=D,m+=D,y-=C,w+=C;const M=m-k||1,H=w-y||1,Z=Math.min(t/M,a/H),F=(t-M*Z)/2,ae=(a-H*Z)/2;return{toXY:(E,$)=>{const Y=p(E,$);return{x:(Y.x-k)*Z+F,y:a-((Y.y-y)*Z+ae)}},pxPerM:Z}}function iu(e,t,a,n=18){e.save(),e.translate(t,a),e.beginPath(),e.moveTo(0,-n),e.lineTo(n*.35,0),e.lineTo(-n*.35,0),e.closePath(),e.fillStyle="#222",e.fill(),e.strokeStyle="#222",e.lineWidth=Math.max(1.5,n*.09),e.beginPath(),e.moveTo(0,0),e.lineTo(0,n),e.stroke(),e.fillStyle="#222",e.font=`bold ${Math.round(n*.7)}px sans-serif`,e.textAlign="center",e.textBaseline="bottom",e.fillText("N",0,-n-3),e.restore()}function su(e,t,a,n){const r=[1,2,5,10,20,50,100,200,500,1e3],s=90;let o=r.find(c=>c*n<=s)??r[r.length-1];const l=o*n;e.save(),e.strokeStyle="#222",e.fillStyle="#222",e.lineWidth=2,e.beginPath(),e.moveTo(t,a),e.lineTo(t+l,a),e.stroke(),e.lineWidth=1.5,[0,l].forEach(c=>{e.beginPath(),e.moveTo(t+c,a-4),e.lineTo(t+c,a+4),e.stroke()}),e.font="11px sans-serif",e.textAlign="center",e.textBaseline="top",e.fillText(`${o} m`,t+l/2,a+5),e.restore()}function ou(e){const t=e.geo;if(!t)return null;const a=t?.geometry?.coordinates?.[0];return a?.length?a.map(([n,r])=>[r,n]):null}function So(e,t,a){const n=document.createElement("canvas");n.width=t,n.height=a;const r=n.getContext("2d");r.fillStyle="#f5f7f5",r.fillRect(0,0,t,a);const s=e.latlngs;if(!s||s.length<3)return r.fillStyle="#aaa",r.font="13px sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillText("Keine Koordinaten",t/2,a/2),n.toDataURL("image/png");const o=20,{toXY:l,pxPerM:c}=ru(s,t-o*2,a-o*2),p=(h,k)=>{const{x:m,y}=l(h,k);return{x:m+o,y:y+o}},u=e.color||"#388e3c";return r.beginPath(),s.forEach(([h,k],m)=>{const{x:y,y:w}=p(h,k);m===0?r.moveTo(y,w):r.lineTo(y,w)}),r.closePath(),r.fillStyle=`${u}28`,r.fill(),(e.result?.beds||[]).forEach((h,k)=>{const m=ou(h);!m||m.length<3||(r.beginPath(),m.forEach(([y,w],D)=>{const{x:C,y:M}=p(y,w);D===0?r.moveTo(C,M):r.lineTo(C,M)}),r.closePath(),r.fillStyle=k%2===0?`${u}cc`:`${u}88`,r.fill())}),r.beginPath(),s.forEach(([h,k],m)=>{const{x:y,y:w}=p(h,k);m===0?r.moveTo(y,w):r.lineTo(y,w)}),r.closePath(),r.strokeStyle="#1a1a1a",r.lineWidth=2,r.stroke(),iu(r,t-30,32,18),su(r,o,a-18,c),n.toDataURL("image/png")}async function lu(){const[{jsPDF:e},t]=await Promise.all([Dt(()=>import("./jspdf.es.min.YCCBj60b.js").then(n=>n.j),__vite__mapDeps([2,1])),Dt(()=>import("./jspdf.plugin.autotable.B0IxatYY.js"),[])]),a=t.default??t;return{jsPDF:e,autoTable:a}}const we=14,Eo=[34,139,34];function Lo(e,t,a){if(!t?.name)return a;if(e.setFont("helvetica","bold"),e.setFontSize(12),e.setTextColor(20),e.text(t.name,we,a),a+=5,t.address){e.setFont("helvetica","normal"),e.setFontSize(8),e.setTextColor(110);for(const n of String(t.address).split(/\r?\n/))n.trim()&&(e.text(n.trim(),we,a),a+=3.5);e.setTextColor(20)}return a+2}function Do(e,t,a){const n=e.internal.pageSize.getWidth();return e.setFont("helvetica","bold"),e.setFontSize(14),e.setTextColor(20),e.text(t,we,a),a+=4,e.setDrawColor(190),e.setLineWidth(.4),e.line(we,a,n-we,a),a+6}function ks(e,t,a,n,r,s){s||e.addPage();const l=e.internal.pageSize.getWidth()-we*2;let c=we;s&&(c=Lo(e,r,c)),c=Do(e,n,c);const p=100,u=Math.round(p*.6),g=we+p+7,h=l-p-7,k=So(a,600,360);e.addImage(k,"PNG",we,c,p,u);const m=a.result??{},y=m.beds??[],w=M=>y.length?y.reduce((H,Z)=>H+(M(Z)||0),0)/y.length:null,D=[["Fläche",`${ge(m.areaM2,0)} m²  ·  ${ge((m.areaM2??0)/1e4,3)} ha`],["Beete",ge(y.length,0)],["Beetmeter",`${ge(m.bedMeters,0)} m`],["Pflanzen (gesch.)",Vr(m.plants??0)],null,["Beet-Breite",`${ge(a.params.bedW,2)} m`],["Weg-Breite",`${ge(a.params.pathW,2)} m`],["Reihenabstand",`${ge(a.params.rowSp,2)} m`],["Pflanzabstand",`${ge(a.params.inRowSp,2)} m`],["Winkel",`${a.params.angle}°`],null,["Reihen/Beet (⌀)",y.length?ge(w(M=>M.rows),1):"–"],["Pfl./Reihe (⌀)",y.length?ge(w(M=>M.perRow),1):"–"],["Pfl./Beet (⌀)",y.length?ge(w(M=>M.plants),0):"–"],["Beet-Fläche (⌀)",y.length?`${ge(w(M=>M.areaM2),1)} m²`:"–"]];let C=c;e.setFontSize(8.5);for(const M of D){if(C>c+u+4)break;if(M===null){C+=2,e.setDrawColor(220),e.setLineWidth(.3),e.line(g,C,g+h,C),C+=2;continue}const[H,Z]=M;e.setFont("helvetica","normal"),e.setTextColor(120),e.text(H+":",g,C),e.setFont("helvetica","bold"),e.setTextColor(20),e.text(Z,g+h,C,{align:"right"}),C+=5.2}if(c+=u+7,y.length>0){e.setFont("helvetica","bold"),e.setFontSize(10),e.setTextColor(20),e.text("Beet-Details",we,c),c+=4;const M=80,H=y.slice(0,M).map((Z,F)=>[String(F+1),ge(Z.lenM,1),ge(Z.rows,0),ge(Z.perRow,0),ge(Z.plants,0),ge(Z.areaM2,1)]);y.length>M&&H.push(["…","","","",`+ ${y.length-M} weitere`,""]),t(e,{startY:c,margin:{left:we,right:we},head:[["Nr.","Länge (m)","Reihen","Pfl./Reihe","Pflanzen","Fläche (m²)"]],body:H,styles:{fontSize:8,cellPadding:1.8},headStyles:{fillColor:Eo,textColor:255,fontStyle:"bold"},columnStyles:{0:{cellWidth:12,halign:"right"},1:{cellWidth:28},2:{cellWidth:22},3:{cellWidth:28},4:{cellWidth:28},5:{cellWidth:28}},alternateRowStyles:{fillColor:[245,250,245]},theme:"striped"})}}function cu(e,t,a,n){const r=e.internal.pageSize.getWidth();let s=we;s=Lo(e,n,s),s=Do(e,"Acker-Übersicht",s);const o=(r-we*2-6)/2,l=Math.round(o*.5),c=2,p=a.slice(0,6);if(p.forEach((y,w)=>{const D=w%c,C=Math.floor(w/c),M=we+D*(o+6),H=s+C*(l+14),Z=So(y,Math.round(o*4),Math.round(l*4));e.addImage(Z,"PNG",M,H,o,l),e.setFont("helvetica","normal"),e.setFontSize(7.5),e.setTextColor(80),e.text(y.name||"Unbenannt",M+o/2,H+l+3.5,{align:"center"})}),p.length>0){const y=Math.ceil(p.length/c);s+=y*(l+14)+4}e.setFont("helvetica","bold"),e.setFontSize(10),e.setTextColor(20),e.text("Zusammenfassung",we,s),s+=4;const u=a.map(y=>{const w=y.result??{};return[y.name||"Unbenannt",ge(w.areaM2,0),ge(w.beds?.length??0,0),ge(w.bedMeters,0),Vr(w.plants??0)]}),g=a.reduce((y,w)=>y+(w.result?.areaM2??0),0),h=a.reduce((y,w)=>y+(w.result?.beds?.length??0),0),k=a.reduce((y,w)=>y+(w.result?.bedMeters??0),0),m=a.reduce((y,w)=>y+(w.result?.plants??0),0);t(e,{startY:s,margin:{left:we,right:we},head:[["Fläche","m²","Beete","Beetmeter","Pflanzen (gesch.)"]],body:u,foot:[["Gesamt",ge(g,0),ge(h,0),ge(k,0),Vr(m)]],styles:{fontSize:9,cellPadding:2},headStyles:{fillColor:Eo,textColor:255,fontStyle:"bold"},footStyles:{fillColor:[230,245,230],fontStyle:"bold",textColor:20},showFoot:"lastPage",alternateRowStyles:{fillColor:[245,250,245]},theme:"striped"})}function du(e,t){const a=e.internal.getNumberOfPages(),n=e.internal.pageSize.getWidth(),r=e.internal.pageSize.getHeight();for(let s=1;s<=a;s++)e.setPage(s),e.setFont("helvetica","normal"),e.setFontSize(7.5),e.setTextColor(150),e.text(t,we,r-5),e.text(`${s} / ${a}`,n-we,r-5,{align:"right"})}async function ws(e,t={}){if(!e.length)return;const{jsPDF:a,autoTable:n}=await lu(),r=new a({unit:"mm",format:"a4"}),s=t.company??null,o=t.singleField??(e.length===1?e[0]:null);if(o){const m=t.title||o.name||"Ackerfläche";ks(r,n,o,m,s,!0)}else cu(r,n,e,s),e.forEach((m,y)=>{ks(r,n,m,m.name||`Fläche ${y+1}`,s,!1)});const l=t.title??(o?o.name:"Acker-Übersicht")??"Acker-PDF";du(r,l);const c=`${nu(l)}.pdf`,p=r.output("blob"),u=new File([p],c,{type:"application/pdf"}),g=navigator;if(typeof g.share=="function"&&(typeof g.canShare!="function"||g.canShare({files:[u]})))try{await g.share({files:[u],title:l});return}catch(m){if(m?.name==="AbortError")return}const h=URL.createObjectURL(p),k=document.createElement("a");k.href=h,k.download=c,document.body.appendChild(k),k.click(),k.remove(),setTimeout(()=>URL.revokeObjectURL(h),1e3)}const It=["#c62828","#d32f2f","#e53935","#ef5350","#bf360c","#e64a19","#f57c00","#ffb300","#1b5e20","#2e7d32","#388e3c","#66bb6a","#0d47a1","#1565c0","#0277bd","#42a5f5","#4a148c","#6a1b9a","#8e24aa","#e91e63","#3e2723","#4e342e","#00695c","#546e7a"],uu=()=>({bedW:1.2,pathW:.4,rowSp:.5,inRowSp:.4,angle:0}),V=(e,t=0)=>Number.isFinite(e)?e.toLocaleString("de-DE",{minimumFractionDigits:t,maximumFractionDigits:t}):"–";let ee=null,_=null;const Lt=Math.PI/180;function $n(e,t,a,n){const r=e*Lt,s=a*Lt,o=(a-e)*Lt,l=(n-t)*Lt,c=Math.sin(o/2)**2+Math.cos(r)*Math.cos(s)*Math.sin(l/2)**2;return 6371e3*2*Math.atan2(Math.sqrt(c),Math.sqrt(1-c))}function pu(e,t,a,n){const r=e*Lt,s=a*Lt,o=(n-t)*Lt,l=Math.sin(o)*Math.cos(s),c=Math.cos(r)*Math.sin(s)-Math.sin(r)*Math.cos(s)*Math.cos(o);return(Math.atan2(l,c)/Lt+360)%360}function mu(e){const t=e.length;if(t<3)return 0;const a=e.reduce((o,l)=>o+l[0],0)/t,n=e.reduce((o,l)=>o+l[1],0)/t,r=Math.cos(a*Lt)*111320;let s=0;for(let o=0;o<t;o++){const l=(o+1)%t;s+=(e[o][1]-n)*r*((e[l][0]-a)*111320)-(e[l][1]-n)*r*((e[o][0]-a)*111320)}return Math.abs(s/2)}let zn=!1,Qt=[];function xs(){if(!_)return 1;const e=_.getCenter().lat;return 156543.03392*Math.cos(e*Math.PI/180)/Math.pow(2,_.getZoom())}function fu(e,t){if(!(e instanceof HTMLElement))return;e.innerHTML=gu();const a=[];let n=null;const r=new Map;let s=null,o=null,l={sat:null,osm:null},c=!0,p=!0,u=[],g=[];const h=(i,d)=>u.filter(b=>b.flaecheTyp===i&&String(b.flaecheId)===String(d)),k=(i,d)=>g.filter(b=>b.flaecheTyp===i&&String(b.flaecheId)===String(d));function m(i){const d=ma(h("acker",i.id)).current;return d&&d.kultur?{name:d.kultur,color:ka(d)}:i.kultur?{name:i.kultur,color:null}:null}function y(){const i=[];if(a.forEach(S=>{const f=S.latlngs||[];if(f.length<3)return;const P=f.map(ie=>[Number(ie[1]),Number(ie[0])]),I=P[0],G=P[P.length-1];(I[0]!==G[0]||I[1]!==G[1])&&P.push([I[0],I[1]]),i.push({type:"Feature",geometry:{type:"Polygon",coordinates:[P]},properties:{name:S.name||"",kultur:S.kultur||null,eppoCode:S.eppoCode||null,flaeche_m2:Math.round(S.result?.areaM2||0),flaeche_ha:Number(((S.result?.areaM2||0)/1e4).toFixed(4)),beete:S.result?.beds?.length||0,beetmeter_m:Math.round(S.result?.bedMeters||0),pflanzen:S.result?.plants||0,bettbreite_m:S.params?.bedW??null,wegbreite_m:S.params?.pathW??null,reihenabstand_m:S.params?.rowSp??null,pflanzabstand_m:S.params?.inRowSp??null,ausrichtung_grad:S.params?.angle??null}})}),(Ue(t.state.getState().gps?.points)||[]).forEach(S=>{const f=Number(S.latitude),P=Number(S.longitude);if(!Number.isFinite(f)||!Number.isFinite(P))return;const I=Number(S.nutzflaecheQm);i.push({type:"Feature",geometry:{type:"Point",coordinates:[P,f]},properties:{name:S.name||"Standort",typ:"standort",flaeche_m2:Number.isFinite(I)&&I>0?Math.round(I):null,kind:S.kind||null}})}),!i.length){N.warning("Keine Flächen oder Standorte zum Exportieren.");return}const b={type:"FeatureCollection",name:"PSM Acker-Planer",crs:{type:"name",properties:{name:"urn:ogc:def:crs:OGC:1.3:CRS84"}},features:i};try{const S=new Blob([JSON.stringify(b,null,2)],{type:"application/geo+json"}),f=URL.createObjectURL(S),P=document.createElement("a");P.href=f,P.download="acker-flaechen.geojson",document.body.appendChild(P),P.click(),P.remove(),setTimeout(()=>URL.revokeObjectURL(f),1e3),N.success(`${i.length} Objekt(e) als GeoJSON exportiert.`)}catch(S){console.error("[Acker] GeoJSON-Export fehlgeschlagen",S),N.error("Export fehlgeschlagen.")}}async function w(i){try{N.info("PDF wird erstellt …"),await ws([i],{singleField:i,title:i.name||"Ackerfläche"})}catch(d){console.error("[Acker] PDF-Export fehlgeschlagen",d),N.error("PDF-Export fehlgeschlagen.")}}async function D(){if(!a.length){N.warning("Keine Flächen vorhanden.");return}try{N.info("PDF wird erstellt …"),await ws(a,{title:"Acker-Übersicht"})}catch(i){console.error("[Acker] PDF-Export fehlgeschlagen",i),N.error("PDF-Export fehlgeschlagen.")}}function C(){if(!ee||!s)return;s.clearLayers(),(Ue(t.state.getState().gps?.points)||[]).forEach(d=>{const b=Number(d.latitude),S=Number(d.longitude);if(!Number.isFinite(b)||!Number.isFinite(S))return;const f=Number(d.nutzflaecheQm),P=Number.isFinite(f)&&f>0?`${Math.round(f)} m²`:"",I=d.name||"Standort",G=ee.marker([b,S],{icon:ee.divIcon({className:"acker-standort",html:'<span class="acker-standort-dot"></span>',iconSize:[16,16],iconAnchor:[8,8]})});G.bindTooltip(`${v(I)}${P?" · "+P:""}`,{permanent:!0,direction:"top",className:"acker-standort-label",offset:[0,-9]}),G.on("click",()=>Gt({typ:"haus",id:d.id,name:I,area:Number.isFinite(f)&&f>0?f:0,latlng:[b,S]})),s.addLayer(G)})}const M=i=>e.querySelector(i),H=M('[data-role="acker-list"]'),Z=M('[data-role="acker-empty"]'),F=M('[data-role="acker-totals"]'),ae=M('[data-role="acker-map"]'),O=i=>({id:i.id,name:i.name,kultur:i.kultur||null,eppoCode:i.eppoCode||null,standortId:i.standortId||null,color:i.color,latlngs:i.latlngs,areaQm:i.result?.areaM2||0,bedW:i.params.bedW,pathW:i.params.pathW,rowSp:i.params.rowSp,inRowSp:i.params.inRowSp,angle:i.params.angle,beds:i.result?.beds?.length||0,bedMeters:i.result?.bedMeters||0,plants:i.result?.plants||0}),E=(i,d=!1)=>{if(ce()!=="sqlite")return;const b=async()=>{try{const S=await hl(O(i));S?.id&&(i.id=S.id),await it().catch(()=>{})}catch(S){console.warn("[Acker] Speichern fehlgeschlagen:",S)}};if(d){b();return}clearTimeout(r.get(i._key)),r.set(i._key,setTimeout(b,600))};async function $(i,d){if(!i||i.length<3)return{areaM2:0,beds:[],bedMeters:0,plants:0};try{return await eu(i,d)}catch(b){return console.error("[Acker] WASM computeBeds fehlgeschlagen:",b),{areaM2:0,beds:[],bedMeters:0,plants:0}}}const Y=(i,d,b)=>({color:i.color,weight:d?3.5:2.5,fillColor:i.color,fillOpacity:b?0:d?.3:.18,dashArray:null}),re=(i,d,b)=>({color:"#ffffff",weight:b?1:.7,opacity:.9,fillColor:i.color,fillOpacity:b?.9:.78});function de(i){if(!p||i.bedsHidden)return!1;const d=xs(),b=(i.params?.bedW||0)/d,S=(i.params?.pathW||0)/d,f=(i.params?.pathW||0)<=.001||S>=1.2;return b>=4&&f}function xe(i){i.outline&&(_.removeLayer(i.outline),i.outline=null),i.bedsLayer&&(_.removeLayer(i.bedsLayer),i.bedsLayer=null),i.label&&o&&(o.removeLayer(i.label),i.label=null),gt(i),Kt(i)}function De(i){const d=!!i.editing;i.outline&&_.removeLayer(i.outline),i.bedsLayer&&(_.removeLayer(i.bedsLayer),i.bedsLayer=null),i.label&&o&&o.removeLayer(i.label),gt(i),Kt(i);const b=i._key===n,S=de(i);i._lastDetail=S,S&&(i.bedsLayer=ee.layerGroup(),(i.result?.beds||[]).forEach((f,P)=>{const I=ee.geoJSON(f.geo,{style:re(i,P,b),bubblingMouseEvents:!1});I.bindTooltip(`Beet ${P+1} · ${V(f.lenM,1)} m · ${f.rows}×${V(f.perRow)} = ${V(f.plants)} Pfl.`,{sticky:!0}),I.on("click",()=>lt(i._key)),I.on("contextmenu",G=>pe(i,G,P+1)),I.addTo(i.bedsLayer)}),i.bedsLayer.addTo(_)),i.outline=ee.polygon(i.latlngs,{...Y(i,b,S),className:b?"acker-outline-grab":"",bubblingMouseEvents:!1}).addTo(_),i.outline.on("click",()=>{lt(i._key),Gt({typ:"acker",id:i.id,name:i.name,area:i.result?.areaM2||0,fieldRef:i})}),i.outline.on("dblclick",()=>ia(i)),i.outline.on("contextmenu",f=>pe(i,f)),i.outline.on("mousedown",f=>un(i,f)),Je(i,b),b&&Te(i),(b||d)&&ra(i)}function Je(i,d){if(!c||!o||!i.outline)return;let b;try{b=i.outline.getBounds().getCenter()}catch{return}const S=i.result?.plants||0,f=m(i),P=f?`<em class="cr" style="--cc:${v(f.color||"#16a34a")}"><span class="dot"></span>${v(f.name)}</em>`:"";let I="";if(d&&i.latlngs?.length>=3){const ie=i.latlngs.map(mr=>mr[0]),le=i.latlngs.map(mr=>mr[1]),ct=Math.min(...ie),et=Math.max(...ie),tt=Math.min(...le),xi=Math.max(...le),Si=(ct+et)/2,Ei=(tt+xi)/2,Fo=$n(Si,tt,Si,xi),No=$n(ct,Ei,et,Ei);I=`<span class="dims">↔ ${V(Fo,0)} m · ↕ ${V(No,0)} m</span>`}const G=`<div class="acker-flabel${d?" sel":""}" style="--fc:${i.color}"><b>${v(i.name||"")}</b>${P}<i>${V(S)} Pfl.</i>${I}</div>`;i.label=ee.marker(b,{interactive:!1,keyboard:!1,icon:ee.divIcon({className:"acker-flabel-wrap",html:G,iconSize:[0,0]})}),o.addLayer(i.label)}function Te(i){gt(i);const d=i.latlngs,b=d.length;i.edgeLabels=d.map((S,f)=>{const P=d[(f+1)%b],I=(S[0]+P[0])/2,G=(S[1]+P[1])/2,ie=$n(S[0],S[1],P[0],P[1]);return ee.marker([I,G],{interactive:!1,keyboard:!1,pane:"edgeLabels",icon:ee.divIcon({className:"acker-edge-label-wrap",html:`<div class="acker-edge-label">${V(ie,1)} m</div>`,iconSize:[0,0],iconAnchor:[0,0]})}).addTo(_)})}function gt(i){(i.edgeLabels||[]).forEach(d=>_.removeLayer(d)),i.edgeLabels=[]}function Wt(i){i.latlngs?.length&&(gt(i),Te(i))}function ra(i){Kt(i),i.handles=i.latlngs.map((d,b)=>{const S=ee.marker(d,{draggable:!0,icon:ee.divIcon({className:"acker-vhandle"})}).addTo(_);return S.on("drag",f=>{i.latlngs[b]=[f.target.getLatLng().lat,f.target.getLatLng().lng],i.outline.setLatLngs(i.latlngs),Wt(i)}),S.on("dragend",()=>void ot(i)),S.on("contextmenu",f=>X(i,b,f)),S}),i.editing=!0}function Kt(i){(i.handles||[]).forEach(d=>_.removeLayer(d)),i.handles=[],i.editing=!1}function La(){a.forEach(i=>De(i))}function or(){a.forEach(i=>{de(i)!==i._lastDetail&&De(i)})}function dn(i,d){i.color=d;try{i.outline?.setStyle({color:d,fillColor:d})}catch{}if(i.bedsLayer)try{i.bedsLayer.eachLayer(S=>S.setStyle&&S.setStyle({fillColor:d}))}catch{}try{const S=i.label?.getElement?.()?.querySelector?.(".acker-flabel");S&&S.style.setProperty("--fc",d)}catch{}const b=H?.querySelector(".acker-field.sel .acker-swatch");b&&(b.style.background=d)}function ia(i){if(i.latlngs?.length)try{_.fitBounds(ee.polygon(i.latlngs).getBounds(),{maxZoom:20,padding:[40,40]})}catch{}}function Da(){const i=a.filter(d=>d.latlngs?.length>=3);if(!i.length){N.info("Keine Flächen vorhanden.");return}try{let d=ee.polygon(i[0].latlngs).getBounds();i.slice(1).forEach(b=>{d=d.extend(ee.polygon(b.latlngs).getBounds())}),_.fitBounds(d,{maxZoom:19,padding:[40,40]})}catch{}}async function ot(i){i.result=await $(i.latlngs,i.params),De(i),Ye(),E(i)}function lr(i){if(Qe("app",d=>({...d,activeSection:"kultur"})),i?.id)try{window.dispatchEvent(new CustomEvent("psm:openKultur",{detail:{typ:"acker",id:String(i.id)}}))}catch{}else N.info("Fläche wird gespeichert – in der Kulturführung gleich wählbar.")}let Ie=null;const ye=()=>{Ie&&(Ie.remove(),Ie=null,document.removeEventListener("pointerdown",jt,!0),document.removeEventListener("keydown",$a,!0))},jt=i=>{Ie&&!Ie.contains(i.target)&&ye()},$a=i=>{i.key==="Escape"&&ye()};function cr(i,d){d.style.left="",d.style.right="",d.style.top="";const b=i.getBoundingClientRect(),S=d.getBoundingClientRect(),f=S.width||210,P=S.height||260;b.right+3+f>window.innerWidth-8&&(d.style.left="auto",d.style.right="calc(100% + 3px)");let I=-5;b.top+I+P>window.innerHeight-8&&(I=Math.min(-5,window.innerHeight-8-P-b.top)),b.top+I<8&&(I=8-b.top),d.style.top=I+"px"}function za(i,d){d.forEach(b=>{if(!b)return;if(b.sep){const f=document.createElement("div");f.className="acker-ctx-sep",i.appendChild(f);return}if(b.type==="swatchGrid"){const f=document.createElement("div");f.className="acker-ctx-swatches",b.colors.forEach(G=>{const ie=document.createElement("button");ie.type="button",ie.className="acker-sw"+(G===b.current?" on":""),ie.style.background=G,ie.title=G,ie.addEventListener("click",le=>{le.stopPropagation(),ye(),b.onPick(G)}),f.appendChild(ie)});const P=document.createElement("label");P.className="acker-sw-custom",P.innerHTML=`<i class="bi bi-eyedropper"></i><input type="color" value="${b.current||"#3b82f6"}">`;const I=P.querySelector("input");I.addEventListener("input",G=>(b.onLive||b.onPick)(G.target.value)),I.addEventListener("change",G=>{b.onPick(G.target.value),ye()}),f.appendChild(P),i.appendChild(f);return}const S=document.createElement("button");if(S.type="button",S.className="acker-ctx-item"+(b.danger?" danger":"")+(b.submenu?" has-sub":"")+(b.disabled?" disabled":""),S.innerHTML=`<span class="ic">${b.icon||""}</span><span class="lb">${v(b.label)}</span>`+(b.right?`<span class="rt">${v(b.right)}</span>`:"")+(b.submenu?'<span class="ch"><i class="bi bi-chevron-right"></i></span>':""),b.submenu){const f=document.createElement("div");f.className="acker-ctx-sub",za(f,b.submenu),S.appendChild(f);let P=null;const I=()=>{P&&(clearTimeout(P),P=null),S.parentElement?.querySelectorAll(".acker-ctx-sub.open").forEach(ie=>{ie!==f&&ie.classList.remove("open")}),cr(S,f),f.classList.add("open")},G=()=>{P=setTimeout(()=>{f.classList.remove("open"),P=null},150)};S.addEventListener("pointerenter",I),S.addEventListener("pointerleave",G),f.addEventListener("pointerenter",()=>{P&&(clearTimeout(P),P=null)}),f.addEventListener("pointerleave",G)}else b.disabled||S.addEventListener("click",f=>{f.stopPropagation(),b.keepOpen||ye(),b.action?.()});i.appendChild(S)})}function We(i,d,b,S){if(ye(),Ie=document.createElement("div"),Ie.className="acker-ctx",S){const G=document.createElement("div");G.className="acker-ctx-title",G.textContent=S,Ie.appendChild(G)}za(Ie,b),document.body.appendChild(Ie);const f=Ie.getBoundingClientRect();let P=i,I=d;P+f.width>window.innerWidth-8&&(P=Math.max(8,window.innerWidth-f.width-8)),I+f.height>window.innerHeight-8&&(I=Math.max(8,window.innerHeight-f.height-8)),Ie.style.left=P+"px",Ie.style.top=I+"px",setTimeout(()=>{document.addEventListener("pointerdown",jt,!0),document.addEventListener("keydown",$a,!0)},0)}const sa=i=>{const d=i.originalEvent||i;return d&&ee.DomEvent.preventDefault?.(d),i.originalEvent&&ee.DomEvent.stop?.(i),{x:d.clientX,y:d.clientY}};function Aa(i,d){i.params.angle=(Math.round(i.params.angle+d)%180+180)%180,ot(i),N.info(`Beete-Ausrichtung: ${i.params.angle}°`)}function oa(i){if(i.length<2)return 0;let d=-1,b=0;for(let S=0;S<i.length;S++){const f=i[S],P=i[(S+1)%i.length],I=$n(f[0],f[1],P[0],P[1]);I>d&&(d=I,b=pu(f[0],f[1],P[0],P[1]))}return((90-Math.round(b))%180+180)%180}function la(i){i.params.angle=oa(i.latlngs||[]),ot(i),N.success(`Beete an Fläche ausgerichtet (${i.params.angle}°).`)}function x(i,d){i.color=d,De(i),Ye(),E(i)}function L(i,d){i.kultur=d||null,i.eppoCode=Qt.find(b=>b.kultur===i.kultur)?.eppoCode||null,De(i),Ye(),E(i),N.success(d?`Kultur: ${d}`:"Kultur entfernt.")}function W(i){i.bedsHidden=!i.bedsHidden,De(i),N.info(i.bedsHidden?"Beete ausgeblendet.":"Beete eingeblendet.")}function R(i){lt(i._key),setTimeout(()=>{const d=H?.querySelector(".acker-field.sel .acker-name");d&&(d.focus(),d.select())},30)}function A(i){const b=xs()*18/111320,S={_key:"new-"+ ++Ca,id:null,name:(i.name||"Fläche")+" (Kopie)",kultur:i.kultur,eppoCode:i.eppoCode,standortId:i.standortId,color:It[(It.indexOf(i.color)+1)%It.length],latlngs:i.latlngs.map(f=>[f[0]+b,f[1]+b]),params:{...i.params},outline:null,bedsLayer:null,label:null,handles:[],result:{areaM2:0,beds:[],bedMeters:0,plants:0}};a.push(S),n=S._key,ot(S),E(S,!0),N.success("Fläche dupliziert.")}function B(i){const d=i.latlngs||[];if(d.length<3){N.warning("Fläche hat keine Geometrie.");return}const b=d.map(f=>[Number(f[1]),Number(f[0])]);(b[0][0]!==b[b.length-1][0]||b[0][1]!==b[b.length-1][1])&&b.push([b[0][0],b[0][1]]);const S={type:"FeatureCollection",crs:{type:"name",properties:{name:"urn:ogc:def:crs:OGC:1.3:CRS84"}},features:[{type:"Feature",geometry:{type:"Polygon",coordinates:[b]},properties:{name:i.name||"",kultur:i.kultur||null,eppoCode:i.eppoCode||null,flaeche_m2:Math.round(i.result?.areaM2||0),beete:i.result?.beds?.length||0,beetmeter_m:Math.round(i.result?.bedMeters||0),pflanzen:i.result?.plants||0}}]};try{const f=new Blob([JSON.stringify(S,null,2)],{type:"application/geo+json"}),P=URL.createObjectURL(f),I=document.createElement("a");I.href=P,I.download=`${(i.name||"flaeche").replace(/[^\w\-]+/g,"_")}.geojson`,document.body.appendChild(I),I.click(),I.remove(),setTimeout(()=>URL.revokeObjectURL(P),1e3),N.success("Fläche als GeoJSON exportiert.")}catch{N.error("Export fehlgeschlagen.")}}async function T(i){const d=i.result||{},b=[`Fläche: ${i.name||""}`,i.kultur?`Kultur: ${i.kultur}`:"",`Größe: ${V(d.areaM2||0)} m² (${V((d.areaM2||0)/1e4,3)} ha)`,`Beete: ${V(d.beds?.length||0)}`,`Beetmeter: ${V(d.bedMeters||0)} m`,`Pflanzen: ${V(d.plants||0)}`].filter(Boolean).join(`
`);try{await navigator.clipboard.writeText(b),N.success("Werte kopiert.")}catch{N.warning("Kopieren nicht möglich.")}}const ue=i=>({icon:'<i class="bi bi-palette"></i>',label:"Farbe",submenu:[{type:"swatchGrid",colors:It,current:i.color,onPick:d=>x(i,d),onLive:d=>dn(i,d)}]}),be=i=>({icon:'<i class="bi bi-flower1"></i>',label:"Kultur zuweisen",submenu:[{icon:'<i class="bi bi-x"></i>',label:"– keine –",action:()=>L(i,null)},...Qt.length?[{sep:!0}]:[],...Qt.map(d=>({icon:d.kultur===i.kultur?'<i class="bi bi-check2"></i>':"",label:`${d.kultur}${d.anbau?" ("+d.anbau+")":""}`,action:()=>L(i,d.kultur)}))]});function pe(i,d,b){lt(i._key);const{x:S,y:f}=sa(d),P=!!i.editing;We(S,f,[{icon:'<i class="bi bi-clipboard2-pulse"></i>',label:"Kulturführung öffnen",action:()=>lr(i)},{icon:'<i class="bi bi-pencil"></i>',label:"Umbenennen",action:()=>R(i)},be(i),ue(i),{sep:!0},{icon:'<i class="bi bi-arrow-clockwise"></i>',label:"Beete drehen +15°",keepOpen:!0,action:()=>Aa(i,15)},{icon:'<i class="bi bi-arrow-counterclockwise"></i>',label:"Beete drehen −15°",keepOpen:!0,action:()=>Aa(i,-15)},{icon:'<i class="bi bi-bounding-box"></i>',label:"Beete an Fläche ausrichten",action:()=>la(i)},{icon:'<i class="bi bi-grid-3x3-gap"></i>',label:i.bedsHidden?"Beete einblenden":"Beete ausblenden",action:()=>W(i)},{icon:'<i class="bi bi-bounding-box-circles"></i>',label:P?"Eckpunkte fertig":"Eckpunkte bearbeiten",action:()=>{P?Kt(i):ra(i)}},{sep:!0},{icon:'<i class="bi bi-copy"></i>',label:"Duplizieren",action:()=>A(i)},{icon:'<i class="bi bi-zoom-in"></i>',label:"Auf Fläche zoomen",action:()=>ia(i)},{icon:'<i class="bi bi-clipboard-data"></i>',label:"Werte kopieren",action:()=>T(i)},{icon:'<i class="bi bi-download"></i>',label:"Als GeoJSON exportieren",action:()=>B(i)},{sep:!0},{icon:'<i class="bi bi-trash"></i>',label:"Löschen",danger:!0,action:()=>Pa(i._key)}],b?`${i.name||"Fläche"} · Beet ${b}`:i.name||"Fläche")}function X(i,d,b){const{x:S,y:f}=sa(b);We(S,f,[{icon:'<i class="bi bi-node-minus"></i>',label:"Eckpunkt löschen",disabled:i.latlngs.length<=3,action:()=>{i.latlngs.length<=3||(i.latlngs.splice(d,1),ot(i))}},{icon:'<i class="bi bi-check2"></i>',label:"Bearbeiten beenden",action:()=>Kt(i)}],`Eckpunkt ${d+1}`)}function Q(){!l.sat||!l.osm||(_.hasLayer(l.sat)?(_.removeLayer(l.sat),l.osm.addTo(_),N.info("Karte: OSM")):(_.removeLayer(l.osm),l.sat.addTo(_),N.info("Karte: Satellit")))}function te(i){const d=i.latlng,{x:b,y:S}=sa(i);We(b,S,[{icon:'<i class="bi bi-pencil-square"></i>',label:"Neue Fläche hier zeichnen",action:()=>{ht(!0),hi({latlng:d})}},{icon:'<i class="bi bi-crosshair"></i>',label:"Hierhin zentrieren",action:()=>_.panTo(d)},{sep:!0},{icon:'<i class="bi bi-arrows-fullscreen"></i>',label:"Alle Flächen anzeigen",disabled:!a.some(f=>f.latlngs?.length>=3),action:Da},{icon:'<i class="bi bi-layers"></i>',label:"Kartentyp wechseln (Satellit/OSM)",action:Q},{sep:!0},{icon:'<i class="bi bi-geo-alt"></i>',label:"Koordinaten kopieren",action:async()=>{try{await navigator.clipboard.writeText(`${d.lat.toFixed(6)}, ${d.lng.toFixed(6)}`),N.success("Koordinaten kopiert.")}catch{N.warning("Kopieren nicht möglich.")}}}],"Karte")}function he(i){return['<option value="">– Kultur –</option>'].concat(Qt.map(d=>{const b=`${d.kultur}${d.anbau?" ("+d.anbau+")":""}`;return`<option value="${v(d.kultur)}"${d.kultur===i?" selected":""}>${v(b)}</option>`})).join("")}function Se(i){const d=Ue(t.state.getState().gps?.points)||[];return['<option value="">– Standort –</option>'].concat(d.map(b=>`<option value="${v(b.id)}"${b.id===i?" selected":""}>${v(b.name||"")}</option>`)).join("")}function Ke(i){const d=m(i);return d?`<span class="acker-cropchip" title="Kultur"><span class="dot" style="background:${v(d.color||"#94a3b8")}"></span>${v(d.name)}</span>`:""}function q(i){if(i=Math.round(i||0),i<=0)return"0";let d=100;return i>=1e5?d=1e3:i>=1e4&&(d=500),"≈ "+V(Math.round(i/d)*d)}function me(i,d){const b=i.result?.beds?.length||0,S=i.params.bedW+i.params.pathW;if(b<1||S<=0){N.warning("Erst Beete berechnen lassen.");return}const P=+(b*S/d-i.params.pathW).toFixed(2);if(P<.1){N.warning("Wegbreite ist größer als der gewünschte Abstand – erst Wegbreite verkleinern.");return}i.params.bedW=P,ot(i),N.success(`Bettbreite ${V(P,2)} m → ${i.result?.beds?.length||0} Beete.`)}function ze(){if(!F)return;let i=0,d=0,b=0,S=0;a.forEach(P=>{i+=P.result?.areaM2||0,d+=P.result?.beds?.length||0,b+=P.result?.bedMeters||0,S+=P.result?.plants||0});const f=(P,I)=>{const G=F.querySelector(P);G&&(G.textContent=I)};f('[data-t="area"]',V(i)+" m² · "+V(i/1e4,3)+" ha"),f('[data-t="beds"]',V(d)),f('[data-t="meters"]',V(b)+" m"),f('[data-t="plants"]',q(S))}function ke(i,d){const b=d.result||{},S=i.querySelector(".acker-stat");S&&(S.textContent=V(b.plants||0)+" Pfl.");const f=(I,G)=>{const ie=i.querySelector(`[data-r="${I}"]`);ie&&(ie.textContent=G)};f("area",V(b.areaM2||0)+" m² · "+V((b.areaM2||0)/1e4,3)+" ha"),f("pitch",V(d.params.bedW+d.params.pathW,2)+" m"),f("beds",V(b.beds?.length||0)),f("meters",V(b.bedMeters||0)+" m"),f("plants",q(b.plants||0));const P=b.beds||[];if(P.length){const I=G=>P.reduce((ie,le)=>ie+(G(le)||0),0)/P.length;f("rows-per-bed",V(I(G=>G.rows),1)),f("per-row",V(I(G=>G.perRow),1)),f("plants-per-bed",V(I(G=>G.plants),0)),f("bed-area",V(I(G=>G.areaM2),1)+" m²")}ze()}const Pt=["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."];function j(i){if(!i)return"";const d=new Date(String(i).slice(0,10)+"T00:00:00");return isNaN(d.getTime())?"":`${d.getDate()}. ${Pt[d.getMonth()]}`}function se(i){const d=i?.ernteVon?j(i.ernteVon):"",b=i?.ernteBis||i?.ernteDatum?j(i.ernteBis||i.ernteDatum):"";return d&&b?`Ernte ${d}–${b}`:b?`Ernte ~${b}`:d?`Ernte ab ${d}`:""}function Ae(){const i=M('[data-role="acker-info"]');i&&(i.style.display="none")}function Gt(i){const d=M('[data-role="acker-info"]');if(!d)return;const{current:b,next:S}=ma(h(i.typ,i.id)),f=k(i.typ,i.id).filter(tt=>tt.status==="geplant").length,P=i.typ==="haus",I=i.area?`${V(i.area)} m²`:"",G=b?ka(b):"#94a3b8",ie=b?`<div class="ai-row"><span class="ai-dot" style="background:${v(G)}"></span>
           <div><div class="ai-crop">${v(b.kultur||"Kultur")}</div>
           <div class="ai-sub">${v([b.pflanzDatum?"gepflanzt "+j(b.pflanzDatum):"",se(b)].filter(Boolean).join(" · "))}</div></div></div>`:'<div class="ai-row"><span class="ai-dot" style="background:#cbd5e1"></span><div class="ai-crop muted">Fläche ist frei</div></div>',le=S?`<div class="ai-next"><i class="bi bi-arrow-right-short"></i> Danach: <b>${v(S.kultur||"")}</b>${S.pflanzDatum?" ab "+j(S.pflanzDatum):""}</div>`:"",ct=!P&&i.fieldRef?`<div class="ai-metrics"><span><b>${V(i.fieldRef.result?.beds?.length||0)}</b> Beete</span><span><b>${V(i.fieldRef.result?.bedMeters||0)}</b> m</span><span><b>${q(i.fieldRef.result?.plants||0)}</b> Pfl.</span></div>`:"",et=`<div class="ai-tasks${f?" has":""}"><i class="bi ${f?"bi-list-check":"bi-check2-circle"}"></i> ${f?f+" Aufgabe"+(f===1?"":"n")+" offen":"Nichts offen"}</div>`;d.innerHTML=`
      <div class="ai-head">
        <div class="ai-title"><b>${v(i.name||"Fläche")}</b><span class="ai-badge">${P?"Gewächshaus":"Freiland"}${I?" · "+I:""}</span></div>
      ...
      <div class="ai-actions">
      ...
      </div>`,d.style.display="block",d.querySelector('[data-ai="close"]')?.addEventListener("click",Ae),d.querySelector('[data-ai="kultur"]')?.addEventListener("click",()=>{Qe("app",tt=>({...tt,activeSection:"kultur"}));try{window.dispatchEvent(new CustomEvent("psm:openKultur",{detail:{typ:i.typ,id:String(i.id)}}))}catch{}}),d.querySelector('[data-ai="zoom"]')?.addEventListener("click",()=>{!P&&i.fieldRef?ia(i.fieldRef):i.latlng&&_.setView(i.latlng,Math.max(_.getZoom(),18))})}function Ye(){if(!H||!Z||!F)return;Z.style.display=a.length?"none":"block",F.style.display=a.length?"block":"none",H.innerHTML="";let i=0,d=0,b=0,S=0;a.forEach(f=>{i+=f.result?.areaM2||0,d+=f.result?.beds?.length||0,b+=f.result?.bedMeters||0,S+=f.result?.plants||0;const P=f._key===n,I=document.createElement("div");I.className="acker-field"+(P?" sel open":""),I.innerHTML=`
        <div class="acker-fhead">
          <span class="acker-swatch" style="background:${f.color}"></span>
          <input class="acker-name" value="${v(f.name)}" />
          ${Ke(f)}
          <span class="acker-stat">${V(f.result?.plants||0)} Pfl.</span>
        </div>
        <div class="acker-fbody">
          <div class="acker-grid">
            <label class="acker-fld span2">Kultur<select data-k="kultur">${he(f.kultur)}</select></label>
            <label class="acker-fld span2">Standort (für PSM)<select data-k="standortId">${Se(f.standortId)}</select></label>
          ...
          <div class="acker-res">
            <div class="r"><span>Fläche</span><b data-r="area">${V(f.result?.areaM2||0)} m² · ${V((f.result?.areaM2||0)/1e4,3)} ha</b></div>
            <div class="r"><span>Abstand (Mitte–Mitte)</span><b data-r="pitch">${V(f.params.bedW+f.params.pathW,2)} m</b></div>
            <div class="r"><span>Beete</span><b data-r="beds">${V(f.result?.beds?.length||0)}</b></div>
            <div class="r"><span>Beetmeter</span><b data-r="meters">${V(f.result?.bedMeters||0)} m</b></div>
            <div class="r"><span>Pflanzen (geschätzt)</span><b data-r="plants">${q(f.result?.plants||0)}</b></div>
            <div class="sep"></div>
        ...
        </div>`,I.querySelector(".acker-fhead").addEventListener("click",le=>{le.target.classList.contains("acker-name")||(lt(f._key),Gt({typ:"acker",id:f.id,name:f.name,area:f.result?.areaM2||0,fieldRef:f}))}),I.querySelector(".acker-name").addEventListener("input",le=>{f.name=le.target.value,E(f)}),I.querySelectorAll("[data-k]").forEach(le=>{const ct=le.dataset.k;if(ct==="kultur"){le.addEventListener("input",et=>{f.kultur=et.target.value||null,f.eppoCode=Qt.find(tt=>tt.kultur===f.kultur)?.eppoCode||null,De(f),E(f)});return}if(ct==="standortId"){le.addEventListener("input",et=>{f.standortId=et.target.value||null,E(f)});return}le.addEventListener("input",et=>{if(ct==="angle"?f.params.angle=+et.target.value:f.params[ct]=parseFloat(et.target.value)||0,f.result=$(f.latlngs,f.params),De(f),ke(I,f),ct==="angle"){const tt=I.querySelector(".acker-angle-head b");tt&&(tt.textContent=f.params.angle+"°")}E(f)})}),I.querySelector('[data-act="align"]')?.addEventListener("click",()=>la(f)),I.querySelector('[data-act="calib"]')?.addEventListener("click",()=>{const le=Math.round(Number(I.querySelector("[data-calib]")?.value)||0);le>=1?me(f,le):N.warning("Bitte die echte Beetzahl eingeben.")}),I.querySelector('[data-act="del"]').addEventListener("click",()=>Pa(f._key)),I.querySelector('[data-act="zoom"]').addEventListener("click",()=>ia(f)),I.querySelector('[data-act="dup"]').addEventListener("click",()=>A(f)),I.querySelector('[data-act="rot"]').addEventListener("click",()=>Aa(f,15)),I.querySelector('[data-act="pdf"]').addEventListener("click",()=>w(f));const ie=I.querySelector('[data-act="color"]');ie.addEventListener("input",le=>dn(f,le.target.value)),ie.addEventListener("change",le=>x(f,le.target.value)),H.appendChild(I)}),F.querySelector('[data-t="area"]').textContent=V(i)+" m² · "+V(i/1e4,3)+" ha",F.querySelector('[data-t="beds"]').textContent=V(d),F.querySelector('[data-t="meters"]').textContent=V(b)+" m",F.querySelector('[data-t="plants"]').textContent=V(S)}function lt(i){n=i,a.forEach(d=>De(d)),Ye(),setTimeout(()=>{const d=H?.querySelector(".acker-field.sel");d&&d.scrollIntoView({behavior:"smooth",block:"nearest"})},20)}async function Pa(i){const d=a.find(S=>S._key===i);if(!d)return;xe(d);const b=a.findIndex(S=>S._key===i);if(b>=0&&a.splice(b,1),n===i&&(n=null),Ye(),d.id&&ce()==="sqlite")try{await bl({id:d.id}),await it().catch(()=>{})}catch{}}let Be=null;function un(i,d){Ut||i._key!==n||(Be={fl:i,lastLL:d.latlng,moved:!1},_.dragging.disable(),_.getContainer().style.cursor="grabbing",ee.DomEvent.stop(d))}function dr(i){if(!Be)return;const d=Be.fl;if(!Be.moved){d.bedsLayer&&(_.removeLayer(d.bedsLayer),d.bedsLayer=null);try{d.outline.setStyle({fillOpacity:.3,dashArray:"6 5"})}catch{}}const b=i.latlng.lat-Be.lastLL.lat,S=i.latlng.lng-Be.lastLL.lng;Be.lastLL=i.latlng,Be.moved=!0,d.latlngs=d.latlngs.map(f=>[f[0]+b,f[1]+S]);try{d.outline.setLatLngs(d.latlngs)}catch{}if((d.handles||[]).forEach((f,P)=>{try{f.setLatLng(d.latlngs[P])}catch{}}),d.label)try{d.label.setLatLng(d.outline.getBounds().getCenter())}catch{}}function pn(){if(!Be)return;const i=Be.fl,d=Be.moved;Be=null,_.dragging.enable(),_.getContainer().style.cursor="",d&&ot(i)}function Ma(i){if(fe.length<3)return!1;const d=_.latLngToContainerPoint(ee.latLng(fe[0][0],fe[0][1])),b=_.latLngToContainerPoint(i);return d.distanceTo(b)<=14}function Mt(i){const d=M('[data-role="acker-draw-stats"]');if(!d)return;const b=mu(i);d.textContent=`${fe.length} Punkt${fe.length===1?"":"e"}`+(b>0?` · ~${V(b)} m²`:"")}let Ut=!1,fe=[],Xe=null,bt=[],Ca=0,mn=0,_e=null;function fn(){return _e||(_e=document.createElement("div"),_e.className="acker-draw-cur",_e.innerHTML='<svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="19" cy="19" r="9" stroke="#22c55e" stroke-width="2.5"/><line x1="19" y1="2" x2="19" y2="9" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round"/><line x1="19" y1="29" x2="19" y2="36" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round"/><line x1="2" y1="19" x2="9" y2="19" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round"/><line x1="29" y1="19" x2="36" y2="19" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round"/><circle cx="19" cy="19" r="2.5" fill="#22c55e"/></svg>',document.body.appendChild(_e)),_e}function gn(i){const d=fn();d.style.left=i.clientX+"px",d.style.top=i.clientY+"px",d.style.opacity="1"}function Ct(){_e&&(_e.style.opacity="0")}function ur(){Xe&&(_.removeLayer(Xe),Xe=null),bt.forEach(i=>_.removeLayer(i)),bt=[],fe=[]}function ht(i){Ut=i,M('[data-role="acker-banner"]').style.display=i?"block":"none",M('[data-role="acker-draw"]').style.display=i?"none":"block";const d=_.getContainer();if(i){mn=Date.now()+250,d.style.cursor="none";const b=fn();b.style.opacity="0",d.addEventListener("mousemove",gn),d.addEventListener("mouseleave",Ct),_.on("mousemove",vi)}else d.style.cursor="",_e&&(_e.style.opacity="0"),d.removeEventListener("mousemove",gn),d.removeEventListener("mouseleave",Ct),_.off("mousemove",vi),ur()}function Vt(i){const d=i?[...fe,[i.lat,i.lng]]:fe;if(d.length<2){Xe&&(_.removeLayer(Xe),Xe=null);return}Xe?Xe.setLatLngs(d):Xe=ee.polygon(d,{interactive:!1,className:"acker-draw-preview",color:"#22c55e",weight:2.5,fillColor:"#22c55e",fillOpacity:.18,dashArray:"6 5"}).addTo(_)}function pr(i,d){const b=ee.circleMarker(i,{radius:d?7:5,color:"#fff",fillColor:d?"#16a34a":"#22c55e",fillOpacity:1,weight:2,interactive:d,bubblingMouseEvents:!1}).addTo(_);d&&(b.bindTooltip("Zum Schließen anklicken",{direction:"top"}),b.on("click",S=>{ee.DomEvent.stop(S),fe.length>=3&&bn()})),bt.push(b)}function hi(i){if(!Ut){Ae();return}if(!(Date.now()<mn)){if(Ma(i.latlng)){bn();return}fe.push([i.latlng.lat,i.latlng.lng]),pr(i.latlng,fe.length===1),Vt(),Mt(fe)}}function vi(i){if(!Ut||!fe.length)return;const d=Ma(i.latlng);if(Vt(d?void 0:i.latlng),bt[0])try{bt[0].setRadius(d?10:7),bt[0].setStyle({weight:d?3:2})}catch{}Mt(d?fe:[...fe,[i.latlng.lat,i.latlng.lng]])}function yi(){if(!fe.length)return;fe.pop();const i=bt.pop();i&&_.removeLayer(i),Vt(),Mt(fe)}function bn(){if(fe.length<3){N.warning("Mindestens 3 Punkte setzen.");return}const i={_key:"new-"+ ++Ca,id:null,name:"Fläche "+(a.length+1),kultur:null,eppoCode:null,standortId:null,color:It[a.length%It.length],latlngs:fe.map(d=>d.slice()),params:{...uu(),angle:oa(fe)},outline:null,bedsLayer:null,handles:[],result:{areaM2:0,beds:[],bedMeters:0,plants:0}};a.push(i),ht(!1),n=i._key,ot(i),E(i,!0)}async function ki(){const i=M('[data-role="acker-q"]').value.trim();if(i)try{const b=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(i))).json();b[0]?_.setView([+b[0].lat,+b[0].lon],18):N.info("Nichts gefunden.")}catch{N.warning("Suche nicht verfügbar.")}}async function Co(){if(zn){setTimeout(()=>_&&_.invalidateSize(),60);return}zn=!0;try{const[f]=await Promise.all([Dt(()=>import("./leaflet-src.BcflbDBd.js").then(P=>P.l),__vite__mapDeps([3,4])).then(async P=>(await Dt(()=>Promise.resolve({}),__vite__mapDeps([5])),P)),tu()]);ee=f.default||f}catch(f){console.warn("[Acker] Karten-Bibliotheken konnten nicht geladen werden:",f),Z&&(Z.textContent="Karte konnte nicht geladen werden (offline?)."),zn=!1;return}_=ee.map(ae,{doubleClickZoom:!1,zoomControl:!0,attributionControl:!0}).setView([47.818,8.976],17);const i=ee.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{maxZoom:21,maxNativeZoom:19,attribution:"Tiles © Esri"}).addTo(_),d=ee.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:"© OpenStreetMap"});l={sat:i,osm:d},s=ee.layerGroup(),C(),s.addTo(_),o=ee.layerGroup().addTo(_);const b=_.createPane("edgeLabels");b.style.zIndex="650",b.style.pointerEvents="none";const S=ee.DomUtil.create("div","acker-info");S.setAttribute("data-role","acker-info"),S.style.display="none",_.getContainer().appendChild(S),ee.DomEvent.disableClickPropagation(S),ee.DomEvent.disableScrollPropagation(S),_.on("click",hi),_.on("contextmenu",f=>{if(Ut){ee.DomEvent.preventDefault?.(f.originalEvent||f),yi();return}te(f)}),_.on("mousemove",dr),_.on("mouseup",pn),document.addEventListener("mouseup",pn),_.on("zoomend",or),M('[data-role="acker-draw"]').addEventListener("click",()=>ht(!0)),M('[data-role="acker-export"]')?.addEventListener("click",y),M('[data-role="acker-export-pdf"]')?.addEventListener("click",D),M('[data-role="acker-finish"]').addEventListener("click",bn),M('[data-role="acker-cancel"]').addEventListener("click",()=>ht(!1)),M('[data-role="acker-go"]').addEventListener("click",ki),M('[data-role="acker-q"]').addEventListener("keydown",f=>{f.key==="Enter"&&ki()}),M('[data-role="ctrl-fit"]')?.addEventListener("click",Da),M('[data-role="ctrl-labels"]')?.addEventListener("click",()=>{c=!c,M('[data-role="ctrl-labels"]')?.classList.toggle("on",c),La()}),M('[data-role="ctrl-beds"]')?.addEventListener("click",()=>{p=!p,M('[data-role="ctrl-beds"]')?.classList.toggle("on",p),La()}),M('[data-role="ctrl-basemap"]')?.addEventListener("click",Q),document.addEventListener("keydown",f=>{Ut&&(f.key==="Backspace"&&(f.preventDefault(),yi()),f.key==="Enter"&&bn(),f.key==="Escape"&&ht(!1))}),await Io(),await wi(),await Bo(),setTimeout(()=>_.invalidateSize(),60)}async function Io(){if(ce()==="sqlite")try{Qt=(await Jr())?.rows||[]}catch{Qt=[]}}async function wi(){if(ce()!=="sqlite"){u=[],g=[];return}try{u=(await $r())?.rows||[]}catch{u=[]}try{g=(await Pn())?.rows||[]}catch{g=[]}}async function Bo(){if(ce()==="sqlite")try{const i=await Yr();for(const b of i?.rows||[]){const S={_key:"db-"+b.id,id:b.id,name:b.name,kultur:b.kultur,eppoCode:b.eppoCode,standortId:b.standortId,color:b.color||It[a.length%It.length],latlngs:b.latlngs||[],params:{bedW:b.bedW??1.2,pathW:b.pathW??.4,rowSp:b.rowSp??.5,inRowSp:b.inRowSp??.4,angle:b.angle??0},outline:null,bedsLayer:null,handles:[],edgeLabels:[],result:{areaM2:0,beds:[],bedMeters:0,plants:0}};S.result=await $(S.latlngs,S.params),a.push(S),De(S)}Ye();const d=a.find(b=>b.latlngs?.length);if(d&&_)try{_.fitBounds(ee.polygon(d.latlngs).getBounds(),{maxZoom:19,padding:[30,30]})}catch{}}catch(i){console.warn("[Acker] Flächen laden fehlgeschlagen:",i)}}t.state.subscribe(i=>{if(i?.app?.activeSection==="acker"){if(!zn){Co();return}(async()=>(await wi(),La(),Ye(),setTimeout(()=>_&&_.invalidateSize(),60)))()}}),Ye()}function gu(){return`
  <style>
  ...
  <section class="calc-section">
  ...
  </section>`}function Ra(e){return e.typ+":"+e.id}function bu(e){if(!Array.isArray(e)||e.length<3)return null;let t=0,a=0,n=0;const r=e.length,s=e[r-1],o=e[0],c=s&&o&&Number(s[0])===Number(o[0])&&Number(s[1])===Number(o[1])?r-1:r;for(let p=0;p<c;p++){const u=Number(e[p]?.[0]),g=Number(e[p]?.[1]);Number.isFinite(u)&&Number.isFinite(g)&&(t+=u,a+=g,n++)}return n?{lat:t/n,lon:a/n}:null}async function Ss(e){const t=[];(Ue(e.state.getState().gps?.points)||[]).forEach(n=>{if(n?.kind!=="gewaechshaus")return;const r=Number(n.latitude),s=Number(n.longitude),o=Number(n.nutzflaecheQm);t.push({typ:"haus",id:String(n.id),name:n.name||"Gewächshaus",areaQm:Number.isFinite(o)&&o>0?o:null,lat:Number.isFinite(r)?r:null,lon:Number.isFinite(s)?s:null,color:null})});try{((await Yr())?.rows||[]).forEach(r=>{const s=bu(r.latlngs),o=Number(r.areaQm);t.push({typ:"acker",id:String(r.id),name:r.name||"Fläche",areaQm:Number.isFinite(o)&&o>0?o:null,lat:s?.lat??null,lon:s?.lon??null,color:r.color||null})})}catch{}return t}const hu="Wetterdaten: Open-Meteo (CC BY 4.0)",vu="psm.weather.";function yu(){const e=new Date;return e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0")}function ku(e,t){return vu+e.toFixed(3)+"_"+t.toFixed(3)}function wu(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}}function xu(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function Su(e){return!!e&&e.slice(0,10)===yu()}function Eu(e,t,a){const n=e?.time||[],r=e?.temperature_2m_max||[],s=e?.temperature_2m_min||[],o=e?.precipitation_sum||[],l=e?.sunshine_duration||[],c=Wn(new Date),p=Ai(c.year,c.week),u=new Map;for(let h=0;h<n.length;h++){const k=qs(n[h]);if(!k)continue;const{year:m,week:y}=Wn(k),w=Ai(m,y);let D=u.get(w);D||(D={key:w,year:m,week:y,tmaxSum:0,tmaxN:0,tminSum:0,tminN:0,precip:0,precipN:0,sun:0,sunN:0,days:0},u.set(w,D)),Number.isFinite(r[h])&&(D.tmaxSum+=r[h],D.tmaxN++),Number.isFinite(s[h])&&(D.tminSum+=s[h],D.tminN++),Number.isFinite(o[h])&&(D.precip+=o[h],D.precipN++),Number.isFinite(l[h])&&(D.sun+=l[h],D.sunN++),D.days++}const g=[...u.values()].sort((h,k)=>h.key<k.key?-1:h.key>k.key?1:0).map(h=>{const k=h.tmaxN?h.tmaxSum/h.tmaxN:null,m=h.tminN?h.tminSum/h.tminN:null;return{weekKey:h.key,year:h.year,week:h.week,tMaxAvg:k,tMinAvg:m,tMeanAvg:k!=null&&m!=null?(k+m)/2:k,precipSum:h.precipN?h.precip:null,sunHours:h.sunN?h.sun/3600:null,days:h.days,isForecast:h.key>=p}});return{lat:t,lon:a,fetchedAt:new Date().toISOString(),weeks:g}}async function Lu(e,t){if(!Number.isFinite(e)||!Number.isFinite(t))return{lat:e,lon:t,fetchedAt:new Date().toISOString(),weeks:[]};const a=ku(e,t),n=wu(a);if(n&&Su(n.fetchedAt)&&n.weeks?.length)return n;if(typeof navigator<"u"&&navigator.onLine===!1)return n?{...n,stale:!0}:{lat:e,lon:t,fetchedAt:new Date().toISOString(),weeks:[]};const r="https://api.open-meteo.com/v1/forecast?latitude="+e.toFixed(4)+"&longitude="+t.toFixed(4)+"&daily=temperature_2m_max,temperature_2m_min,precipitation_sum,sunshine_duration&timezone=Europe%2FBerlin&past_days=92&forecast_days=16";try{const s=await fetch(r);if(!s.ok)throw new Error("HTTP "+s.status);const o=await s.json(),l=Eu(o.daily,e,t);return l.weeks.length&&xu(a,l),l}catch{return n?{...n,stale:!0}:{lat:e,lon:t,fetchedAt:new Date().toISOString(),weeks:[]}}}const Lr=66;function Du(e,t){const{units:a,anbau:n,mass:r,onSelect:s,onContext:o}=t;if(!a||!a.length){e.innerHTML='<div class="km-empty"><i class="bi bi-calendar3"></i><p>Noch keine Flächen für den Anbauplan.</p></div>';return}const l=new Date;let c=new Date(l.getFullYear(),l.getMonth()-1,1),p=new Date(l.getFullYear(),l.getMonth()+4,1);const u=F=>{if(!F)return;const ae=new Date(String(F).slice(0,10)+"T00:00:00");isNaN(ae.getTime())||(ae<c&&(c=new Date(ae.getFullYear(),ae.getMonth(),1)),ae>p&&(p=new Date(ae.getFullYear(),ae.getMonth(),1)))};(n||[]).forEach(F=>{u(F.pflanzDatum),u(F.ernteBis||F.ernteDatum),u(F.ernteVon)}),(r||[]).forEach(F=>u(F.planDatum||F.erledigtDatum));const g=wo(c,p),h=g.length,k=h*Lr,m=F=>F==null?null:(F*100).toFixed(2)+"%",y=je(g,l.toISOString()),w=a.filter(F=>F.typ==="haus"),D=a.filter(F=>F.typ==="acker");let C="";g.forEach((F,ae)=>{const O=F.y===l.getFullYear()&&F.m===l.getMonth();C+=`<div class="kb2-mo${O?" cur":""}" style="width:${Lr}px">${ko[F.m]}${F.m===0?" "+String(F.y).slice(2):""}</div>`});const M=F=>{const ae=(n||[]).filter($=>$.flaecheTyp===F.typ&&String($.flaecheId)===String(F.id)),O=(r||[]).filter($=>$.flaecheTyp===F.typ&&String($.flaecheId)===String(F.id));let E="";return ae.forEach(($,Y)=>{const re=je(g,$.pflanzDatum);let de=je(g,$.ernteBis||$.ernteDatum||$.pflanzDatum);if(re==null)return;(de==null||de<=re)&&(de=Math.min(1,re+.5/h));const xe=ka($,Y),De=$.status==="geplant";E+=`<div class="kb2-bar${De?" planned":""}" title="${v($.kultur||"Kultur")}" style="left:${m(re)};width:${((de-re)*100).toFixed(2)}%;--cc:${v(xe)}"><span>${v($.kultur||"")}</span></div>`;const Je=je(g,$.ernteVon),Te=je(g,$.ernteBis);Je!=null&&Te!=null&&Te>Je&&(E+=`<div class="kb2-harvest" title="Ernte" style="left:${m(Je)};width:${((Te-Je)*100).toFixed(2)}%;--cc:${v(xe)}"></div>`)}),O.forEach($=>{const Y=$.status==="erledigt"?$.erledigtDatum||$.planDatum:$.planDatum||$.erledigtDatum,re=je(g,Y);if(re==null)return;const de=vo($.art),xe=$.status==="erledigt";E+=`<span class="kb2-mk${xe?" done":""}" title="${v(de.label+($.notes?": "+$.notes:""))}" style="left:${m(re)};--mc:${de.color}"></span>`}),y!=null&&(E+=`<div class="kb2-today" style="left:${m(y)}"></div>`),E},H=F=>{const ae=F.typ+":"+F.id,O=(n||[]).filter(Y=>Y.flaecheTyp===F.typ&&String(Y.flaecheId)===String(F.id)),E=O.find(Y=>Y.status==="aktiv")||O.find(Y=>Y.status!=="abgeschlossen"),$=E?v(E.kultur||""):"frei";return`<div class="kb2-row" data-ukey="${ae}">
      <div class="kb2-label" title="${v(F.name)}"><b>${v(F.name)}</b><small>${$}</small></div>
      <div class="kb2-track" style="width:${k}px">${M(F)}</div>
    ...
    <div class="kb2-legend">
    ...
    </div>`,e.querySelectorAll(".kb2-row").forEach(F=>{const ae=F.dataset.ukey;F.querySelector(".kb2-label")?.addEventListener("click",()=>s&&s(ae)),F.addEventListener("contextmenu",O=>{O.preventDefault(),o&&o(ae,O.clientX,O.clientY)})})}const $u=[{art:"bewaesserung",label:"Gießen",icon:"bi-droplet"},{art:"mechanisch",label:"Hacken",icon:"bi-tools"},{art:"duengung",label:"Düngen",icon:"bi-flower1"},{art:"nuetzlinge",label:"Nützlinge",icon:"bi-bug"},{art:"chemisch_psm",label:"Pflanzenschutz",icon:"bi-droplet-half"},{art:"monitoring",label:"Kontrolle",icon:"bi-eye"},{art:"sonstiges",label:"Sonstiges",icon:"bi-three-dots"}],zu=["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."];function Au(e,t){if(!(e instanceof HTMLElement))return;e.innerHTML=Pu();let a=[],n=[],r=[],s=[],o=[],l=null,c="plan",p=!1,u=!1;const g={};let h=null;const k=x=>e.querySelector(x),m=()=>k('[data-role="list"]'),y=()=>k('[data-role="detail"]'),w=()=>k('[data-role="kpis"]'),D=()=>k('[data-role="board-view"]'),C=()=>k('[data-role="flaechen-view"]'),M=()=>ce()==="sqlite",H=()=>{M()&&it().catch(()=>{})},Z=(x,L)=>x.filter(W=>W.flaecheTyp===L.typ&&String(W.flaecheId)===String(L.id)),F=x=>a.find(L=>Ra(L)===x)||null,ae=(x,L=0)=>yo(x.color)||Yt[L%Yt.length];async function O(){if(a=await Ss(t),M()){try{n=(await $r())?.rows||[]}catch{n=[]}try{r=(await Pn())?.rows||[]}catch{r=[]}try{s=(await Jr())?.rows||[]}catch{s=[]}try{o=(await vl())?.rows||[]}catch{o=[]}if(!u){u=!0;try{const x=await Pi();x?.imported&&(r=(await Pn())?.rows||[],N.info(`${x.imported} Pflanzenschutz-Eintrag(e) übernommen.`),H())}catch{}}}!l&&a.length&&(l=Ra(a[0])),Y(),$()}async function E(){if(M()){try{n=(await $r())?.rows||[]}catch{}try{r=(await Pn())?.rows||[]}catch{}}}async function $(){const x=l?F(l):null;if(!x||x.lat==null||x.lon==null)return;const L=Ra(x);if(!g[L]){g[L]={loading:!0,weeks:[]};try{g[L]=await Lu(x.lat,x.lon)}catch{g[L]={weeks:[]}}l===L&&Te()}}function Y(){de(),c==="plan"?(C().style.display="none",D().style.display="block",Du(D(),{units:a,anbau:n,mass:r,onSelect:x=>{l=x,re("flaechen"),$()},onContext:(x,L,W)=>za(x,L,W)})):(D().style.display="none",C().style.display="grid",De(),Te()),e.querySelectorAll(".km-modebtn").forEach(x=>x.classList.toggle("active",x.dataset.mode===c))}function re(x){c=x,Y()}function de(){const x=w();if(!x)return;a.filter(A=>A.typ==="haus").length,a.filter(A=>A.typ==="acker").length;let L=0,W=null;a.forEach(A=>{const{current:B,next:T}=ma(Z(n,A));B&&L++,T?.pflanzDatum&&(!W||Ee(T.pflanzDatum)<Ee(W.pflanzDatum))&&(W=T)});const R=r.filter(A=>A.status==="geplant").length;x.innerHTML=`
      ${xe(String(a.length),"Flächen")}
      ${xe(String(L),"Kulturen aktiv")}
      ${xe(String(R),"Aufgaben offen")}
      ${xe(W?Ia(Wt(W.pflanzDatum)):"–","Nächste Pflanzung")}
      <button class="km-psm" data-role="psm-import" title="Bestehende Pflanzenschutz-Einträge übernehmen"><i class="bi bi-arrow-down-circle"></i><span>PSM übernehmen</span></button>`,x.querySelector('[data-role="psm-import"]')?.addEventListener("click",ot)}const xe=(x,L)=>`<div class="km-kpi"><div class="km-kpi-v">${x}</div><div class="km-kpi-l">${v(L)}</div></div>`;function De(){const x=m();if(!x)return;if(!a.length){x.innerHTML='<div class="km-empty"><i class="bi bi-geo-alt"></i><p>Noch keine Flächen.<br>Gewächshäuser unter Einstellungen, Freiland im Reiter „Karte".</p></div>';return}const L=a.filter(A=>A.typ==="haus"),W=a.filter(A=>A.typ==="acker"),R=(A,B)=>B.length?`<div class="km-grp">${v(A)}</div>`+B.map(Je).join(""):"";x.innerHTML=R("Gewächshäuser",L)+R("Freiland",W),x.querySelectorAll("[data-ukey]").forEach(A=>{A.addEventListener("click",()=>{l=A.dataset.ukey,De(),Te(),$()}),A.addEventListener("contextmenu",B=>{B.preventDefault(),za(A.dataset.ukey,B.clientX,B.clientY)})})}function Je(x,L){const W=Ra(x),{current:R}=ma(Z(n,x));return`<div class="km-row${W===l?" sel":""}" data-ukey="${W}">
      <span class="km-dot" style="background:${v(R?ka(R):ae(x,L))}"></span>
      <div class="km-row-main"><div class="km-row-name">${v(x.name)}</div>
      <div class="km-row-sub">${R?`<span class="crop">${v(R.kultur||"Kultur")}</span>`:'<span class="free">frei</span>'}</div></div>
    </div>`}function Te(){const x=y();if(!x)return;const L=l?F(l):null;if(!L){x.innerHTML='<div class="km-empty"><i class="bi bi-hand-index"></i><p>Fläche links wählen.</p></div>';return}const W=Z(n,L),R=Z(r,L),{current:A,next:B}=ma(W),T=g[Ra(L)],ue=L.typ==="haus"?"Gewächshaus":"Freiland",be=L.areaQm?`${Math.round(L.areaQm).toLocaleString("de-DE")} m²`:"";let pe;if(A){const Q=A.pflanzDatum?`seit ${ra(A.pflanzDatum)} · ${Ia(Wt(A.pflanzDatum))}`:"",te=or(A);pe=`<div class="km-hero active" style="--cc:${v(ka(A))}">
        <div class="km-hero-ic"><i class="bi bi-flower2"></i></div>
        <div class="km-hero-body"><div class="km-hero-crop">${v(A.kultur||"Kultur")}</div><div class="km-hero-sub">${v(Q+te+dn(A))}</div></div>
      ...
      </div>`;const X=B?`<div class="km-next"><i class="bi bi-arrow-right-short"></i>Danach geplant: <b>${v(B.kultur||"Kultur")}</b> · ab ${Ia(Wt(B.pflanzDatum))} <button class="km-next-edit" data-edit-crop="next" title="Bearbeiten"><i class="bi bi-pencil"></i></button></div>`:A?'<button class="km-next-add" data-edit-crop="next"><i class="bi bi-plus"></i> Nächste Kultur planen</button>':"";x.innerHTML=`
      ...
      <div class="km-attr">${v(hu)}${T?.stale?" · offline":""}</div>`,x.querySelector('[data-act="map"]')?.addEventListener("click",()=>Da()),x.querySelector('[data-act="plan"]')?.addEventListener("click",()=>re("plan")),x.querySelector('[data-act="add-massnahme"]')?.addEventListener("click",()=>la(L,null,A)),x.querySelectorAll("[data-edit-crop]").forEach(Q=>Q.addEventListener("click",()=>{const te=Q.dataset.editCrop;oa(L,te==="current"?A:B,te,W.length)})),x.querySelectorAll("[data-m-done]").forEach(Q=>Q.addEventListener("click",te=>{te.stopPropagation(),lr(Q.dataset.mDone)})),x.querySelectorAll("[data-m-del]").forEach(Q=>Q.addEventListener("click",te=>{te.stopPropagation(),Ie(Q.dataset.mDel)})),x.querySelectorAll("[data-m-edit]").forEach(Q=>Q.addEventListener("click",()=>{const te=r.find(he=>he.id===Q.dataset.mEdit);la(L,te,A)}))}function gt(x){const L=x.filter(T=>T.status==="geplant").sort((T,ue)=>(Ee(T.planDatum)||9e15)-(Ee(ue.planDatum)||9e15)),W=x.filter(T=>T.status==="erledigt").sort((T,ue)=>(Ee(ue.erledigtDatum)||0)-(Ee(T.erledigtDatum)||0)).slice(0,6),R=Number(dt().replace(/-/g,"")),A=(T,ue)=>{const be=vo(T.art),pe=ue?T.erledigtDatum:T.planDatum,X=!ue&&pe&&Ee(pe)<R,Q=ue?ra(pe):Kt(pe,X),te=T.notes||be.label,he=T.historyId?'<span class="km-pill">PSM</span>':"",Se=[];T.notes&&Se.push(v(be.label)),T.mittel&&Se.push(v(T.mittel)),T.menge!=null&&Se.push(`${T.menge}${T.einheit?" "+v(T.einheit):""}`);const Ke=Se.join(" · ");return`<div class="km-task${ue?" done":""}" data-m-edit="${T.id}">
        ...
        <span class="km-task-when${X?" overdue":""}">${Q}</span>
      ...
      </div>`};let B="";return L.length?B+=L.map(T=>A(T,!1)).join(""):B+='<div class="km-tasks-none"><i class="bi bi-check2-circle"></i> Nichts offen</div>',W.length&&(B+='<div class="km-done-h">Erledigt</div>'+W.map(T=>A(T,!0)).join("")),`<div class="km-tasks">${B}</div>`}function Wt(x){const L=new Date(String(x).slice(0,10)+"T00:00:00");return isNaN(L.getTime())?0:Wn(L).week}function ra(x){const L=new Date(String(x).slice(0,10)+"T00:00:00");return isNaN(L.getTime())?"":`${L.getDate()}. ${zu[L.getMonth()]}`}function Kt(x,L){if(!x)return"offen";const W=new Date(String(x).slice(0,10)+"T00:00:00");if(isNaN(W.getTime()))return"offen";const R=new Date;R.setHours(0,0,0,0);const A=Math.round((W.getTime()-R.getTime())/864e5);return A===0?"heute":A===1?"morgen":L?"überfällig":ra(x)}function La(x){if(!x||!x.weeks?.length)return x?.loading?"Wetter lädt…":"";const{year:L,week:W}=Wn(new Date),R=x.weeks.find(T=>T.year===L&&T.week===W)||x.weeks.find(T=>!T.isForecast);if(!R)return"";const A=R.tMaxAvg!=null?Math.round(R.tMaxAvg)+"°":"–",B=R.precipSum!=null?Math.round(R.precipSum)+" mm":"–";return`<i class="bi bi-cloud-sun"></i> Diese Woche: ${A} · ${B} Regen`}function or(x){const L=x.ernteVon?Ia(Wt(x.ernteVon)):null,W=x.ernteBis||x.ernteDatum,R=W?Ia(Wt(W)):null;return L&&R?` · Ernte ${L}–${R}`:R?` · Ernte ~${R}`:L?` · Ernte ab ${L}`:""}function dn(x){return!x||x.menge==null||x.menge===""?"":` · ${x.menge} ${x.einheit||"Pflanzen"}`}function ia(x,L){if(!x.length&&!L.length)return"";const W=new Date;let R=new Date(W.getFullYear(),W.getMonth()-1,1),A=new Date(W.getFullYear(),W.getMonth()+4,1);const B=q=>{if(!q)return;const me=new Date(String(q).slice(0,10)+"T00:00:00");isNaN(me.getTime())||(me<R&&(R=new Date(me.getFullYear(),me.getMonth(),1)),me>A&&(A=new Date(me.getFullYear(),me.getMonth(),1)))};x.forEach(q=>{B(q.pflanzDatum),B(q.ernteBis||q.ernteDatum),B(q.ernteVon)}),L.forEach(q=>B(q.planDatum||q.erledigtDatum));const T=wo(R,A),ue=T.length,be=`background-size:${(100/ue).toFixed(4)}% 100%`,pe=q=>q==null?null:(q*100).toFixed(2)+"%",X=je(T,W.toISOString()),Q=X!=null?`<div class="ks-today" style="left:${pe(X)}"></div>`:"",te=T.map(q=>`<div class="ks-mo${q.y===W.getFullYear()&&q.m===W.getMonth()?" cur":""}">${ko[q.m]}</div>`).join("");let he="";x.forEach((q,me)=>{const ze=je(T,q.pflanzDatum);let ke=je(T,q.ernteBis||q.ernteDatum||q.pflanzDatum);if(ze==null)return;(ke==null||ke<=ze)&&(ke=Math.min(1,ze+.5/ue));const Pt=ka(q,me);he+=`<div class="ks-bar${q.status==="geplant"?" planned":""}" style="left:${pe(ze)};width:${((ke-ze)*100).toFixed(2)}%;--cc:${v(Pt)}"><span>${v(q.kultur||"")}</span></div>`;const j=je(T,q.ernteVon),se=je(T,q.ernteBis);j!=null&&se!=null&&se>j&&(he+=`<div class="ks-harvest" style="left:${pe(j)};width:${((se-j)*100).toFixed(2)}%"></div>`)});const Se={};L.forEach(q=>{(Se[q.art]=Se[q.art]||[]).push(q)});const Ke=Ud.filter(q=>Se[q]).map(q=>{const me=Yn[q],ze=Se[q].map(ke=>{const Pt=ke.status==="erledigt"?ke.erledigtDatum||ke.planDatum:ke.planDatum||ke.erledigtDatum,j=je(T,Pt);return j==null?"":`<span class="ks-mk${ke.status==="erledigt"?" done":""}" title="${v(me.label+(ke.notes?": "+ke.notes:""))}" style="left:${pe(j)};--mc:${me.color}"></span>`}).join("");return`<div class="ks-row"><div class="ks-rl">${v(me.label)}</div><div class="ks-track" style="${be}">${ze}${Q}</div></div>`}).join("");return`<div class="ks-wrap">
    ...
    </div>`}function Da(x){Qe("app",L=>({...L,activeSection:"acker"})),N.info("Karte geöffnet.")}async function ot(){if(!M()){N.warning("Keine Datenbank aktiv.");return}try{const x=await Pi();await E(),Y(),x?.imported?(N.success(`${x.imported} übernommen.`),H()):N.info(`Nichts Neues${x?.skipped?` (${x.skipped} nicht zuordenbar)`:""}.`)}catch{N.error("Übernahme fehlgeschlagen.")}}async function lr(x){const L=r.find(W=>W.id===x);if(L)try{await Ci({...L,status:"erledigt",erledigtDatum:L.erledigtDatum||dt()}),await E(),Y(),H()}catch{N.error("Speichern fehlgeschlagen.")}}async function Ie(x){try{await Mi({id:x}),await E(),Y(),H()}catch{N.error("Löschen fehlgeschlagen.")}}let ye=null;const jt=()=>{ye&&(ye.remove(),ye=null,document.removeEventListener("pointerdown",$a,!0))},$a=x=>{ye&&!ye.contains(x.target)&&jt()};function cr(x,L,W,R){if(jt(),ye=document.createElement("div"),ye.className="km-ctx",R){const B=document.createElement("div");B.className="km-ctx-t",B.textContent=R,ye.appendChild(B)}W.forEach(B=>{if(B.sep){const ue=document.createElement("div");ue.className="km-ctx-sep",ye.appendChild(ue);return}const T=document.createElement("button");T.className="km-ctx-i",T.innerHTML=`<i class="bi ${B.icon}"></i><span>${v(B.label)}</span>`,T.addEventListener("click",()=>{jt(),B.action?.()}),ye.appendChild(T)}),document.body.appendChild(ye);const A=ye.getBoundingClientRect();ye.style.left=Math.max(8,Math.min(x,window.innerWidth-A.width-8))+"px",ye.style.top=Math.max(8,Math.min(L,window.innerHeight-A.height-8))+"px",setTimeout(()=>document.addEventListener("pointerdown",$a,!0),0)}function za(x,L,W){const R=F(x);if(!R)return;const A=Z(n,R),{current:B}=ma(A);cr(L,W,[{icon:"bi-flower2",label:B?"Kultur bearbeiten":"Kultur setzen",action:()=>oa(R,B,"current",A.length)},{icon:"bi-plus-lg",label:"Nächste Kultur planen",action:()=>oa(R,null,"next",A.length)},{icon:"bi-list-check",label:"Aufgabe planen",action:()=>la(R,null,B)},{sep:!0},{icon:"bi-arrow-right-circle",label:"Fläche öffnen",action:()=>{l=x,re("flaechen"),$()}},{icon:"bi-map",label:"Auf Karte",action:()=>Da()}],R.name)}function We(){h&&(h.remove(),h=null)}function sa(x,L,W,R){We();const A=document.createElement("div");return A.className="kmodal-ov",A.innerHTML=`<div class="kmodal" role="dialog" aria-modal="true">
      ...
      <div class="kmodal-f"><button class="btn-cancel" data-k="cancel">Abbrechen</button><button class="btn-save" data-k="save">${v(W)}</button></div></div>`,e.appendChild(A),h=A,A.querySelector(".kmodal-x").addEventListener("click",We),A.querySelector('[data-k="cancel"]').addEventListener("click",We),A.addEventListener("mousedown",B=>{B.target===A&&We()}),A.querySelector('[data-k="save"]').addEventListener("click",()=>{R(A)!==!1&&We()}),A.querySelectorAll("[data-more]").forEach(B=>B.addEventListener("click",()=>{const T=A.querySelector("[data-more-box]");T&&(T.hidden=!1,B.style.display="none")})),setTimeout(()=>A.querySelector("input,select,textarea,.km-tile")?.focus?.(),30),A}function Aa(){const x=new Set,L=[],W=A=>{const B=String(A||"").trim().toLowerCase();A&&!x.has(B)&&(x.add(B),L.push(A))};return o.forEach(A=>W(A.name)),s.forEach(A=>W(A.kultur)),`<datalist id="km-kultur-dl">${L.map(A=>`<option value="${v(A)}"></option>`).join("")}</datalist>`}function oa(x,L,W,R){const A=W==="next"&&!L,B=L||{},T=(B.kulturStammId?o.find(j=>j.id===B.kulturStammId):null)||Ln(o,B.kultur),ue=B.pflanzDatum?.slice(0,10)||(A?"":dt()),be=Yt.map(j=>`<button type="button" class="km-sw${(B.color||"")===j?" on":""}" data-col="${j}" style="background:${j}"></button>`).join(""),pe=Jd.map(j=>`<option value="${v(j)}"${(B.einheit||"Pflanzen")===j?" selected":""}>${v(j)}</option>`).join(""),X=`
      ...
      <div class="km-frow2">
        ...
        <label class="km-fld">${A?"Geplante Pflanzung":"Pflanzung"}<input type="date" data-f="pflanz" value="${ue}" /></label>
      </div>
      <div class="km-frow2">
      ...
      <div class="km-more-box" data-more-box hidden>
        <label class="km-fld">Status<select data-f="status">${["aktiv","geplant","abgeschlossen"].map(j=>`<option value="${j}"${(B.status||(A?"geplant":"aktiv"))===j?" selected":""}>${Vd[j].label}</option>`).join("")}</select></label>
      ...
      ${L?'<button type="button" class="km-dangerlink" data-f="del"><i class="bi bi-trash"></i> Satz löschen</button>':""}`,Q=sa(L?"Satz bearbeiten":A?"Nächsten Satz planen":"Satz eintragen",X,"Speichern",j=>{const se=Ct=>j.querySelector(`[data-f="${Ct}"]`)?.value?.trim()||"",Ae=se("kultur");if(!Ae)return N.warning("Bitte eine Kultur angeben."),!1;const Gt=Ln(o,Ae),Ye=se("aussaat")||null,lt=se("pflanz")||null,Pa=se("ernteVon")||null,Be=se("ernteBis")||null,un=se("menge"),dr=un?Number(un):null,pn=j.querySelector('[data-f="einheit"]')?.value||null,Ma=!j.querySelector("[data-more-box]").hidden;let Mt=Ma?se("status"):"";Mt||(Mt=A||lt&&Ee(lt)>Number(dt().replace(/-/g,""))?"geplant":"aktiv");const fe=j.querySelector(".km-sw.on")?.dataset.col||B.color||Gt?.color||Yt[R%Yt.length],Xe=s.find(Ct=>Ct.kultur===Ae)?.eppoCode||Gt?.eppoCode||null,bt=Ma?se("notes")||null:B.notes||null,Ca={flaecheTyp:x.typ,flaecheId:x.id,kultur:Ae,eppoCode:Xe,color:fe,menge:dr,einheit:pn,kulturStammId:Gt?.id||B.kulturStammId||null,notes:bt},mn=!L&&j.querySelector('[data-f="succOn"]')?.checked,_e=Math.max(2,Math.min(20,Number(j.querySelector('[data-f="succN"]')?.value)||2)),fn=Math.max(1,Number(j.querySelector('[data-f="succGap"]')?.value)||14),gn=Number(dt().replace(/-/g,""));(async()=>{try{if(mn){const Ct="sg-"+Date.now().toString(36)+Math.random().toString(36).slice(2,6),ur={aussaatDatum:Ye,pflanzDatum:lt,ernteVon:Pa,ernteBis:Be};for(let ht=0;ht<_e;ht++){const Vt=Xd(ur,ht*fn),pr=Vt.pflanzDatum&&Ee(Vt.pflanzDatum)>gn?"geplant":Mt;await Ii({...Ca,...Vt,ernteDatum:null,status:pr,satzGruppe:Ct})}N.success(`${_e} Sätze angelegt.`)}else await Ii({id:L?.id,...Ca,aussaatDatum:Ye,pflanzDatum:lt,ernteVon:Pa,ernteBis:Be,ernteDatum:null,status:Mt,satzGruppe:B.satzGruppe||null});await E(),Y(),H()}catch{N.error("Speichern fehlgeschlagen.")}})()});let te="pflanz";const he=j=>Q.querySelector(`[data-f="${j}"]`),Se=Q.querySelector("[data-anchor-row]"),Ke=Q.querySelector("[data-stammhint]");let q=T;const me=()=>{if(!q){Ke.hidden=!0,Se.style.opacity="0.45";return}Se.style.opacity="1";const se=[Qd[q.anbauMethode==="anzucht"?"anzucht":"direkt"].short];q.kulturTage&&se.push(`${q.kulturTage} T. Kultur`),q.anbauMethode==="anzucht"&&q.anzuchtTage&&se.push(`${q.anzuchtTage} T. Anzucht`),q.familie&&se.push(q.familie),Ke.innerHTML=`<i class="bi bi-stars"></i> <b>Bibliothek:</b> ${v(se.join(" · "))}`,Ke.hidden=!1},ze=()=>{if(!q)return;const se=he(te==="ernte"?"ernteVon":te).value||dt(),Ae=Yd(q,te,se);Ae.aussaatDatum!=null&&(he("aussaat").value=Ae.aussaatDatum||""),Ae.pflanzDatum!=null&&(he("pflanz").value=Ae.pflanzDatum||""),Ae.ernteVon!=null&&(he("ernteVon").value=Ae.ernteVon||""),Ae.ernteBis!=null&&(he("ernteBis").value=Ae.ernteBis||"")},ke=he("kultur");ke.addEventListener("input",()=>{q=Ln(o,ke.value),me()}),ke.addEventListener("change",()=>{q=Ln(o,ke.value),me(),q&&(he("pflanz").value||(he("pflanz").value=dt()),ze())}),Q.querySelectorAll("[data-anchor]").forEach(j=>j.addEventListener("click",()=>{Q.querySelectorAll("[data-anchorseg] .km-segb").forEach(se=>se.classList.remove("on")),j.classList.add("on"),te=j.dataset.anchor,ze()})),["aussaat","pflanz","ernteVon"].forEach(j=>he(j)?.addEventListener("change",()=>{j===(te==="ernte"?"ernteVon":te)&&ze()})),me();const Pt=Q.querySelector('[data-f="succOn"]');Pt?.addEventListener("change",()=>{Q.querySelector("[data-succ-box]").hidden=!Pt.checked}),Q.querySelectorAll(".km-sw").forEach(j=>j.addEventListener("click",()=>{Q.querySelectorAll(".km-sw").forEach(se=>se.classList.remove("on")),j.classList.add("on")})),Q.querySelector('[data-f="del"]')?.addEventListener("click",async()=>{if(L?.id)try{await yl({id:L.id}),await E(),Y(),H(),We()}catch{N.error("Löschen fehlgeschlagen.")}})}function la(x,L,W){const R=L||{art:"bewaesserung",status:"geplant"},A=$u.map(X=>`<button type="button" class="km-tile${(R.art||"bewaesserung")===X.art?" on":""}" data-art="${X.art}" style="--ac:${Yn[X.art].color}"><i class="bi ${X.icon}"></i><span>${v(X.label)}</span></button>`).join(""),B=(R.status||"geplant")==="erledigt",T=(B?R.erledigtDatum:R.planDatum)||dt(),ue=`
      <div class="km-tasktiles">${A}</div>
      ...
      <div class="km-more-box" data-more-box hidden>
        <label class="km-fld">Bezeichnung<input data-f="notes" value="${v(R.notes||"")}" placeholder="z. B. Kompostgabe" /></label>
        <div class="km-frow2">
          <label class="km-fld">Menge<input type="number" step="0.1" data-f="menge" value="${R.menge!=null?R.menge:""}" placeholder="optional" /></label>
          <label class="km-fld">Einheit<input data-f="einheit" value="${v(R.einheit||"")}" placeholder="kg/ha, l" /></label>
        </div>
        <label class="km-fld">Mittel<input data-f="mittel" value="${v(R.mittel||"")}" placeholder="optional" /></label>
      </div>
      ${L?'<button type="button" class="km-dangerlink" data-f="del"><i class="bi bi-trash"></i> Aufgabe löschen</button>':""}`,be=sa(L?"Aufgabe bearbeiten":"Aufgabe hinzufügen",ue,"Speichern",X=>{const Q=X.querySelector(".km-tile.on")?.dataset.art||"bewaesserung",te=X.querySelector(".km-segb.on")?.dataset.status||"geplant",he=X.querySelector('[data-f="datum"]').value||dt(),Se=!X.querySelector("[data-more-box]").hidden,Ke=me=>{const ze=X.querySelector(`[data-f="${me}"]`)?.value;return ze?Number(ze):null},q=me=>X.querySelector(`[data-f="${me}"]`)?.value.trim()||null;(async()=>{try{await Ci({id:L?.id,flaecheTyp:x.typ,flaecheId:x.id,anbauId:L?.anbauId||W?.id||null,art:Q,status:te,planDatum:te==="geplant"?he:L?.planDatum||null,erledigtDatum:te==="erledigt"?he:null,menge:Se?Ke("menge"):L?.menge??null,einheit:Se?q("einheit"):L?.einheit||null,mittel:Se?q("mittel"):L?.mittel||null,historyId:L?.historyId||null,notes:Se?q("notes"):L?.notes||null}),await E(),Y(),H()}catch{N.error("Speichern fehlgeschlagen.")}})()});be.querySelectorAll(".km-tile").forEach(X=>X.addEventListener("click",()=>{be.querySelectorAll(".km-tile").forEach(Q=>Q.classList.remove("on")),X.classList.add("on")})),be.querySelectorAll(".km-segb").forEach(X=>X.addEventListener("click",()=>{be.querySelectorAll(".km-segb").forEach(Q=>Q.classList.remove("on")),X.classList.add("on")}));const pe=be.querySelector('[data-f="datum"]');be.querySelectorAll("[data-day]").forEach(X=>X.addEventListener("click",()=>{const Q=X.dataset.day;if(Q==="x"){pe.style.display="inline-block",pe.showPicker?.();return}const te=new Date;te.setDate(te.getDate()+Number(Q)),pe.value=te.toISOString().slice(0,10),pe.style.display="none"})),be.querySelector('[data-f="del"]')?.addEventListener("click",async()=>{if(L?.id)try{await Mi({id:L.id}),await E(),Y(),H(),We()}catch{N.error("Löschen fehlgeschlagen.")}})}e.querySelectorAll(".km-modebtn").forEach(x=>x.addEventListener("click",()=>re(x.dataset.mode))),document.addEventListener("keydown",x=>{x.key==="Escape"&&(h&&We(),jt())}),window.addEventListener("psm:openKultur",x=>{const L=x?.detail;!L?.typ||!L?.id||(l=L.typ+":"+L.id,re("flaechen"),p&&(De(),Te(),$()))}),t.state.subscribe(x=>{x?.app?.activeSection==="kultur"&&(p?(async()=>(a=await Ss(t),Y(),$()))():(p=!0,O()))}),de()}function Pu(){return`
  <style>
  ...
  `,e}function Bu(e){if(!e)return"-";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function Fu(e,t){const a=e.querySelector('[data-role="import-log-list"]');if(a){if(!t.length){a.innerHTML='<tr><td colspan="5" class="text-muted small">Noch keine Importe protokolliert.</td></tr>';return}a.innerHTML=t.map(n=>{const r=n.rangeStart||n.rangeEnd?`${Ja(n.rangeStart)||n.rangeStart||"?"} – ${Ja(n.rangeEnd)||n.rangeEnd||"?"}`:"-",s=[n.source,n.device].filter(Boolean),o=s.length?v(s.join(" · ")):"-";return`
        ...
        </tr>`}).join("")}}async function Hn(e){if(ce()==="sqlite")try{const t=await kl(50);Fu(e,t.items||[])}catch(t){console.warn("Import-Historie konnte nicht geladen werden",t)}}function At(e,t,a="info"){const n=e.querySelector('[data-role="import-hint"]');if(n){if(!t){n.classList.add("d-none"),n.textContent="";return}n.className=`alert alert-${a} small mt-3`,n.textContent=t}}function Xt(e,t){const a=e.querySelector('[data-role="import-feedback"]');a&&(a.textContent=t)}function Rt(e){const t=e.querySelector('[data-action="clear-import"]'),a=e.querySelector('[data-action="focus-import"]'),n=e.querySelector('[data-action="run-import"]'),r=!!K;if(t&&(t.disabled=!r||zt),a&&(a.disabled=!r||zt),n){const s=!!(K?.importableEntries?.length&&K.stats||K?.fotos?.length);n.disabled=!r||!s||zt}}function Nu(e){K=null,ju(e);const t=e.querySelector('[data-role="import-summary-card"]'),a=e.querySelector('[data-role="import-file"]');t&&t.classList.add("d-none"),a&&(a.value=""),Xt(e,""),At(e,"Bereit für eine neue Importdatei."),Rt(e),fa()}function $o(e){if(e.dateIso)return e.dateIso;if(e.datum){const t=new Date(e.datum);if(!Number.isNaN(t.getTime()))return t.toISOString()}if(e.date){const t=new Date(e.date);if(!Number.isNaN(t.getTime()))return t.toISOString()}if(e.savedAt){const t=new Date(e.savedAt);if(!Number.isNaN(t.getTime()))return t.toISOString()}return null}function Xn(e){return e?Ja(e)||e.slice(0,10):"-"}function zo(e){return e.savedAt||(e.savedAt=e.createdAt||e.dateIso||new Date().toISOString()),e}function Ds(e,t){if(!e)return;const a=new Date(e);if(!Number.isNaN(a.getTime()))return t==="start"?a.setHours(0,0,0,0):a.setHours(23,59,59,999),a.toISOString()}function Tu(e){if(!e||typeof e!="object")return null;const t={...e};if(!Array.isArray(t.items)){const a=e.items;t.items=Array.isArray(a)?[...a]:[]}return zo(t),t}function Ao(e,t){const a=e.map(n=>$o(n)).filter(n=>!!n).sort();return{startIso:a[0]||t?.filters?.startDate||null,endIso:a[a.length-1]||t?.filters?.endDate||null}}function qu(e){if(!e)return;const t=Ds(e.startIso,"start"),a=Ds(e.endIso,"end");if(!t&&!a)return;const n={};return t&&(n.startDate=t),a&&(n.endDate=a),n}async function Po(e,t){if(ce()!=="sqlite"){const l=Ue(e.history);return new Set(l.map(c=>er(c)).filter(c=>!!c))}const n=qu(t);if(!n)return new Set;const r=new Set;let s=1;const o=500;try{for(;;){const l=await _s({page:s,pageSize:o,filters:n,sortDirection:"asc"});if(l.items.forEach(c=>{const p=er(c);p&&r.add(p)}),s*o>=l.totalCount)break;s+=1}}catch(l){return console.warn("Konnte vorhandene Einträge für Duplikatprüfung nicht laden",l),new Set}return r}function er(e){const t=typeof e.clientUuid=="string"&&e.clientUuid?e.clientUuid:"";if(t)return`uuid:${t}`;const a=e.savedAt||e.dateIso||e.createdAt||e.datum||"",n=e.ersteller||"",r=e.kultur||"",s=e.invekos||e.standort||"";return[a,n,r,s].join("|")}function Hu(e,t,a,n){const r=n||Ao(e,a),s=r.startIso,o=r.endIso,l=new Set,c=new Set;return t.forEach(p=>{p.ersteller&&l.add(p.ersteller),p.kultur&&c.add(p.kultur)}),{startDateLabel:Xn(s),endDateLabel:Xn(o),startDateRaw:s,endDateRaw:o,entryCount:e.length,importableCount:t.length,duplicateCount:e.length-t.length,creators:Array.from(l).slice(0,5),crops:Array.from(c).slice(0,5)}}function Ru(e,t){const a=e.querySelector('[data-role="import-stats"]');if(!a)return;if(!t){a.innerHTML="";return}const n=t.stats,r=t.metadata?.filters;a.innerHTML=`
  ...
  `}function Ou(e,t){const a=e.querySelector('[data-role="import-warnings"]');if(!a)return;if(!t||!t.warnings.length){a.innerHTML="";return}const n=t.warnings.map(r=>`<li>${v(r)}</li>`).join("");a.innerHTML=`
    <div class="alert alert-warning">
      <strong>Hinweise:</strong>
      <ul class="mb-0">${n}</ul>
    </div>
  `}function Mo(e){const t=e.entries.length;if(!t)return Le=0,{start:0,end:0,total:0};const a=Math.max(Math.ceil(t/aa),1);Le>=a&&(Le=a-1),Le<0&&(Le=0);const n=Le*aa,r=Math.min(n+aa,t);return{start:n,end:r,total:t}}function _u(e){const t=e.querySelector('[data-role="import-pager"]');return t?((!An||Ls!==t)&&(An?.destroy(),An=on(t,{onPrev:()=>Wu(e),onNext:()=>Ku(e),labels:{prev:"Zurück",next:"Weiter",loading:"Vorschau wird geladen...",empty:"Keine Einträge verfügbar"}}),Ls=t),An):null}function Qa(e,t){const a=_u(e);if(!a)return;if(!t){Le=0,a.update({status:"hidden"});return}const n=t.entries.length;if(!n){Le=0,a.update({status:"disabled",info:"Keine Einträge vorhanden."});return}const{start:r,end:s}=Mo(t),o=`Einträge ${Dr.format(r+1)}–${Dr.format(s)} von ${Dr.format(n)}`;a.update({status:"ready",info:o,canPrev:Le>0,canNext:s<n})}function Wu(e){!K||Le===0||(Le=Math.max(Le-1,0),bi(e,K))}function Ku(e){if(!K)return;const t=K.entries.length;if(!t)return;const a=Math.max(Math.ceil(t/aa)-1,0);Le>=a||(Le=Math.min(Le+1,a),bi(e,K))}function ju(e){Le=0,e&&Qa(e,K)}function bi(e,t){const a=e.querySelector('[data-role="import-preview-table"]');if(!a){fa();return}if(!t){a.innerHTML="",Qa(e,null),fa();return}if(!t.entries.length){a.innerHTML='<tr><td colspan="5" class="text-center text-muted">Keine Einträge</td></tr>',Qa(e,t),fa();return}const{start:r,end:s}=Mo(t),l=t.entries.slice(r,s).map(c=>{const p=Xn($o(c));return`
        <tr>
          <td>${v(p)}</td>
          <td>${v(c.kultur||"-")}</td>
          <td>${v(c.ersteller||"-")}</td>
          <td>${v(c.standort||c.invekos||"-")}</td>
          <td>${v(c.savedAt?Xn(c.savedAt):"-")}</td>
        </tr>
      `}).join("");a.innerHTML=l,Qa(e,t),fa()}async function Gu(e){const t=Sl(e),a=Object.keys(t),n=a.find(p=>Mu.some(u=>p.toLowerCase().endsWith(u)));if(!n)throw new Error("ZIP enthält keine 'pflanzenschutz.json'.");const r=JSON.parse(zr(t[n])),s=a.find(p=>p.toLowerCase().endsWith("metadata.json")),o=s?JSON.parse(zr(t[s])):null,l=Array.isArray(r)?r:Array.isArray(r.entries)?r.entries:Array.isArray(r.history)?r.history:[],c=Array.isArray(r?.fotos)?r.fotos:[];for(const p of c){if(p?.data)continue;const u=p?.file?String(p.file):null,g=u?a.find(h=>h===u||h.toLowerCase().endsWith(u.toLowerCase())):null;g&&t[g]&&(p.data=Uu(t[g]),p.mime||(p.mime="image/jpeg"))}return{entries:l,metadata:o,fotos:c}}function Uu(e){let t="";for(let n=0;n<e.length;n+=32768)t+=String.fromCharCode(...e.subarray(n,n+32768));return btoa(t)}async function Vu(e){const t=zr(e),a=JSON.parse(t);if(Array.isArray(a))return{entries:a,metadata:null,fotos:[]};const n=Array.isArray(a.fotos)?a.fotos:[];if(Array.isArray(a.entries))return{entries:a.entries,metadata:a.metadata||null,fotos:n};if(Array.isArray(a.history))return{entries:a.history,metadata:a.metadata||null,fotos:n};if(n.length)return{entries:[],metadata:a.metadata||null,fotos:n};throw new Error("JSON enthält keine Eintragsliste.")}async function Zu(e,t){const a=new Uint8Array(await e.arrayBuffer()),n=/\.zip$/i.test(e.name)||e.type==="application/zip",{entries:r,metadata:s,fotos:o}=n?await Gu(a):await Vu(a),l=Array.isArray(o)?o:[],c=(Array.isArray(r)?r:[]).map(w=>Tu(w)).filter(w=>!!w);if(!c.length&&!l.length)throw new Error("Die Datei enthielt keine verwertbaren Einträge.");const p=Ao(c,s),u=await Po(t,p),g=new Set,h=[];let k=0;c.forEach(w=>{const D=er(w);if(!D){h.push(w);return}if(u.has(D)||g.has(D)){k+=1;return}g.add(D),h.push(w)});const m=Hu(c,h,s,p),y=[];return k&&y.push(`${k} Datensätze wurden wegen gleicher Kennung übersprungen.`),(!m.startDateRaw||!m.endDateRaw)&&y.push("Zeitraum konnte nicht eindeutig ermittelt werden."),{filename:e.name,entries:c,importableEntries:h,metadata:s,stats:m,warnings:y,lastImportRefs:[],fotos:l}}function $s(){if(!K)return"Keine Datei";const e=[];return zt&&e.push("Verarbeitung"),K.warnings.length&&e.push("Warnungen"),K.stats.importableCount<K.stats.entryCount&&e.push("Duplikate entfernt"),e.length?e.join(" · "):void 0}function Qu(){const e=!!K,t=e?Math.max(Math.ceil((K?.entries.length||0)/aa),1):null,a=e?{items:K?.entries.length??0,totalCount:K?.stats.entryCount??null,cursor:K&&(K.entries.length||0)>aa?`Seite ${Le+1}${t?` / ${t}`:""}`:null,payloadKb:to(K?.entries.slice(0,aa)),lastUpdated:Zr,note:$s()}:{items:0,totalCount:0,cursor:null,payloadKb:0,lastUpdated:Zr,note:$s()};eo(Cu,a)}function fa(){Zr=new Date().toISOString(),Qu()}function Qr(e){const t=e.querySelector('[data-role="import-summary-card"]');if(!t)return;if(!K){t.classList.add("d-none"),Qa(e,null),Rt(e),fa();return}t.classList.remove("d-none"),Le=0;const a=t.querySelector('[data-role="import-file-name"]'),n=t.querySelector('[data-role="import-summary-subline"]');a&&(a.textContent=K.filename),n&&(n.textContent=`${K.stats.importableCount} von ${K.stats.entryCount} Einträgen importierbar`),Ru(e,K),Ou(e,K),bi(e,K),Rt(e)}async function Ju(){const e=ce();if(!e||e==="memory"||e==="sqlite")return;const t=at();await nt(t)}function zs(e,t){if(!t.length)return[];const a=typeof e.state.updateSlice=="function"?e.state.updateSlice:Qe,n=[];return a("history",r=>{const s=rn(r),o=s.items.slice(),l=o.length;return t.forEach((c,p)=>{n.push(l+p),o.push(c)}),{...s,items:o,totalCount:o.length,lastUpdatedAt:new Date().toISOString()}}),n}async function Yu(e,t){if(!K){window.alert("Bitte zuerst eine Importdatei laden.");return}const a=K.fotos||[];if(!K.importableEntries.length&&!a.length){window.alert("Alle Einträge wurden bereits importiert oder als Duplikat erkannt.");return}zt=!0,Rt(e),Xt(e,"Import läuft ...");const n=t.state.getState(),r={startIso:K.stats.startDateRaw,endIso:K.stats.endDateRaw};let s=new Set;try{s=await Po(n,r)}catch(y){console.warn("Duplikatprüfung vor Import fehlgeschlagen",y)}const o=new Set(s),l=[];let c=0;if(K.importableEntries.forEach(y=>{const w=er(y);if(w&&o.has(w)){c+=1;return}w&&o.add(w),l.push(y)}),!l.length&&!a.length){Xt(e,"Keine neuen Einträge gefunden."),At(e,"Alle Datensätze sind bereits importiert worden.","warning"),zt=!1,Rt(e);return}const p=ce(),u=[],g=[];let h=0,k=0;const m=l.map(y=>zo({...y}));try{if(p==="sqlite"){const C=[];for(const M of m)try{const H=await Ms(M);if(H?.duplicate){c+=1;continue}H?.id!=null&&(u.push({source:"sqlite",ref:H.id}),C.push(M))}catch(H){console.error("appendHistoryEntry failed",H),g.push(M.savedAt||"Unbekannter Eintrag")}zs(t,C);for(const M of a)try{(await wl(M))?.duplicate?k+=1:h+=1}catch(H){console.error("appendFoto failed",H)}h&&window.dispatchEvent(new CustomEvent("fotos:changed"));try{await it()}catch(M){console.warn("SQLite-Datei konnte nach dem Import nicht gespeichert werden",M)}}else zs(t,m).forEach(M=>{u.push({source:"state",ref:M})}),await Ju();const y=u.length;if(y||h){p==="sqlite"&&y&&t.events?.emit?.("history:data-changed",{type:"created-bulk",count:y});const C=[];y&&C.push(`${y} Einträge`),h&&C.push(`${h} Foto(s)`),Xt(e,`${C.join(" und ")} importiert.${g.length?` ${g.length} Einträge konnten nicht übernommen werden.`:""}`.trim()),K.lastImportRefs=u,K.importableEntries=[],K.stats={...K.stats,importableCount:0},Qr(e)}else Xt(e,"Keine neuen Daten importiert.");const w=[];let D="success";if(g.length&&(w.push(`${g.length} Einträge konnten nicht gespeichert werden. Details siehe Konsole.`),D="warning"),c&&(w.push(`${c} Einträge wurden während des Imports als Duplikat übersprungen.`),D="warning"),k&&w.push(`${k} Foto(s) waren bereits vorhanden (übersprungen).`),w.length||w.push("Import abgeschlossen."),At(e,w.join(" "),D),p==="sqlite"&&(y||c||h||k))try{const C=[];g.length&&C.push(`${g.length} fehlgeschlagen`),h&&C.push(`${h} Fotos`),k&&C.push(`${k} Fotos doppelt`),await xl({source:K.filename||null,device:K.metadata?.device||K.metadata?.label||null,added:y,skipped:c,rangeStart:K.stats.startDateRaw,rangeEnd:K.stats.endDateRaw,note:C.length?C.join(", "):null}),await it().catch(()=>{}),await Hn(e)}catch(C){console.warn("Import-Historie konnte nicht geschrieben werden",C)}}catch(y){console.error("Import fehlgeschlagen",y),Xt(e,"Import fehlgeschlagen. Siehe Konsole für Details."),At(e,"Import fehlgeschlagen. Bitte erneut versuchen.","danger")}finally{zt=!1,Rt(e)}}function Xu(e,t,a){if(!e.events?.emit)return;const n=t.metadata?.label||t.metadata?.filters?.label||`Import ${t.filename}`;e.events.emit("documentation:focus-range",{startDate:t.stats.startDateRaw||void 0,endDate:t.stats.endDateRaw||void 0,label:n,reason:"import",entryIds:a,autoSelectFirst:!!a.length})}function ep(e,t){if(!K){window.alert("Bitte zuerst eine Importdatei laden.");return}if(!K.stats.startDateRaw||!K.stats.endDateRaw){window.alert("Zeitraum konnte nicht bestimmt werden.");return}Xu(t,K,K.lastImportRefs),At(e,"Dokumentation wurde auf den Importzeitraum fokussiert.")}function tp(e,t){const a=e.querySelector('[data-role="import-file"]');a&&a.addEventListener("change",()=>{const n=a.files?.[0];n&&(zt=!0,At(e,"Datei wird analysiert ..."),Rt(e),Xt(e,""),Zu(n,t.state.getState()).then(r=>{K=r,Qr(e),At(e,`${r.importableEntries.length} Einträge bereit zum Import.`)}).catch(r=>{console.error("Importdatei konnte nicht gelesen werden",r),At(e,r?.message||"Importdatei konnte nicht gelesen werden.","danger"),K=null,Qr(e)}).finally(()=>{zt=!1,Rt(e)}))}),e.addEventListener("click",n=>{const r=n.target?.closest("[data-action]");if(!r)return;const s=r.dataset.action;if(s){if(s==="clear-import"){Nu(e);return}if(s==="focus-import"){ep(e,t);return}s==="run-import"&&Yu(e,t)}})}function ap(e,t){if(!e||Es)return;const a=e;a.innerHTML="";const n=Iu();a.appendChild(n),tp(n,t),At(n,"Wähle eine Datei aus, um den Import zu starten."),Hn(n),mt("database:connected",()=>void Hn(n)),mt("app:sectionChanged",r=>{(r==="daten"||r==="documentation"||r==="import")&&Hn(n)}),Es=!0}const Jt=(e,t=0)=>Number.isFinite(e)?e.toLocaleString("de-DE",{minimumFractionDigits:t,maximumFractionDigits:t}):"–";function np(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString("de-DE")}function da(e,t,a,n){return`
  ...
  </section>`}function ip(e,t){if(!(e instanceof HTMLElement))return;e.innerHTML=rp();const a=e.querySelector('[data-role="dash-cards"]'),n=e.querySelector('[data-role="dash-warn"]'),r=e.querySelector('[data-role="dash-recent"]');e.addEventListener("click",o=>{const l=o.target?.closest("[data-goto]");if(!l)return;const c=l.getAttribute("data-goto");c&&t.state.updateSlice("app",p=>({...p,activeSection:c}))});const s=async()=>{if(ce()!=="sqlite"){a&&(a.innerHTML='<div class="dash-empty">Bitte zuerst eine Datenbank öffnen.</div>');return}const o=t.state.getState(),l=(Ue(o.gps?.points)||[]).length;let c=0,p=0,u=0,g=0,h=[],k=[],m=0;try{c=(await Jr())?.rows?.length||0}catch{}try{p=(await Os())?.rows?.length||0}catch{}try{const y=(await Yr())?.rows||[];u=y.length,g=y.reduce((w,D)=>w+(D.plants||0),0)}catch{}try{h=(await Rs())?.rows||[]}catch{}try{const y=await _s({}),w=y?.entries||y?.rows||[];m=y?.totalCount??w.length,k=w.slice(0,6)}catch{}if(a&&(a.innerHTML=[da("bi-geo-alt","Standorte",Jt(l)),da("bi-flower1","Kulturen",Jt(c)),da("bi-droplet","Mittel im Sortiment",Jt(p),"lager"),da("bi-journal-check","Anwendungen",Jt(m),"documentation"),da("bi-map","Acker-Flächen",Jt(u),"acker"),da("bi-flower3","Pflanzen (Acker)",Jt(g),"acker")].join("")),n){const y=[];h.forEach(D=>{D.bestand<=0&&(D.verbraucht>0||D.zugang>0)&&y.push(`<div class="dash-row"><span><i class="bi bi-box-seam me-1" style="color:#ef4444"></i>${v(D.name)}</span><span style="color:#ef4444">Bestand ${Jt(D.bestand)} ${v(D.einheit||"")}</span></div>`)}),h.forEach(D=>{if(!D.zulEnde)return;const C=Math.round((new Date(D.zulEnde).getTime()-Date.now())/864e5);C<0?y.push(`<div class="dash-row"><span><i class="bi bi-calendar-x me-1" style="color:#ef4444"></i>${v(D.name)}</span><span style="color:#ef4444">Zulassung abgelaufen</span></div>`):C<180&&y.push(`<div class="dash-row"><span><i class="bi bi-calendar-event me-1" style="color:#f59e0b"></i>${v(D.name)}</span><span style="color:#f59e0b">Zulassung endet in ${C} T</span></div>`)});const w=y.length>6?`<div class="dash-row" style="color:var(--color-text-muted)"><span>+ ${y.length-6} weitere</span></div>`:"";n.innerHTML=y.length?y.slice(0,6).join("")+w:'<div class="dash-empty">Alles im grünen Bereich. ✓</div>'}r&&(r.innerHTML=k.length?k.map(y=>{const w=np(y.datum||y.dateIso||y.created_at||y.createdAt||null),D=y.kultur||"",C=y.standort||"";return`<div class="dash-row"><span>${v(C)}${D?" · "+v(D):""}</span><span class="dash-empty" style="padding:0">${v(w)}</span></div>`}).join(""):'<div class="dash-empty">Noch keine Anwendungen erfasst.</div>')};t.state.subscribe(o=>{o?.app?.activeSection==="dashboard"&&s()}),s()}function As(e){document.querySelectorAll(".content-section").forEach(a=>{a.style.display="none"});const t=document.getElementById(`section-${e}`);t instanceof HTMLElement&&(t.style.display="block")}function Ps(){El(),Is();const e={state:{getState:U,updateSlice:Qe,subscribe:On},events:{emit:(w,D)=>{Dt(async()=>{const{emit:C}=await import("./index.D1c2XijN.js").then(M=>M.aS);return{emit:C}},[]).then(({emit:C})=>{C(w,D)})},subscribe:mt}},t=document.querySelector('[data-region="startup"]'),a=document.querySelector('[data-region="shell"]'),n=document.querySelector('[data-region="main"]'),r=document.querySelector('[data-region="footer"]');tc(t,e);const s=document.querySelector('[data-feature="calculation"]');Ll(s,e);const o=document.querySelector('[data-feature="documentation"]');Jc(o,e);const l=document.querySelector('[data-feature="settings"]');Wd(l,e);const c=document.querySelector('[data-feature="lager"]');Gd(c,e);const p=document.querySelector('[data-feature="acker"]');fu(p,e);const u=document.querySelector('[data-feature="kultur"]');Au(u,e);const g=document.querySelector('[data-feature="fotos"]');Dl(g,e,{archiveMode:!0});const h=document.querySelector('[data-feature="import-page"]');ap(h,{state:{getState:U,updateSlice:Qe},events:e.events});const k=document.querySelector('[data-feature="dashboard"]');ip(k,e);const m=w=>{const D=document.body;D&&(D.classList.toggle("bg-app",w),D.classList.toggle("bg-startup",!w))},y=w=>{const D=!!w.app?.hasDatabase;if(m(D),t instanceof HTMLElement&&t.classList.toggle("d-none",D),a instanceof HTMLElement&&a.classList.toggle("d-none",!D),n instanceof HTMLElement&&n.classList.toggle("d-none",!D),r instanceof HTMLElement&&r.classList.toggle("d-none",!D),D){const C=w.app?.activeSection??"dashboard";As(C)}};y(e.state.getState()),On((w,D)=>{w.app?.hasDatabase!==D.app?.hasDatabase&&y(w),w.app?.activeSection!==D.app?.activeSection&&w.app?.hasDatabase&&As(w.app.activeSection)}),mt("app:sectionChanged",()=>{})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ps,{once:!0}):Ps();
