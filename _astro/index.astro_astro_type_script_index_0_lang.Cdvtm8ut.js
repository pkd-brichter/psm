...
import{M as de,N as Ds,J as tt,O as Eo,P as Lo,Q as $s,h as At,l as Do,a as zs,s as ct,n as $o,q as As,p as wi,e as j,r as Tn,C as qn,u as Ve,_ as It,R as zo,S as Ao,w as g,t as B,m as Si,T as Po,j as bn,k as Ei,U as Mo,V as Co,W as je,X as Io,Y as Ps,Z as Ms,H as Cs,G as Hn,$ as Bo,a0 as No,a1 as Fo,a2 as To,a3 as qo,a4 as tn,z as Va,a5 as Ho,x as Oo,a6 as Ye,a7 as Xe,a8 as _o,a9 as an,aa as Ro,ab as Ko,D as Wo,ac as Is,ad as Bs,ae as Za,af as jo,ag as Go,ah as Uo,ai as Li,aj as fr,ak as gr,al as Vo,am as Zo,an as Qo,ao as Jo,ap as Yo,aq as Xo,ar as el,as as Ns,at as tl,au as Fs,av as al,aw as Qr,ax as $r,ay as $n,az as Jr,aA as nl,aB as rl,aC as On,aD as Di,aE as il,aF as $i,aG as Pa,aH as zi,aI as sl,aJ as Ai,aK as Pi,aL as ol,aM as ll,aN as cl,aO as dl,aP as zr,v as Ts,i as ul,b as pl,c as ml}from"./index.CA5PA6Pp.js";const Ar="__psl_history_seeded",Pr=200,Mi=["Salat","Apfel","Wein","Tomate","Kartoffel","Hopfen","Raps","Birne"],Ci=["Spritzung","Düngung","Pflege","Behandlung"],Ii=["LACES","MALDO","VITVI","SOLTU","PRNUS","CUPAR","CYNCR","ALLCE"],Bi=["BBCH 10","BBCH 31","BBCH 41","BBCH 55","BBCH 65","BBCH 71","BBCH 81"],fl=[{mediumId:"seed-water",name:"Wasser",unit:"L",methodId:"perKiste",methodLabel:"pro Kiste",value:.02,zulassungsnummer:"N/A"},{mediumId:"seed-tonikum",name:"Tonikum X",unit:"ml",methodId:"perKiste",methodLabel:"pro Kiste",value:.85,zulassungsnummer:"Z-123456"},{mediumId:"seed-oel",name:"Pflegeöl Y",unit:"ml",methodId:"percentWater",methodLabel:"% vom Wasser",value:.12,zulassungsnummer:"Z-654321"}];function gl(e){if(typeof window>"u")return;const a=new URLSearchParams(window.location.search).has("seedHistory");if(!a)return;const n=window;n.__PSL||(n.__PSL={});const r=n.__PSL;r.seedHistoryEntries=(l=Pr)=>Ni(e,{count:l}),r.resetHistorySeedFlag=()=>localStorage.removeItem(Ar),!a&&!localStorage.getItem(Ar)&&de()==="sqlite"&&Ni(e,{count:Pr,setFlag:!0}).catch(l=>{console.error("History seeding failed",l)})}async function bl(e){if(!e.state.getState().app?.hasDatabase){if(typeof e.state.subscribe!="function")throw new Error("SQLite-Datenbank ist noch nicht initialisiert.");await new Promise((t,a)=>{const n=window.setTimeout(()=>{s(),a(new Error("SQLite-Datenbank wurde nicht rechtzeitig initialisiert."))},1e4),r=e.state.subscribe?.(l=>{l.app?.hasDatabase&&(s(),t())}),s=()=>{window.clearTimeout(n),typeof r=="function"&&r()}})}}async function Ni(e,t={}){const a=t.count??Pr;if(de()!=="sqlite")throw new Error("SQLite-Treiber muss aktiv sein, bevor Daten befüllt werden können.");await bl(e);const n=performance.now();let r=0;for(let s=0;s<a;s+=1){const l=hl(s);await Ds(l),r+=1}try{await tt()}catch(s){console.warn("Seed-Daten konnten nicht persistent gespeichert werden",s)}return e.events.emit("history:data-changed",{source:"dev-history-seed"}),t.setFlag&&localStorage.setItem(Ar,"1"),{inserted:r,durationMs:performance.now()-n}}function hl(e){const t=new Date;t.setDate(t.getDate()-e);const a=t.toLocaleDateString("de-DE"),n=t.toISOString(),r=20+e%30,s=Number((r*.5).toFixed(2));return{datum:a,dateIso:n,ersteller:`Seeder ${1+e%5}`,standort:`Test-Ort ${String.fromCharCode(65+e%6)}`,kultur:Mi[e%Mi.length],usageType:Ci[e%Ci.length],kisten:r,eppoCode:Ii[e%Ii.length],bbch:Bi[e%Bi.length],gps:`GPS-Notiz ${e}`,gpsCoordinates:{latitude:48+e%10*.01,longitude:11+e%10*.01},gpsPointId:`seed-gps-${e}`,invekos:`INV-${String(1e3+e).padStart(4,"0")}`,uhrzeit:`${String(6+e%12).padStart(2,"0")}:${String(e*7%60).padStart(2,"0")}`,savedAt:n,items:vl(e,r,s)}}function vl(e,t,a){return fl.map((n,r)=>{const s=1+(e+r)%4*.05,l=Number((n.value*s).toFixed(4)),o=Number((l*t).toFixed(2));return{id:`seed-item-${e}-${r}`,name:n.name,unit:n.unit,methodLabel:n.methodLabel,methodId:n.methodId,value:l,total:o,inputs:{kisten:t,waterVolume:a},zulassungsnummer:n.zulassungsnummer,mediumId:n.mediumId}})}let Vt=null,Ma=null,Fi=!1,Ti=!1;async function yl(){if(!("serviceWorker"in navigator))return console.warn("[PWA] Service Workers nicht unterstützt"),null;try{return Ma=await navigator.serviceWorker.register("/psm/sw.js",{scope:"/psm/",updateViaCache:"none"}),console.log("[PWA] Service Worker registriert:",Ma.scope),Ma.addEventListener("updatefound",()=>{const e=Ma?.installing;e&&e.addEventListener("statechange",()=>{e.state==="installed"&&navigator.serviceWorker.controller&&(console.log("[PWA] Neues Update verfügbar"),ba("pwa:update-available"))})}),navigator.serviceWorker.addEventListener("message",xl),Fi||(Fi=!0,navigator.serviceWorker.addEventListener("controllerchange",()=>{Ti||(Ti=!0,window.location.reload())})),Ma}catch(e){return console.error("[PWA] Service Worker Registrierung fehlgeschlagen:",e),null}}function xl(e){const{type:t,payload:a}=e.data||{};switch(t){case"DB_STATE":ba("pwa:db-state",a);break;case"CACHES_CLEARED":ba("pwa:caches-cleared");break}}async function Yn(e){if(!navigator.serviceWorker.controller){localStorage.setItem("psm-db-state",JSON.stringify({...e,updatedAt:new Date().toISOString()}));return}navigator.serviceWorker.controller.postMessage({type:"SET_DB_STATE",payload:e})}async function qs(){const e=localStorage.getItem("psm-db-state");if(e)try{return JSON.parse(e)}catch{}return navigator.serviceWorker?.controller?new Promise(t=>{const a=n=>{n.data?.type==="DB_STATE"&&(navigator.serviceWorker.removeEventListener("message",a),t(n.data.payload))};navigator.serviceWorker.addEventListener("message",a),navigator.serviceWorker.controller.postMessage({type:"GET_DB_STATE"}),setTimeout(()=>{navigator.serviceWorker.removeEventListener("message",a),t(null)},1e3)}):null}async function kl(){const e=await qs();return!!(e?.hasDatabase&&e?.autoStartEnabled)}function wl(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),Vt=e,console.log("[PWA] Install Prompt verfügbar"),localStorage.getItem("psm-app-installed")==="true"&&(console.log("[PWA] Widerspruch erkannt: Flag sagt installiert, aber Prompt verfügbar"),localStorage.removeItem("psm-app-installed"),console.log("[PWA] Veraltetes Installations-Flag entfernt")),ba("pwa:install-available")}),window.addEventListener("appinstalled",()=>{Vt=null,er(),console.log("[PWA] App installiert - Flag gesetzt"),ba("pwa:installed")})}function Xn(){return Vt!==null}function Jt(){return window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Yr(){const e=navigator.userAgent.toLowerCase();return e.includes("edg/")?"edge":e.includes("chrome")&&!e.includes("edg")?"chrome":e.includes("firefox")?"firefox":e.includes("safari")&&!e.includes("chrome")?"safari":"other"}function Xr(){return!!(Jt()||localStorage.getItem("psm-app-installed")==="true"||window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia("(display-mode: minimal-ui)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches)}async function Hs(){if(Xr())return!0;try{if("getInstalledRelatedApps"in navigator){const e=await navigator.getInstalledRelatedApps();if(console.log("[PWA] getInstalledRelatedApps result:",e),e&&e.length>0)return er(),!0}}catch(e){console.warn("[PWA] getInstalledRelatedApps API Fehler:",e)}return!1}function er(){localStorage.setItem("psm-app-installed","true"),console.log("[PWA] App als installiert markiert")}function Sl(){localStorage.removeItem("psm-app-installed"),console.log("[PWA] Installations-Flag entfernt")}function Os(){const e=Yr(),t=Jt(),a=Xr();return{canInstall:Xn(),isInstalled:a&&!t,isStandalone:t,browser:e,showBanner:!t}}async function _s(){const e=Yr(),t=Jt(),a=await Hs();return{canInstall:Xn(),isInstalled:a&&!t,isStandalone:t,browser:e,showBanner:!t}}async function El(){if(!Vt)return console.warn("[PWA] Kein Install Prompt verfügbar"),!1;try{await Vt.prompt();const{outcome:e}=await Vt.userChoice;return console.log("[PWA] Install Prompt Ergebnis:",e),e==="accepted"&&er(),Vt=null,e==="accepted"}catch(e){return console.error("[PWA] Install Prompt fehlgeschlagen:",e),!1}}function Ll(e){if(!("launchQueue"in window)){console.log("[PWA] Launch Queue API nicht verfügbar");return}window.launchQueue?.setConsumer(async t=>{if(!t.files?.length){console.log("[PWA] Launch ohne Dateien");return}console.log("[PWA] Datei via Launch Queue empfangen:",t.files.length);for(const a of t.files)try{await e(a),await Yn({hasDatabase:!0,fileHandleName:a.name,lastAccess:new Date().toISOString(),autoStartEnabled:!0});break}catch(n){console.error("[PWA] Fehler beim Öffnen der Datei:",n)}}),console.log("[PWA] File Handling initialisiert")}const Tt="psm-file-handles",ei="last-database";async function Mr(e){try{const t=await ti(),n=t.transaction(Tt,"readwrite").objectStore(Tt);await new Promise((r,s)=>{const l=n.put({key:ei,handle:e,savedAt:new Date().toISOString()});l.onsuccess=()=>r(),l.onerror=()=>s(l.error)}),t.close(),console.log("[PWA] FileHandle gespeichert"),await Yn({hasDatabase:!0,fileHandleName:e.name,lastAccess:new Date().toISOString(),autoStartEnabled:!0})}catch(t){console.error("[PWA] FileHandle speichern fehlgeschlagen:",t)}}async function Cr(){try{const e=await ti(),a=e.transaction(Tt,"readonly").objectStore(Tt),n=await new Promise((s,l)=>{const o=a.get(ei);o.onsuccess=()=>s(o.result),o.onerror=()=>l(o.error)});if(e.close(),!n?.handle)return null;const r=n.handle;return typeof r.queryPermission=="function"&&await r.queryPermission({mode:"readwrite"})==="granted"?(console.log("[PWA] FileHandle mit Berechtigung geladen"),n.handle):(console.log("[PWA] FileHandle gefunden, aber Berechtigung erforderlich"),n.handle)}catch(e){return console.error("[PWA] FileHandle laden fehlgeschlagen:",e),null}}async function Dl(e){try{const t=e;return typeof t.requestPermission!="function"?(await e.getFile(),!0):await t.requestPermission({mode:"readwrite"})==="granted"}catch{return!1}}async function $l(){try{const e=await ti(),a=e.transaction(Tt,"readwrite").objectStore(Tt);await new Promise((n,r)=>{const s=a.delete(ei);s.onsuccess=()=>n(),s.onerror=()=>r(s.error)}),e.close(),await Yn({hasDatabase:!1,autoStartEnabled:!1}),console.log("[PWA] FileHandle gelöscht")}catch(e){console.error("[PWA] FileHandle löschen fehlgeschlagen:",e)}}async function ti(){return new Promise((e,t)=>{const a=indexedDB.open("psm-file-handles",1);a.onerror=()=>t(a.error),a.onsuccess=()=>e(a.result),a.onupgradeneeded=n=>{const r=n.target.result;r.objectStoreNames.contains(Tt)||r.createObjectStore(Tt,{keyPath:"key"})}})}function ba(e,t){window.dispatchEvent(new CustomEvent(e,{detail:t}))}function Rs(){return{serviceWorker:"serviceWorker"in navigator,fileSystemAccess:typeof window.showOpenFilePicker=="function",launchQueue:"launchQueue"in window,indexedDB:"indexedDB"in window,standalone:Jt(),installAvailable:Xn()}}async function zl(e){if(console.log("[PWA] Initialisierung..."),await yl(),wl(),e?.onFileOpened&&Ll(e.onFileOpened),e?.onAutoStart&&await kl()){const t=await Cr();if(t){const a=t;let n=!1;if(typeof a.queryPermission=="function"&&(n=await a.queryPermission({mode:"readwrite"})==="granted"),n){console.log("[PWA] Auto-Start mit gespeicherter Datei"),e.onFileOpened&&await e.onFileOpened(t);return}console.log("[PWA] Auto-Start: Berechtigung für Datei erforderlich"),ba("pwa:permission-required",{handle:t})}}console.log("[PWA] Capabilities:",Rs())}async function Al(){if(console.group("🔧 PWA Debug Status"),console.log("📱 Standalone Mode:",Jt()),console.log("💾 localStorage Flag:",localStorage.getItem("psm-app-installed")),console.log("🔔 Install Prompt verfügbar:",Xn()),console.log("🌐 Browser:",Yr()),console.group("📺 Display Mode Checks"),console.log("standalone:",window.matchMedia("(display-mode: standalone)").matches),console.log("fullscreen:",window.matchMedia("(display-mode: fullscreen)").matches),console.log("minimal-ui:",window.matchMedia("(display-mode: minimal-ui)").matches),console.log("window-controls-overlay:",window.matchMedia("(display-mode: window-controls-overlay)").matches),console.log("browser:",window.matchMedia("(display-mode: browser)").matches),console.groupEnd(),console.group("🔍 getInstalledRelatedApps API"),"getInstalledRelatedApps"in navigator)try{const e=await navigator.getInstalledRelatedApps();console.log("Installierte Apps:",e)}catch(e){console.log("API Fehler:",e)}else console.log("API nicht verfügbar");console.groupEnd(),console.group("📊 Status Vergleich"),console.log("Sync (isProbablyInstalled):",Xr()),console.log("Async (checkIfInstalled):",await Hs()),console.log("getInstallStatus():",Os()),console.log("getInstallStatusAsync():",await _s()),console.groupEnd(),console.log("💡 Tipp: clearInstalledFlag() zum Zurücksetzen des Flags"),console.groupEnd()}typeof window<"u"&&(window.pwaDebug=Al,window.pwaClearFlag=Sl);let hn=!1;function Pl(e){const t=r=>{if(hn){hn=!1;return}return r.preventDefault(),r.returnValue="",""};let a=!1;const n=r=>{const s=!!r.app?.hasDatabase;s&&!a?(window.addEventListener("beforeunload",t),a=!0):!s&&a&&(window.removeEventListener("beforeunload",t),a=!1)};n(e.getState()),e.subscribe(n),document.addEventListener("click",r=>{const s=r.target.closest("a");s&&s.target==="_blank"&&(hn=!0,setTimeout(()=>{hn=!1},100))})}function Ml(){const e=document.getElementById("app-root");if(!e)throw new Error("app-root Container fehlt");return{startup:e.querySelector('[data-region="startup"]'),shell:e.querySelector('[data-region="shell"]'),main:e.querySelector('[data-region="main"]'),footer:e.querySelector('[data-region="footer"]')}}async function Cl(){if(Eo()){window.location.replace("/psm/m/");return}Ml(),Lo();const e=$s();e!=="memory"&&At(e),await Do();const t={state:{getState:j,patchState:wi,updateSlice:Ve,subscribe:qn},events:{emit:Tn,subscribe:ct}};gl(t),zs(),Pl(t.state),zl({onFileOpened:async a=>{const n=await It(()=>import("./index.CA5PA6Pp.js").then(s=>s.aR),[]),r=await It(()=>import("./index.CA5PA6Pp.js").then(s=>s.aQ),[]);if(r.isSupported()){n.setActiveDriver("sqlite");const s=await a.getFile(),l=await s.arrayBuffer(),o=await r.importFromArrayBuffer(l,s.name);await Mr(a);const{applyDatabase:d}=await It(async()=>{const{applyDatabase:m}=await import("./index.CA5PA6Pp.js").then(u=>u.aT);return{applyDatabase:m}},[]);d(o.data),Tn("database:connected",{driver:"sqlite",autoStarted:!0})}}}),ct("database:connected",async a=>{await Yn({hasDatabase:!0,lastAccess:new Date().toISOString(),autoStartEnabled:!0})}),ct("database:connected",async a=>{if(de()==="sqlite")try{await $o(),await As()}catch(n){console.warn("GPS-Punkte konnten beim Start nicht geladen werden",n)}}),wi({app:{...j().app,ready:!0}})}const qi="__pflanzenschutz_bootstrapped__",Hi=window;function Oi(){Cl().catch(e=>{console.error("bootstrap failed",e)})}Hi[qi]||(Hi[qi]=!0,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Oi,{once:!0}):Oi());const Ks=[{id:"start",label:"Start",icon:"bi-grid-1x2",sections:[{section:"dashboard",label:"Übersicht",icon:"bi-grid-1x2"}]},{id:"psm",label:"PSM",icon:"bi-flower1",sections:[{section:"calc",label:"Neu erfassen",icon:"bi-pencil-square"},{section:"documentation",label:"Übersicht",icon:"bi-list-ul"},{section:"lager",label:"Lager",icon:"bi-box-seam"},{section:"settings",label:"Einstellungen",icon:"bi-gear"}]},{id:"acker",label:"Acker-Planer",icon:"bi-map",sections:[{section:"acker",label:"Karte",icon:"bi-map"},{section:"kultur",label:"Kulturführung",icon:"bi-clipboard2-pulse"}]},{id:"fotos",label:"Fotos",icon:"bi-camera",sections:[{section:"fotos",label:"Fotos",icon:"bi-camera"}]},{id:"daten",label:"Daten",icon:"bi-database",sections:[{section:"daten",label:"Import",icon:"bi-cloud-upload"}]}],Ws={dashboard:"start",calc:"psm",documentation:"psm",lager:"psm",history:"psm",report:"psm",acker:"acker",kultur:"acker",fotos:"fotos",settings:"psm",gps:"psm",lookup:"psm",import:"daten",daten:"daten"};function js(e){return Ks.find(t=>t.id===e)}function Il(e){const t=Ws[e];return t?js(t):void 0}function Bl(){const e=document.getElementById("offline-indicator");if(!e)return;const t=()=>{const a=!navigator.onLine;e.classList.toggle("d-none",!a)};t(),window.addEventListener("online",t),window.addEventListener("offline",t)}function _i(e){j().app.activeSection!==e&&(Ve("app",t=>({...t,activeSection:e})),Tn("app:sectionChanged",e))}function Ri(){Bl();const e=document.querySelectorAll(".nav-btn[data-area]"),t=document.getElementById("brand-link"),a=document.getElementById("topnav-tabs"),n=document.getElementById("topnav-area-icon"),r=document.getElementById("topnav-area-label"),s={};for(const h of Ks)s[h.id]=h.sections[0].section;let l=null;function o(h,S){if(a){if(h.sections.length<=1){a.innerHTML="";return}a.innerHTML=h.sections.map(w=>`
  ...
  `}function qt(e,t){ar();const a=e.querySelector('[data-role="doc-list"]');if(!a)return;const r=e.querySelector("#doc-detail")?.dataset.entryId||null;if(!kt.length)a.innerHTML=We?'<div class="text-center text-muted py-4">Lädt ...</div>':'<div class="text-center text-muted py-4">Noch keine Einträge</div>';else{a.innerHTML="";const s=document.createDocumentFragment();(t||j().fieldLabels).history?.detail?.usageType,kt.forEach(o=>{const d=document.createElement("div"),m=!!Nt?.highlightEntryIds?.has(o.id);d.className=`doc-sidebar-entry list-group-item${m?" doc-sidebar-entry--highlight":""}`,d.dataset.entryId=o.id;const u=eo(o.entry)||"-",f=m?'<span class="badge bg-warning-subtle text-warning-emphasis badge-import">Import</span>':"";d.innerHTML=`
        <div
...
`):""}function pi(e,t){if(!$)return;const a=e.gps,n=oo(e),r=t==="ok";if($.summaryLabel){const s=Ha(a).length;$.summaryLabel.textContent=r?`${s} Punkt${s===1?"":"e"} gespeichert`:"Funktion derzeit nicht verfügbar"}if(!r){$.listBody&&($.listBody.innerHTML=""),$.emptyState&&($.emptyState.textContent=t==="no-db"?"Keine Datenbank verbunden.":"Bitte SQLite als Speicher-Treiber aktivieren.",$.emptyState.classList.remove("d-none")),$.activeInfo&&($.activeInfo.textContent=t==="no-db"?"Wartet auf Datenbank.":"Nur mit SQLite verfügbar."),ps(e,t);return}if($.listBody){const{items:s}=co(Ha(a));$.listBody.innerHTML=Jc(s,a.activePointId)}if($.emptyState){const s=Ha(a).length>0;$.emptyState.classList.toggle("d-none",s),!s&&a.initialized?$.emptyState.innerHTML=`
  ...
  `).join(""):`
    ...
    `}function gt(e){const t=e.querySelector('[data-role="saved-eppo-list"]'),a=Oe.length>0;if(t){const o=t.closest(".border-top");o&&a&&(o.innerHTML=`
      ...
      `)}const n=e.querySelector('[data-role="saved-bbch-list"]'),r=_e.length>0;if(n){const o=n.closest(".border-top");o&&r&&(o.innerHTML=`
        ...
        `)}else if(r){const d=e.querySelectorAll(".codes-card")[1];if(d){const m=d.querySelector(".border-top.pt-3.mb-3");m&&(m.innerHTML=`
          <h6 class="mb-2 text-muted small text-uppercase d-flex align-items-center">
            <i class="bi bi-bookmark-star me-1"></i>
            Meine Stadien
            <span class="badge bg-info ms-2">${_e.length}</span>
        ...
        `)}}const s=e.querySelector(".codes-card:first-child .card-header .badge"),l=e.querySelector(".codes-card:last-child .card-header .badge");s&&(s.textContent=`${Oe.length} gespeichert`),l&&(l.textContent=`${_e.length} gespeichert`)}function fd(e){const t=e.querySelector('[data-input="eppo-search"]'),a=e.querySelector('[data-role="eppo-search-results"]');if(t&&a){const o=Li(async()=>{const d=t.value.trim();if(d.length<2){a.innerHTML="";return}try{const m=await Qo(d,10);if(!m.length){a.innerHTML=`
            <div class="list-group-item text-muted">Keine Ergebnisse für "${g(d)}"</div>
          `;return}a.innerHTML=m.map(u=>`
        ...
        `).join("")}catch(m){console.error("EPPO search failed:",m),a.innerHTML=`
          <div class="list-group-item text-danger">Suche fehlgeschlagen</div>
        `}},300);t.addEventListener("input",o)}const n=e.querySelector('[data-input="bbch-search"]'),r=e.querySelector('[data-role="bbch-search-results"]');if(n&&r){const o=Li(async()=>{const d=n.value.trim();if(d.length<1){r.innerHTML="";return}try{const m=await Jo(d,10);if(!m.length){r.innerHTML=`
            <div class="list-group-item text-muted">Keine Ergebnisse für "${g(d)}"</div>
          `;return}r.innerHTML=m.map(u=>`
        ...
        `).join("")}catch(m){console.error("BBCH search failed:",m),r.innerHTML=`
          <div class="list-group-item text-danger">Suche fehlgeschlagen</div>
        `}},300);n.addEventListener("input",o)}e.dataset.codesClickBound!=="1"&&(e.dataset.codesClickBound="1",e.addEventListener("click",async o=>{const m=o.target.closest("[data-action]");if(!m)return;const u=m.dataset.action;if(u==="select-eppo"){const f=m.dataset.code||"",v=m.dataset.name||"",k=m.dataset.language||"",h=m.dataset.dtcode||"";if(!f||!v){console.warn("EPPO selection missing code or name");return}a&&(a.innerHTML=""),t&&(t.value="");const S=Oe.find(w=>w.code.toUpperCase()===f.toUpperCase());if(S){const w=e.querySelector(`[data-eppo-id="${S.id}"]`);w&&(w.classList.add("flash-highlight"),setTimeout(()=>w.classList.remove("flash-highlight"),800));return}try{await fr({code:f,name:v,language:k||void 0,dtcode:h||void 0,isFavorite:!1});const w=Ye();await Xe(w),await ft(),gt(e)}catch(w){console.error("Failed to save EPPO from search:",w),alert("Speichern fehlgeschlagen")}}if(u==="select-bbch"){const f=m.dataset.code||"",v=m.dataset.label||"",k=m.dataset.principal,h=m.dataset.secondary,S=k?parseInt(k,10):void 0,w=h?parseInt(h,10):void 0;if(!f||!v){console.warn("BBCH selection missing code or label");return}r&&(r.innerHTML=""),n&&(n.value="");const E=_e.find(I=>I.code===f);if(E){const I=e.querySelector(`[data-bbch-id="${E.id}"]`);I&&(I.classList.add("flash-highlight"),setTimeout(()=>I.classList.remove("flash-highlight"),800));return}try{await gr({code:f,label:v,principalStage:Number.isNaN(S)?void 0:S,secondaryStage:Number.isNaN(w)?void 0:w,isFavorite:!1});const I=Ye();await Xe(I),await ft(),gt(e)}catch(I){console.error("Failed to save BBCH from search:",I),alert("Speichern fehlgeschlagen")}}if(u==="toggle-favorite-eppo"){const f=m.dataset.id;if(!f)return;const v=Oe.find(k=>k.id===f);if(!v)return;try{await fr({id:v.id,code:v.code,name:v.name,language:v.language,dtcode:v.dtcode,isFavorite:!v.isFavorite});const k=Ye();await Xe(k),await ft(),gt(e)}catch(k){console.error("Failed to toggle EPPO favorite:",k)}}if(u==="toggle-favorite-bbch"){const f=m.dataset.id;if(!f)return;const v=_e.find(k=>k.id===f);if(!v)return;try{await gr({id:v.id,code:v.code,label:v.label,principalStage:v.principalStage,secondaryStage:v.secondaryStage,isFavorite:!v.isFavorite});const k=Ye();await Xe(k),await ft(),gt(e)}catch(k){console.error("Failed to toggle BBCH favorite:",k)}}if(u==="delete-eppo"){const f=m.dataset.id;if(!f||!confirm("EPPO-Code wirklich löschen?"))return;try{await Vo({id:f});const v=Ye();await Xe(v),await ft(),gt(e)}catch(v){console.error("Failed to delete EPPO:",v)}}if(u==="delete-bbch"){const f=m.dataset.id;if(!f||!confirm("BBCH-Stadium wirklich löschen?"))return;try{await Zo({id:f});const v=Ye();await Xe(v),await ft(),gt(e)}catch(v){console.error("Failed to delete BBCH:",v)}}}));const s=e.querySelector('[data-form="add-eppo"]');s&&s.addEventListener("submit",async o=>{o.preventDefault();const d=e.querySelector('[data-input="eppo-code"]'),m=e.querySelector('[data-input="eppo-name"]'),u=e.querySelector('[data-input="eppo-favorite"]'),f=d?.value.trim(),v=m?.value.trim();if(!f||!v){alert("Bitte Code und Name eingeben");return}try{await fr({code:f,name:v,isFavorite:u?.checked||!1});const k=Ye();await Xe(k),await ft(),gt(e),d&&(d.value=""),m&&(m.value=""),u&&(u.checked=!1)}catch(k){console.error("Failed to save EPPO:",k),alert("Speichern fehlgeschlagen")}});const l=e.querySelector('[data-form="add-bbch"]');l&&l.addEventListener("submit",async o=>{o.preventDefault();const d=e.querySelector('[data-input="bbch-code"]'),m=e.querySelector('[data-input="bbch-label"]'),u=e.querySelector('[data-input="bbch-favorite"]'),f=d?.value.trim(),v=m?.value.trim();if(!f||!v){alert("Bitte Code und Bezeichnung eingeben");return}try{await gr({code:f,label:v,isFavorite:u?.checked||!1});const k=Ye();await Xe(k),await ft(),gt(e),d&&(d.value=""),m&&(m.value=""),u&&(u.checked=!1)}catch(k){console.error("Failed to save BBCH:",k),alert("Speichern fehlgeschlagen")}})}function gd(e,t,a={}){if(!e||Rr)return;Cn=e,Rr=!0,Cn.innerHTML=`
    <div class="section-inner codes-manager">
      <h4 class="mb-3"><i class="bi bi-tags me-2"></i>EPPO & BBCH Codes</h4>
      ${md()}
    </div>`;const n=Cn.querySelector(".codes-manager");if(!n)return;fd(n);const r=async()=>{await ft(),gt(n)};t?.events?.subscribe?.("database:connected",()=>{r()}),t?.state?.getState?.().app?.hasDatabase&&r()}function bd(){Rr=!1,Cn=null}let ms=!1,vt=null,_a=null,In=null,Ra=null,Kt=null,Wn=null,yt=null,en=null,jn=null,xt=null,jr=null,bt=null,Pe=new Set,Mt=null,kr=!1,wr=!1,ma=!1;const at=e=>je(e.mediums),Bn=25,Sr=new Intl.NumberFormat("de-DE");let Fe=0,oa=null,Gr=null,Ur=null,mi=null;function hd(){const e=document.createElement("div");return e.className="section-inner",e.innerHTML=`
    <h2 class="text-center mb-4">
  ...
  `,e}function vd(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`profile-${Date.now()}-${Math.random().toString(16).slice(2,10)}`}function uo(e){if(!Pe.size)return;const t=new Set(at(e).map(n=>n.id));let a=!1;Pe.forEach(n=>{t.has(n)||(Pe.delete(n),a=!0)}),a&&(Pe=new Set(Pe))}function Gn(){vt&&vt.querySelectorAll('[data-role="profile-select"]').forEach(e=>{const t=e.dataset.mediumId;e.checked=!!(t&&Pe.has(t))})}function Ct(e){const t=at(e).length,a=Pe.size;let n="Noch keine Mittel ausgewählt.";t?a===t&&t>0?n=`${a} Mittel ausgewählt (alle).`:a>0&&(n=`${a} Mittel ausgewählt.`):n="Keine Mittel vorhanden.",jr&&(jr.textContent=n),bt&&(bt.disabled=t===0,bt.indeterminate=a>0&&a<t,bt.checked=t>0&&a===t)}function Nn(e){Mt=null,Wn&&Wn.reset(),en&&(en.value=""),yt&&(yt.value=""),xt&&(xt.textContent="Profil speichern"),Pe=new Set,Gn(),Ct(e)}function yd(e,t){Mt=e.id,en&&(en.value=e.id),yt&&(yt.value=e.name,yt.focus()),xt&&(xt.textContent="Profil aktualisieren"),Pe=new Set(e.mediumIds),Gn(),Ct(t)}function fs(e,t){if(xt){if(xt.disabled=e,e){xt.textContent=t||"Speichert...";return}xt.textContent=Mt?"Profil aktualisieren":"Profil speichern"}}function Un(e,t){if(_a){if(_a.disabled=e,e){_a.textContent=t||"Speichert...";return}_a.textContent="Hinzufügen"}}async function xd(e,t,a){if(ma)return;const n=t.state.getState(),s=(at(n)[e]??null)?.id||null;ma=!0,Un(!0);const l=a?.textContent??null;a&&(a.disabled=!0,a.textContent="Lösche...");try{t.state.updateSlice("mediums",d=>{const m=tn(d),u=m.items.slice();return u.splice(e,1),{...m,items:u,totalCount:Math.min(m.totalCount,u.length),lastUpdatedAt:new Date().toISOString()}}),await Vn({silent:!0})&&s&&t.events?.emit?.("mediums:data-changed",{action:"deleted",id:s})}finally{ma=!1,Un(!1),a&&a.isConnected&&(a.disabled=!1,a.textContent=l??"Löschen")}}async function kd(e,t,a){const n=a?.textContent??null;a&&(a.disabled=!0,a.textContent="Lösche...");try{t.state.updateSlice("mediumProfiles",(r=[])=>r.filter(s=>s.id!==e.id)),Mt===e.id&&Nn(t.state.getState()),await Vn({successMessage:"Profil gelöscht."})}finally{a&&(a.disabled=!1,a.textContent=n||"Löschen")}}function wd(e){if(!jn)return;const t=jn,a=e.mediumProfiles||[];if(!a.length){t.innerHTML=`
      <tr>
    ...
    `,t.appendChild(s)})}function Sd(e,t){if(kr||!e.mediumProfiles?.length)return;const a=new Set(at(e).map(s=>s.id));let n=!1;const r=e.mediumProfiles.map(s=>{const l=s.mediumIds.filter(o=>a.has(o));return l.length!==s.mediumIds.length?(n=!0,{...s,mediumIds:l,updatedAt:new Date().toISOString()}):s}).filter(s=>s.mediumIds.length?!0:(n=!0,!1));n&&(kr=!0,t.state.updateSlice("mediumProfiles",()=>r),kr=!1)}function po(e){if(!e)return Fe=0,{start:0,end:0,total:0};const t=Math.max(Math.ceil(e/Bn),1);Fe>=t&&(Fe=t-1),Fe<0&&(Fe=0);const a=Fe*Bn,n=Math.min(a+Bn,e);return{start:a,end:n,total:e}}function Ed(){if(!Ur)return null;const e=Ur.querySelector('[data-role="mediums-pager"]');return e?((!oa||Gr!==e)&&(oa?.destroy(),oa=nn(e,{onPrev:()=>Ld(),onNext:()=>Dd(),labels:{prev:"Zurück",next:"Weiter",loading:"Lade Mittel...",empty:"Keine Mittel verfügbar"}}),Gr=e),oa):null}function gs(e){const t=Ed();if(!t)return;const a=at(e).length;if(!a){Fe=0,t.update({status:"disabled",info:"Noch keine Mittel gespeichert."});return}const{start:n,end:r}=po(a),s=`Mittel ${Sr.format(n+1)}–${Sr.format(r)} von ${Sr.format(a)}`;t.update({status:"ready",info:s,canPrev:Fe>0,canNext:r<a})}function Ld(){if(Fe===0)return;const e=mi?.state.getState();e&&(Fe=Math.max(Fe-1,0),fi(e))}function Dd(){const e=mi?.state.getState();if(!e)return;const t=at(e).length;if(!t)return;const a=Math.max(Math.ceil(t/Bn)-1,0);Fe>=a||(Fe=Math.min(Fe+1,a),fi(e))}function fi(e){if(!vt)return;uo(e);const t=new Map(e.measurementMethods.map(l=>[l.id,l])),a=at(e).length;if(!a){vt.innerHTML=`
      <tr>
        <td colspan="9" class="text-center text-muted">Noch keine Mittel gespeichert.</td>
      </tr>
    `,Ct(e),gs(e);return}const{start:n,end:r}=po(a),s=at(e).slice(n,r);vt.innerHTML="",s.forEach((l,o)=>{const d=n+o,m=document.createElement("tr"),u=t.get(l.methodId),f=l.approval||l.zulassungsnummer,v=typeof f=="string"&&f.trim().length?g(f):"-",k=typeof l.wartezeit=="string"&&l.wartezeit.trim().length?g(l.wartezeit):typeof l.wartezeit=="number"?`${l.wartezeit} Tage`:"-",h=typeof l.wirkstoff=="string"&&l.wirkstoff.trim().length?g(l.wirkstoff):"-";m.innerHTML=`
    ...
    `,vt?.appendChild(m)}),Ct(e),gs(e)}function bs(e){if(!Ra)return;const t=new Set;Ra.innerHTML="",e.measurementMethods.forEach(a=>{const n=(a.label??"").toLowerCase(),r=(a.id??"").toLowerCase();if(n&&!t.has(n)){t.add(n);const s=document.createElement("option");s.value=a.label,Ra.appendChild(s)}if(r&&!t.has(r)){t.add(r);const s=document.createElement("option");s.value=a.id,Ra.appendChild(s)}})}function $d(e){const t=e.toLowerCase().trim().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"");return t||`method-${Date.now()}-${Math.random().toString(16).slice(2,6)}`}function zd(e,t){if(!In)return null;const a=In.value.trim();if(!a)return window.alert("Bitte eine Methode angeben."),In.focus(),null;const n=e.measurementMethods.find(o=>o.label?.toLowerCase()===a.toLowerCase()||o.id?.toLowerCase()===a.toLowerCase());if(n)return n.id;const r=$d(a),s=e.fieldLabels?.calculation?.fields?.quantity?.unit||"Kiste",l={id:r,label:a,type:"factor",unit:s,requires:["areaHa"],config:{sourceField:"areaHa"}};return t.state.updateSlice("measurementMethods",o=>[...o,l]),r}async function Vn(e){try{const t=Ye();return await Xe(t),e?.silent||window.alert(e?.successMessage??"Änderungen wurden gespeichert."),!0}catch(t){console.error("Fehler beim Speichern",t);const a=t instanceof Error?t.message:"Speichern fehlgeschlagen";return window.alert(a),!1}}function Ad(e,t){const a=!!t.app?.hasDatabase,n=t.app?.activeSection==="settings";e.classList.toggle("d-none",!(a&&n))}function Pd(e,t){if(!e||ms)return;const a=e;a.innerHTML="";const n=hd();a.appendChild(n),Ur=n,mi=t,Fe=0,oa?.destroy(),oa=null,Gr=null,vt=n.querySelector("#settings-mediums-table tbody"),In=n.querySelector('input[name="medium-method"]'),Ra=n.querySelector("#settings-method-options"),Kt=n.querySelector("#settings-medium-form"),_a=Kt?Kt.querySelector('button[type="submit"]'):null,Wn=n.querySelector("#settings-profile-form"),yt=n.querySelector("#profile-name"),en=n.querySelector('input[name="profile-id"]'),jn=n.querySelector("#settings-profile-table tbody"),xt=n.querySelector('[data-role="profile-submit"]'),jr=n.querySelector('[data-role="profile-selection-summary"]'),bt=n.querySelector('[data-role="profile-select-all"]');let r=!1,s=!1;function l(u){if(n.querySelectorAll("[data-settings-tab]").forEach(f=>{const v=f.dataset.settingsTab===u;f.classList.toggle("active",v)}),n.querySelectorAll("[data-pane]").forEach(f=>{const v=f.dataset.pane===u;f.style.display=v?"block":"none"}),u==="gps"&&!r){const f=n.querySelector('[data-feature="gps-embedded"]');f&&(pd(f,t),r=!0)}if(u==="codes"&&!s){const f=n.querySelector('[data-feature="codes-embedded"]');f&&(bd(),gd(f,{state:t.state,events:{subscribe:t.events?.subscribe}},{}),s=!0)}}n.querySelectorAll("[data-settings-tab]").forEach(u=>{u.addEventListener("click",()=>{const f=u.dataset.settingsTab;f&&l(f)})});async function o(){if(!Kt||ma)return;const u=t.state.getState(),f=new FormData(Kt),v=(f.get("medium-name")||"").toString().trim(),k=(f.get("medium-unit")||"").toString().trim(),h=f.get("medium-value"),S=Number(h),w=(f.get("medium-approval")||"").toString().trim(),E=f.get("medium-wartezeit"),I=E?Number(E):null,U=(f.get("medium-wirkstoff")||"").toString().trim()||null;if(!v||!k||Number.isNaN(S)){window.alert("Bitte alle Felder korrekt ausfüllen.");return}const K=zd(u,t);if(!K)return;const he=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`medium-${Date.now()}-${Math.random().toString(16).slice(2,8)}`,F={id:he,name:v,unit:k,methodId:K,value:S,zulassungsnummer:w||null,wartezeit:I!=null&&!Number.isNaN(I)?I:null,wirkstoff:U};ma=!0,Un(!0,"Speichere...");try{t.state.updateSlice("mediums",q=>{const D=tn(q),A=[...D.items,F];return{...D,items:A,totalCount:A.length,lastUpdatedAt:new Date().toISOString()}}),bs(t.state.getState()),await Vn({successMessage:"Mittel gespeichert.",silent:!0})&&(Kt.reset(),t.events?.emit?.("mediums:data-changed",{action:"created",id:he}))}finally{ma=!1,Un(!1)}}Kt?.addEventListener("submit",u=>{u.preventDefault(),o()}),vt?.addEventListener("click",u=>{const f=u.target?.closest('[data-action="delete"]');if(!f)return;const v=Number(f.dataset.index);Number.isNaN(v)||xd(v,t,f)}),vt?.addEventListener("change",u=>{const f=u.target;if(!f||f.dataset.role!=="profile-select")return;const v=f.dataset.mediumId;if(!v)return;f.checked?Pe.add(v):Pe.delete(v);const k=t.state.getState();Ct(k)}),bt?.addEventListener("change",()=>{const u=t.state.getState();bt&&(bt.indeterminate=!1,bt.checked?Pe=new Set(at(u).map(f=>f.id)):Pe=new Set,Gn(),Ct(u))});const d=async()=>{if(!yt)return;const u=yt.value.trim();if(!u){window.alert("Bitte einen Profilnamen eingeben."),yt.focus();return}if(!Pe.size){window.alert("Bitte mindestens ein Mittel auswählen.");return}const f=t.state.getState();if(f.mediumProfiles?.some(w=>w.name.toLowerCase()===u.toLowerCase()&&w.id!==Mt)){window.alert("Ein Profil mit diesem Namen existiert bereits.");return}const k=at(f).filter(w=>Pe.has(w.id)).map(w=>w.id);if(!k.length){window.alert("Ausgewählte Mittel sind nicht mehr verfügbar. Bitte Auswahl prüfen."),uo(f),Gn(),Ct(f);return}if(wr)return;const h=!!Mt;wr=!0,fs(!0,h?"Aktualisiere...":"Speichere...");const S=new Date().toISOString();try{if(Mt)t.state.updateSlice("mediumProfiles",(E=[])=>E.map(I=>I.id===Mt?{...I,name:u,mediumIds:k,updatedAt:S}:I));else{const E={id:vd(),name:u,mediumIds:k,createdAt:S,updatedAt:S};t.state.updateSlice("mediumProfiles",(I=[])=>[...I,E])}await Vn({successMessage:h?"Profil aktualisiert und gespeichert.":"Profil gespeichert."})&&Nn(t.state.getState())}finally{wr=!1,fs(!1)}};Wn?.addEventListener("submit",u=>{u.preventDefault(),d()}),jn?.addEventListener("click",u=>{const f=u.target?.closest('[data-action^="profile-"]');if(!f)return;const v=f.dataset.id;if(!v)return;const k=t.state.getState();if(f.dataset.action==="profile-edit"){const h=k.mediumProfiles?.find(S=>S.id===v);h&&yd(h,k);return}if(f.dataset.action==="profile-delete"){const h=k.mediumProfiles?.find(S=>S.id===v);if(!h||!window.confirm(`Profil "${h.name}" wirklich löschen?`))return;kd(h,t,f)}}),n.querySelector('[data-action="profile-reset"]')?.addEventListener("click",()=>{Nn(t.state.getState())}),Nn(t.state.getState());const m=u=>{Sd(u,t),Ad(n,u),u.app.activeSection==="settings"&&(fi(u),bs(u),wd(u),Ct(u))};t.state.subscribe(m),m(t.state.getState()),ms=!0}const Fa=e=>g(e),Er=(e,t=1)=>Number.isFinite(e)?e.toLocaleString("de-DE",{minimumFractionDigits:t,maximumFractionDigits:t}):"–";function fa(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString("de-DE")}function Md(e){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return g(e);const a=Math.round((t.getTime()-Date.now())/864e5);return a<0?`<span style="color:#ef4444;">${fa(e)} · abgelaufen</span>`:a<180?`<span style="color:#f59e0b;">${fa(e)} · ${a} T</span>`:`<span class="calc-hint">${fa(e)}</span>`}function Cd(){return`
    <section class="calc-section">
      ...
      <fieldset class="calc-fieldset mb-4">
        ...
        <div data-role="lager-bewegungen"></div>
          ...
          <td class="text-end">${Er(h.verbraucht)} ${w}<span class="d-block calc-hint">${h.anwendungen} Anw.</span></td>
          <td class="text-end fw-semibold" style="color:${S};">${Er(h.bestand)} ${w}</td>
          <td>${Md(h.zulEnde)}</td>
          <td class="calc-hint">${h.naechsterAblauf?fa(h.naechsterAblauf):""}</td>
        </tr>`}).join("")}},m=k=>{if(n){if(!k.length){n.innerHTML='<div class="calc-hint">Keine Bewegungen erfasst.</div>';return}n.innerHTML=k.map(h=>`
        <div class="d-flex align-items-center gap-2 py-1" style="border-bottom:1px solid var(--border-1);">
          ...
          <span class="flex-grow-1">${g(h.mittelName)} · <b>${Er(h.menge)} ${g(h.einheit||"")}</b>${h.charge?` · Charge ${g(h.charge)}`:""}<span class="d-block calc-hint">${fa(h.datum)}${h.lieferant?" · "+g(h.lieferant):""}${h.ablauf?" · Ablauf "+fa(h.ablauf):""}</span></span>
...
`);try{await navigator.clipboard.writeText(p),B.success("Werte kopiert.")}catch{B.warning("Kopieren nicht möglich.")}}const L=i=>({icon:'<i class="bi bi-palette"></i>',label:"Farbe",submenu:[{type:"swatchGrid",colors:zt,current:i.color,onPick:c=>ka(i,c),onLive:c=>Et(i,c)}]}),O=i=>({icon:'<i class="bi bi-flower1"></i>',label:"Kultur zuweisen",submenu:[{icon:'<i class="bi bi-x"></i>',label:"– keine –",action:()=>Ze(i,null)},...Wt.length?[{sep:!0}]:[],...Wt.map(c=>({icon:c.kultur===i.kultur?'<i class="bi bi-check2"></i>':"",label:`${c.kultur}${c.anbau?" ("+c.anbau+")":""}`,action:()=>Ze(i,c.kultur)}))]});function T(i,c,p){Re(i._key);const{x:y,y:b}=$t(c),M=!!i.editing;ke(y,b,[{icon:'<i class="bi bi-clipboard2-pulse"></i>',label:"Kulturführung öffnen",action:()=>rr(i)},{icon:'<i class="bi bi-pencil"></i>',label:"Umbenennen",action:()=>sr(i)},O(i),L(i),{sep:!0},{icon:'<i class="bi bi-arrow-clockwise"></i>',label:"Beete drehen +15°",keepOpen:!0,action:()=>Xt(i,15)},{icon:'<i class="bi bi-arrow-counterclockwise"></i>',label:"Beete drehen −15°",keepOpen:!0,action:()=>Xt(i,-15)},{icon:'<i class="bi bi-bounding-box"></i>',label:"Beete an Fläche ausrichten",action:()=>dn(i)},{icon:'<i class="bi bi-grid-3x3-gap"></i>',label:i.bedsHidden?"Beete einblenden":"Beete ausblenden",action:()=>un(i)},{icon:'<i class="bi bi-bounding-box-circles"></i>',label:M?"Eckpunkte fertig":"Eckpunkte bearbeiten",action:()=>{M?Me(i):ut(i)}},{sep:!0},{icon:'<i class="bi bi-copy"></i>',label:"Duplizieren",action:()=>ea(i)},{icon:'<i class="bi bi-zoom-in"></i>',label:"Auf Fläche zoomen",action:()=>Lt(i)},{icon:'<i class="bi bi-clipboard-data"></i>',label:"Werte kopieren",action:()=>x(i)},{icon:'<i class="bi bi-download"></i>',label:"Als GeoJSON exportieren",action:()=>wa(i)},{sep:!0},{icon:'<i class="bi bi-trash"></i>',label:"Löschen",danger:!0,action:()=>W(i._key)}],p?`${i.name||"Fläche"} · Beet ${p}`:i.name||"Fläche")}function z(i,c,p){const{x:y,y:b}=$t(p);ke(y,b,[{icon:'<i class="bi bi-node-minus"></i>',label:"Eckpunkt löschen",disabled:i.latlngs.length<=3,action:()=>{i.latlngs.length<=3||(i.latlngs.splice(c,1),nt(i))}},{icon:'<i class="bi bi-check2"></i>',label:"Bearbeiten beenden",action:()=>Me(i)}],`Eckpunkt ${c+1}`)}function P(){!o.sat||!o.osm||(_.hasLayer(o.sat)?(_.removeLayer(o.sat),o.osm.addTo(_),B.info("Karte: OSM")):(_.removeLayer(o.osm),o.sat.addTo(_),B.info("Karte: Satellit")))}function N(i){const c=i.latlng,{x:p,y}=$t(i);ke(p,y,[{icon:'<i class="bi bi-pencil-square"></i>',label:"Neue Fläche hier zeichnen",action:()=>{_t(!0),Da({latlng:c})}},{icon:'<i class="bi bi-crosshair"></i>',label:"Hierhin zentrieren",action:()=>_.panTo(c)},{sep:!0},{icon:'<i class="bi bi-arrows-fullscreen"></i>',label:"Alle Flächen anzeigen",disabled:!a.some(b=>b.latlngs?.length>=3),action:on},{icon:'<i class="bi bi-layers"></i>',label:"Kartentyp wechseln (Satellit/OSM)",action:P},{sep:!0},{icon:'<i class="bi bi-geo-alt"></i>',label:"Koordinaten kopieren",action:async()=>{try{await navigator.clipboard.writeText(`${c.lat.toFixed(6)}, ${c.lng.toFixed(6)}`),B.success("Koordinaten kopiert.")}catch{B.warning("Kopieren nicht möglich.")}}}],"Karte")}function ue(i){return['<option value="">– Kultur –</option>'].concat(Wt.map(c=>{const p=`${c.kultur}${c.anbau?" ("+c.anbau+")":""}`;return`<option value="${g(c.kultur)}"${c.kultur===i?" selected":""}>${g(p)}</option>`})).join("")}function pe(i){const c=je(t.state.getState().gps?.points)||[];return['<option value="">– Standort –</option>'].concat(c.map(p=>`<option value="${g(p.id)}"${p.id===i?" selected":""}>${g(p.name||"")}</option>`)).join("")}function me(i){const c=h(i);return c?`<span class="acker-cropchip" title="Kultur"><span class="dot" style="background:${g(c.color||"#94a3b8")}"></span>${g(c.name)}</span>`:""}function J(i){if(i=Math.round(i||0),i<=0)return"0";let c=100;return i>=1e5?c=1e3:i>=1e4&&(c=500),"≈ "+X(Math.round(i/c)*c)}function G(i,c){const p=i.result?.beds?.length||0,y=i.params.bedW+i.params.pathW;if(p<1||y<=0){B.warning("Erst Beete berechnen lassen.");return}const M=+(p*y/c-i.params.pathW).toFixed(2);if(M<.1){B.warning("Wegbreite ist größer als der gewünschte Abstand – erst Wegbreite verkleinern.");return}i.params.bedW=M,nt(i),B.success(`Bettbreite ${X(M,2)} m → ${i.result?.beds?.length||0} Beete.`)}function ae(){if(!K)return;let i=0,c=0,p=0,y=0;a.forEach(M=>{i+=M.result?.areaM2||0,c+=M.result?.beds?.length||0,p+=M.result?.bedMeters||0,y+=M.result?.plants||0});const b=(M,C)=>{const Y=K.querySelector(M);Y&&(Y.textContent=C)};b('[data-t="area"]',X(i)+" m² · "+X(i/1e4,3)+" ha"),b('[data-t="beds"]',X(c)),b('[data-t="meters"]',X(p)+" m"),b('[data-t="plants"]',J(y))}function fe(i,c){const p=c.result||{},y=i.querySelector(".acker-stat");y&&(y.textContent=X(p.plants||0)+" Pfl.");const b=(M,C)=>{const Y=i.querySelector(`[data-r="${M}"]`);Y&&(Y.textContent=C)};b("area",X(p.areaM2||0)+" m² · "+X((p.areaM2||0)/1e4,3)+" ha"),b("pitch",X(c.params.bedW+c.params.pathW,2)+" m"),b("beds",X(p.beds?.length||0)),b("meters",X(p.bedMeters||0)+" m"),b("plants",J(p.plants||0)),ae()}const xe=["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."];function Be(i){if(!i)return"";const c=new Date(String(i).slice(0,10)+"T00:00:00");return isNaN(c.getTime())?"":`${c.getDate()}. ${xe[c.getMonth()]}`}function H(i){const c=i?.ernteVon?Be(i.ernteVon):"",p=i?.ernteBis||i?.ernteDatum?Be(i.ernteBis||i.ernteDatum):"";return c&&p?`Ernte ${c}–${p}`:p?`Ernte ~${p}`:c?`Ernte ab ${c}`:""}function ce(){const i=E('[data-role="acker-info"]');i&&(i.style.display="none")}function we(i){const c=E('[data-role="acker-info"]');if(!c)return;const{current:p,next:y}=la(v(i.typ,i.id)),b=k(i.typ,i.id).filter(it=>it.status==="geplant").length,M=i.typ==="haus",C=i.area?`${X(i.area)} m²`:"",Y=p?ga(p):"#94a3b8",ve=p?`<div class="ai-row"><span class="ai-dot" style="background:${g(Y)}"></span>
  ...
  <section class="calc-section">
  ...
  </section>`}function Ta(e){return e.typ+":"+e.id}function Wd(e){if(!Array.isArray(e)||e.length<3)return null;let t=0,a=0,n=0;const r=e.length,s=e[r-1],l=e[0],d=s&&l&&Number(s[0])===Number(l[0])&&Number(s[1])===Number(l[1])?r-1:r;for(let m=0;m<d;m++){const u=Number(e[m]?.[0]),f=Number(e[m]?.[1]);Number.isFinite(u)&&Number.isFinite(f)&&(t+=u,a+=f,n++)}return n?{lat:t/n,lon:a/n}:null}async function vs(e){const t=[];(je(e.state.getState().gps?.points)||[]).forEach(n=>{if(n?.kind!=="gewaechshaus")return;const r=Number(n.latitude),s=Number(n.longitude),l=Number(n.nutzflaecheQm);t.push({typ:"haus",id:String(n.id),name:n.name||"Gewächshaus",areaQm:Number.isFinite(l)&&l>0?l:null,lat:Number.isFinite(r)?r:null,lon:Number.isFinite(s)?s:null,color:null})});try{((await Jr())?.rows||[]).forEach(r=>{const s=Wd(r.latlngs),l=Number(r.areaQm);t.push({typ:"acker",id:String(r.id),name:r.name||"Fläche",areaQm:Number.isFinite(l)&&l>0?l:null,lat:s?.lat??null,lon:s?.lon??null,color:r.color||null})})}catch{}return t}const jd="Wetterdaten: Open-Meteo (CC BY 4.0)",Gd="psm.weather.";function Ud(){const e=new Date;return e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0")}function Vd(e,t){return Gd+e.toFixed(3)+"_"+t.toFixed(3)}function Zd(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}}function Qd(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function Jd(e){return!!e&&e.slice(0,10)===Ud()}function Yd(e,t,a){const n=e?.time||[],r=e?.temperature_2m_max||[],s=e?.temperature_2m_min||[],l=e?.precipitation_sum||[],o=e?.sunshine_duration||[],d=On(new Date),m=Di(d.year,d.week),u=new Map;for(let v=0;v<n.length;v++){const k=Is(n[v]);if(!k)continue;const{year:h,week:S}=On(k),w=Di(h,S);let E=u.get(w);E||(E={key:w,year:h,week:S,tmaxSum:0,tmaxN:0,tminSum:0,tminN:0,precip:0,precipN:0,sun:0,sunN:0,days:0},u.set(w,E)),Number.isFinite(r[v])&&(E.tmaxSum+=r[v],E.tmaxN++),Number.isFinite(s[v])&&(E.tminSum+=s[v],E.tminN++),Number.isFinite(l[v])&&(E.precip+=l[v],E.precipN++),Number.isFinite(o[v])&&(E.sun+=o[v],E.sunN++),E.days++}const f=[...u.values()].sort((v,k)=>v.key<k.key?-1:v.key>k.key?1:0).map(v=>{const k=v.tmaxN?v.tmaxSum/v.tmaxN:null,h=v.tminN?v.tminSum/v.tminN:null;return{weekKey:v.key,year:v.year,week:v.week,tMaxAvg:k,tMinAvg:h,tMeanAvg:k!=null&&h!=null?(k+h)/2:k,precipSum:v.precipN?v.precip:null,sunHours:v.sunN?v.sun/3600:null,days:v.days,isForecast:v.key>=m}});return{lat:t,lon:a,fetchedAt:new Date().toISOString(),weeks:f}}async function Xd(e,t){if(!Number.isFinite(e)||!Number.isFinite(t))return{lat:e,lon:t,fetchedAt:new Date().toISOString(),weeks:[]};const a=Vd(e,t),n=Zd(a);if(n&&Jd(n.fetchedAt)&&n.weeks?.length)return n;if(typeof navigator<"u"&&navigator.onLine===!1)return n?{...n,stale:!0}:{lat:e,lon:t,fetchedAt:new Date().toISOString(),weeks:[]};const r="https://api.open-meteo.com/v1/forecast?latitude="+e.toFixed(4)+"&longitude="+t.toFixed(4)+"&daily=temperature_2m_max,temperature_2m_min,precipitation_sum,sunshine_duration&timezone=Europe%2FBerlin&past_days=92&forecast_days=16";try{const s=await fetch(r);if(!s.ok)throw new Error("HTTP "+s.status);const l=await s.json(),o=Yd(l.daily,e,t);return o.weeks.length&&Qd(a,o),o}catch{return n?{...n,stale:!0}:{lat:e,lon:t,fetchedAt:new Date().toISOString(),weeks:[]}}}const Lr=66;function eu(e,t){const{units:a,anbau:n,mass:r,onSelect:s,onContext:l}=t;if(!a||!a.length){e.innerHTML='<div class="km-empty"><i class="bi bi-calendar3"></i><p>Noch keine Flächen für den Anbauplan.</p></div>';return}const o=new Date;let d=new Date(o.getFullYear(),o.getMonth()-1,1),m=new Date(o.getFullYear(),o.getMonth()+4,1);const u=F=>{if(!F)return;const Q=new Date(String(F).slice(0,10)+"T00:00:00");isNaN(Q.getTime())||(Q<d&&(d=new Date(Q.getFullYear(),Q.getMonth(),1)),Q>m&&(m=new Date(Q.getFullYear(),Q.getMonth(),1)))};(n||[]).forEach(F=>{u(F.pflanzDatum),u(F.ernteBis||F.ernteDatum),u(F.ernteVon)}),(r||[]).forEach(F=>u(F.planDatum||F.erledigtDatum));const f=bo(d,m),v=f.length,k=v*Lr,h=F=>F==null?null:(F*100).toFixed(2)+"%",S=Ke(f,o.toISOString()),w=a.filter(F=>F.typ==="haus"),E=a.filter(F=>F.typ==="acker");let I="";f.forEach((F,Q)=>{const q=F.y===o.getFullYear()&&F.m===o.getMonth();I+=`<div class="kb2-mo${q?" cur":""}" style="width:${Lr}px">${go[F.m]}${F.m===0?" "+String(F.y).slice(2):""}</div>`});const U=F=>{const Q=(n||[]).filter(A=>A.flaecheTyp===F.typ&&String(A.flaecheId)===String(F.id)),q=(r||[]).filter(A=>A.flaecheTyp===F.typ&&String(A.flaecheId)===String(F.id));let D="";return Q.forEach((A,ee)=>{const ie=Ke(f,A.pflanzDatum);let te=Ke(f,A.ernteBis||A.ernteDatum||A.pflanzDatum);if(ie==null)return;(te==null||te<=ie)&&(te=Math.min(1,ie+.5/v));const ye=ga(A,ee),ut=A.status==="geplant";D+=`<div class="kb2-bar${ut?" planned":""}" title="${g(A.kultur||"Kultur")}" style="left:${h(ie)};width:${((te-ie)*100).toFixed(2)}%;--cc:${g(ye)}"><span>${g(A.kultur||"")}</span></div>`;const Me=Ke(f,A.ernteVon),Ce=Ke(f,A.ernteBis);Me!=null&&Ce!=null&&Ce>Me&&(D+=`<div class="kb2-harvest" title="Ernte" style="left:${h(Me)};width:${((Ce-Me)*100).toFixed(2)}%;--cc:${g(ye)}"></div>`)}),q.forEach(A=>{const ee=A.status==="erledigt"?A.erledigtDatum||A.planDatum:A.planDatum||A.erledigtDatum,ie=Ke(f,ee);if(ie==null)return;const te=mo(A.art),ye=A.status==="erledigt";D+=`<span class="kb2-mk${ye?" done":""}" title="${g(te.label+(A.notes?": "+A.notes:""))}" style="left:${h(ie)};--mc:${te.color}"></span>`}),S!=null&&(D+=`<div class="kb2-today" style="left:${h(S)}"></div>`),D},K=F=>{const Q=F.typ+":"+F.id,q=(n||[]).filter(ee=>ee.flaecheTyp===F.typ&&String(ee.flaecheId)===String(F.id)),D=q.find(ee=>ee.status==="aktiv")||q.find(ee=>ee.status!=="abgeschlossen"),A=D?g(D.kultur||""):"frei";return`<div class="kb2-row" data-ukey="${Q}">
      <div class="kb2-label" title="${g(F.name)}"><b>${g(F.name)}</b><small>${A}</small></div>
      <div class="kb2-track" style="width:${k}px">${U(F)}</div>
    </div>`},he=(F,Q)=>Q.length?`<div class="kb2-grp"><div class="kb2-grp-l">${g(F)}</div><div class="kb2-grp-t" style="width:${k}px"></div></div>`+Q.map(K).join(""):"";e.innerHTML=`
    <style>
      ...
      .kb2-track{position:relative;height:38px;border-top:1px solid var(--border-1);background-image:linear-gradient(to right,var(--border-1) 1px,transparent 1px);background-size:${Lr}px 100%}
    ...
    <div class="kb2-legend">
    ...
    </div>`,e.querySelectorAll(".kb2-row").forEach(F=>{const Q=F.dataset.ukey;F.querySelector(".kb2-label")?.addEventListener("click",()=>s&&s(Q)),F.addEventListener("contextmenu",q=>{q.preventDefault(),l&&l(Q,q.clientX,q.clientY)})})}const tu=[{art:"bewaesserung",label:"Gießen",icon:"bi-droplet"},{art:"mechanisch",label:"Hacken",icon:"bi-tools"},{art:"duengung",label:"Düngen",icon:"bi-flower1"},{art:"nuetzlinge",label:"Nützlinge",icon:"bi-bug"},{art:"chemisch_psm",label:"Pflanzenschutz",icon:"bi-droplet-half"},{art:"monitoring",label:"Kontrolle",icon:"bi-eye"},{art:"sonstiges",label:"Sonstiges",icon:"bi-three-dots"}],au=["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."];function nu(e,t){if(!(e instanceof HTMLElement))return;e.innerHTML=ru();let a=[],n=[],r=[],s=[],l=[],o=null,d="plan",m=!1,u=!1;const f={};let v=null;const k=x=>e.querySelector(x),h=()=>k('[data-role="list"]'),S=()=>k('[data-role="detail"]'),w=()=>k('[data-role="kpis"]'),E=()=>k('[data-role="board-view"]'),I=()=>k('[data-role="flaechen-view"]'),U=()=>de()==="sqlite",K=()=>{U()&&tt().catch(()=>{})},he=(x,L)=>x.filter(O=>O.flaecheTyp===L.typ&&String(O.flaecheId)===String(L.id)),F=x=>a.find(L=>Ta(L)===x)||null,Q=(x,L=0)=>fo(x.color)||Gt[L%Gt.length];async function q(){if(a=await vs(t),U()){try{n=(await $r())?.rows||[]}catch{n=[]}try{r=(await $n())?.rows||[]}catch{r=[]}try{s=(await Qr())?.rows||[]}catch{s=[]}try{l=(await il())?.rows||[]}catch{l=[]}if(!u){u=!0;try{const x=await $i();x?.imported&&(r=(await $n())?.rows||[],B.info(`${x.imported} Pflanzenschutz-Eintrag(e) übernommen.`),K())}catch{}}}!o&&a.length&&(o=Ta(a[0])),ee(),A()}async function D(){if(U()){try{n=(await $r())?.rows||[]}catch{}try{r=(await $n())?.rows||[]}catch{}}}async function A(){const x=o?F(o):null;if(!x||x.lat==null||x.lon==null)return;const L=Ta(x);if(!f[L]){f[L]={loading:!0,weeks:[]};try{f[L]=await Xd(x.lat,x.lon)}catch{f[L]={weeks:[]}}o===L&&Ce()}}function ee(){te(),d==="plan"?(I().style.display="none",E().style.display="block",eu(E(),{units:a,anbau:n,mass:r,onSelect:x=>{o=x,ie("flaechen"),A()},onContext:(x,L,O)=>ka(x,L,O)})):(E().style.display="none",I().style.display="grid",ut(),Ce()),e.querySelectorAll(".km-modebtn").forEach(x=>x.classList.toggle("active",x.dataset.mode===d))}function ie(x){d=x,ee()}function te(){const x=w();if(!x)return;a.filter(z=>z.typ==="haus").length,a.filter(z=>z.typ==="acker").length;let L=0,O=null;a.forEach(z=>{const{current:P,next:N}=la(he(n,z));P&&L++,N?.pflanzDatum&&(!O||Le(N.pflanzDatum)<Le(O.pflanzDatum))&&(O=N)});const T=r.filter(z=>z.status==="geplant").length;x.innerHTML=`
      ${ye(String(a.length),"Flächen")}
      ${ye(String(L),"Kulturen aktiv")}
      ${ye(String(T),"Aufgaben offen")}
      ${ye(O?Pa(Et(O.pflanzDatum)):"–","Nächste Pflanzung")}
      <button class="km-psm" data-role="psm-import" title="Bestehende Pflanzenschutz-Einträge übernehmen"><i class="bi bi-arrow-down-circle"></i><span>PSM übernehmen</span></button>`,x.querySelector('[data-role="psm-import"]')?.addEventListener("click",ln)}const ye=(x,L)=>`<div class="km-kpi"><div class="km-kpi-v">${x}</div><div class="km-kpi-l">${g(L)}</div></div>`;function ut(){const x=h();if(!x)return;if(!a.length){x.innerHTML='<div class="km-empty"><i class="bi bi-geo-alt"></i><p>Noch keine Flächen.<br>Gewächshäuser unter Einstellungen, Freiland im Reiter „Karte".</p></div>';return}const L=a.filter(z=>z.typ==="haus"),O=a.filter(z=>z.typ==="acker"),T=(z,P)=>P.length?`<div class="km-grp">${g(z)}</div>`+P.map(Me).join(""):"";x.innerHTML=T("Gewächshäuser",L)+T("Freiland",O),x.querySelectorAll("[data-ukey]").forEach(z=>{z.addEventListener("click",()=>{o=z.dataset.ukey,ut(),Ce(),A()}),z.addEventListener("contextmenu",P=>{P.preventDefault(),ka(z.dataset.ukey,P.clientX,P.clientY)})})}function Me(x,L){const O=Ta(x),{current:T}=la(he(n,x));return`<div class="km-row${O===o?" sel":""}" data-ukey="${O}">
      <span class="km-dot" style="background:${g(T?ga(T):Q(x,L))}"></span>
    ...
    </div>`}function Ce(){const x=S();if(!x)return;const L=o?F(o):null;if(!L){x.innerHTML='<div class="km-empty"><i class="bi bi-hand-index"></i><p>Fläche links wählen.</p></div>';return}const O=he(n,L),T=he(r,L),{current:z,next:P}=la(O),N=f[Ta(L)],ue=L.typ==="haus"?"Gewächshaus":"Freiland",pe=L.areaQm?`${Math.round(L.areaQm).toLocaleString("de-DE")} m²`:"";let me;if(z){const G=z.pflanzDatum?`seit ${Lt(z.pflanzDatum)} · ${Pa(Et(z.pflanzDatum))}`:"",ae=rr(z);me=`<div class="km-hero active" style="--cc:${g(ga(z))}">
      ...
      <div class="km-attr">${g(jd)}${N?.stale?" · offline":""}</div>`,x.querySelector('[data-act="map"]')?.addEventListener("click",()=>xa()),x.querySelector('[data-act="plan"]')?.addEventListener("click",()=>ie("plan")),x.querySelector('[data-act="add-massnahme"]')?.addEventListener("click",()=>wa(L,null,z)),x.querySelectorAll("[data-edit-crop]").forEach(G=>G.addEventListener("click",()=>{const ae=G.dataset.editCrop;ea(L,ae==="current"?z:P,ae,O.length)})),x.querySelectorAll("[data-m-done]").forEach(G=>G.addEventListener("click",ae=>{ae.stopPropagation(),ir(G.dataset.mDone)})),x.querySelectorAll("[data-m-del]").forEach(G=>G.addEventListener("click",ae=>{ae.stopPropagation(),cn(G.dataset.mDel)})),x.querySelectorAll("[data-m-edit]").forEach(G=>G.addEventListener("click",()=>{const ae=r.find(fe=>fe.id===G.dataset.mEdit);wa(L,ae,z)}))}function Yt(x){const L=x.filter(N=>N.status==="geplant").sort((N,ue)=>(Le(N.planDatum)||9e15)-(Le(ue.planDatum)||9e15)),O=x.filter(N=>N.status==="erledigt").sort((N,ue)=>(Le(ue.erledigtDatum)||0)-(Le(N.erledigtDatum)||0)).slice(0,6),T=Number(st().replace(/-/g,"")),z=(N,ue)=>{const pe=mo(N.art),me=ue?N.erledigtDatum:N.planDatum,J=!ue&&me&&Le(me)<T,G=ue?Lt(me):on(me,J),ae=N.notes||pe.label,fe=N.historyId?'<span class="km-pill">PSM</span>':"",xe=[];N.notes&&xe.push(g(pe.label)),N.mittel&&xe.push(g(N.mittel)),N.menge!=null&&xe.push(`${N.menge}${N.einheit?" "+g(N.einheit):""}`);const Be=xe.join(" · ");return`<div class="km-task${ue?" done":""}" data-m-edit="${N.id}">
        <span class="km-task-ic" style="--mc:${pe.color}"><i class="bi ${pe.icon}"></i></span>
        <div class="km-task-main"><div class="km-task-title">${g(ae)}${fe}</div>${Be?`<div class="km-task-sub">${Be}</div>`:""}</div>
      ...
      </div>`};let P="";return L.length?P+=L.map(N=>z(N,!1)).join(""):P+='<div class="km-tasks-none"><i class="bi bi-check2-circle"></i> Nichts offen</div>',O.length&&(P+='<div class="km-done-h">Erledigt</div>'+O.map(N=>z(N,!0)).join("")),`<div class="km-tasks">${P}</div>`}function Et(x){const L=new Date(String(x).slice(0,10)+"T00:00:00");return isNaN(L.getTime())?0:On(L).week}function Lt(x){const L=new Date(String(x).slice(0,10)+"T00:00:00");return isNaN(L.getTime())?"":`${L.getDate()}. ${au[L.getMonth()]}`}function on(x,L){if(!x)return"offen";const O=new Date(String(x).slice(0,10)+"T00:00:00");if(isNaN(O.getTime()))return"offen";const T=new Date;T.setHours(0,0,0,0);const z=Math.round((O.getTime()-T.getTime())/864e5);return z===0?"heute":z===1?"morgen":L?"überfällig":Lt(x)}function nt(x){if(!x||!x.weeks?.length)return x?.loading?"Wetter lädt…":"";const{year:L,week:O}=On(new Date),T=x.weeks.find(N=>N.year===L&&N.week===O)||x.weeks.find(N=>!N.isForecast);if(!T)return"";const z=T.tMaxAvg!=null?Math.round(T.tMaxAvg)+"°":"–",P=T.precipSum!=null?Math.round(T.precipSum)+" mm":"–";return`<i class="bi bi-cloud-sun"></i> Diese Woche: ${z} · ${P} Regen`}function rr(x){const L=x.ernteVon?Pa(Et(x.ernteVon)):null,O=x.ernteBis||x.ernteDatum,T=O?Pa(Et(O)):null;return L&&T?` · Ernte ${L}–${T}`:T?` · Ernte ~${T}`:L?` · Ernte ab ${L}`:""}function Ie(x){return!x||x.menge==null||x.menge===""?"":` · ${x.menge} ${x.einheit||"Pflanzen"}`}function Dt(x,L){if(!x.length&&!L.length)return"";const O=new Date;let T=new Date(O.getFullYear(),O.getMonth()-1,1),z=new Date(O.getFullYear(),O.getMonth()+4,1);const P=H=>{if(!H)return;const ce=new Date(String(H).slice(0,10)+"T00:00:00");isNaN(ce.getTime())||(ce<T&&(T=new Date(ce.getFullYear(),ce.getMonth(),1)),ce>z&&(z=new Date(ce.getFullYear(),ce.getMonth(),1)))};x.forEach(H=>{P(H.pflanzDatum),P(H.ernteBis||H.ernteDatum),P(H.ernteVon)}),L.forEach(H=>P(H.planDatum||H.erledigtDatum));const N=bo(T,z),ue=N.length,pe=`background-size:${(100/ue).toFixed(4)}% 100%`,me=H=>H==null?null:(H*100).toFixed(2)+"%",J=Ke(N,O.toISOString()),G=J!=null?`<div class="ks-today" style="left:${me(J)}"></div>`:"",ae=N.map(H=>`<div class="ks-mo${H.y===O.getFullYear()&&H.m===O.getMonth()?" cur":""}">${go[H.m]}</div>`).join("");let fe="";x.forEach((H,ce)=>{const we=Ke(N,H.pflanzDatum);let se=Ke(N,H.ernteBis||H.ernteDatum||H.pflanzDatum);if(we==null)return;(se==null||se<=we)&&(se=Math.min(1,we+.5/ue));const Re=ga(H,ce);fe+=`<div class="ks-bar${H.status==="geplant"?" planned":""}" style="left:${me(we)};width:${((se-we)*100).toFixed(2)}%;--cc:${g(Re)}"><span>${g(H.kultur||"")}</span></div>`;const W=Ke(N,H.ernteVon),Z=Ke(N,H.ernteBis);W!=null&&Z!=null&&Z>W&&(fe+=`<div class="ks-harvest" style="left:${me(W)};width:${((Z-W)*100).toFixed(2)}%"></div>`)});const xe={};L.forEach(H=>{(xe[H.art]=xe[H.art]||[]).push(H)});const Be=Bd.filter(H=>xe[H]).map(H=>{const ce=Zn[H],we=xe[H].map(se=>{const Re=se.status==="erledigt"?se.erledigtDatum||se.planDatum:se.planDatum||se.erledigtDatum,W=Ke(N,Re);return W==null?"":`<span class="ks-mk${se.status==="erledigt"?" done":""}" title="${g(ce.label+(se.notes?": "+se.notes:""))}" style="left:${me(W)};--mc:${ce.color}"></span>`}).join("");return`<div class="ks-row"><div class="ks-rl">${g(ce.label)}</div><div class="ks-track" style="${pe}">${we}${G}</div></div>`}).join("");return`<div class="ks-wrap">
      <div class="ks-head"><div class="ks-rl"></div><div class="ks-axis">${ae}</div></div>
      <div class="ks-row"><div class="ks-rl">Kultur</div><div class="ks-track" style="${pe}">${fe}${G}</div></div>
      ${Be}
    ...
    </div>`}function xa(x){Ve("app",L=>({...L,activeSection:"acker"})),B.info("Karte geöffnet.")}async function ln(){if(!U()){B.warning("Keine Datenbank aktiv.");return}try{const x=await $i();await D(),ee(),x?.imported?(B.success(`${x.imported} übernommen.`),K()):B.info(`Nichts Neues${x?.skipped?` (${x.skipped} nicht zuordenbar)`:""}.`)}catch{B.error("Übernahme fehlgeschlagen.")}}async function ir(x){const L=r.find(O=>O.id===x);if(L)try{await Ai({...L,status:"erledigt",erledigtDatum:L.erledigtDatum||st()}),await D(),ee(),K()}catch{B.error("Speichern fehlgeschlagen.")}}async function cn(x){try{await zi({id:x}),await D(),ee(),K()}catch{B.error("Löschen fehlgeschlagen.")}}let ke=null;const $t=()=>{ke&&(ke.remove(),ke=null,document.removeEventListener("pointerdown",Xt,!0))},Xt=x=>{ke&&!ke.contains(x.target)&&$t()};function dn(x,L,O,T){if($t(),ke=document.createElement("div"),ke.className="km-ctx",T){const P=document.createElement("div");P.className="km-ctx-t",P.textContent=T,ke.appendChild(P)}O.forEach(P=>{if(P.sep){const ue=document.createElement("div");ue.className="km-ctx-sep",ke.appendChild(ue);return}const N=document.createElement("button");N.className="km-ctx-i",N.innerHTML=`<i class="bi ${P.icon}"></i><span>${g(P.label)}</span>`,N.addEventListener("click",()=>{$t(),P.action?.()}),ke.appendChild(N)}),document.body.appendChild(ke);const z=ke.getBoundingClientRect();ke.style.left=Math.max(8,Math.min(x,window.innerWidth-z.width-8))+"px",ke.style.top=Math.max(8,Math.min(L,window.innerHeight-z.height-8))+"px",setTimeout(()=>document.addEventListener("pointerdown",Xt,!0),0)}function ka(x,L,O){const T=F(x);if(!T)return;const z=he(n,T),{current:P}=la(z);dn(L,O,[{icon:"bi-flower2",label:P?"Kultur bearbeiten":"Kultur setzen",action:()=>ea(T,P,"current",z.length)},{icon:"bi-plus-lg",label:"Nächste Kultur planen",action:()=>ea(T,null,"next",z.length)},{icon:"bi-list-check",label:"Aufgabe planen",action:()=>wa(T,null,P)},{sep:!0},{icon:"bi-arrow-right-circle",label:"Fläche öffnen",action:()=>{o=x,ie("flaechen"),A()}},{icon:"bi-map",label:"Auf Karte",action:()=>xa()}],T.name)}function Ze(){v&&(v.remove(),v=null)}function un(x,L,O,T){Ze();const z=document.createElement("div");return z.className="kmodal-ov",z.innerHTML=`<div class="kmodal" role="dialog" aria-modal="true">
      ...
      ${L?'<button type="button" class="km-dangerlink" data-f="del"><i class="bi bi-trash"></i> Satz löschen</button>':""}`,G=un(L?"Satz bearbeiten":z?"Nächsten Satz planen":"Satz eintragen",J,"Speichern",W=>{const Z=Rt=>W.querySelector(`[data-f="${Rt}"]`)?.value?.trim()||"",Ne=Z("kultur");if(!Ne)return B.warning("Bitte eine Kultur angeben."),!1;const Sa=En(l,Ne),Ea=Z("aussaat")||null,Ht=Z("pflanz")||null,pn=Z("ernteVon")||null,ta=Z("ernteBis")||null,pt=Z("menge"),ge=pt?Number(pt):null,Qe=W.querySelector('[data-f="einheit"]')?.value||null,rt=!W.querySelector("[data-more-box]").hidden;let Ot=rt?Z("status"):"";Ot||(Ot=z||Ht&&Le(Ht)>Number(st().replace(/-/g,""))?"geplant":"aktiv");const _t=W.querySelector(".km-sw.on")?.dataset.col||P.color||Sa?.color||Gt[T%Gt.length],La=s.find(Rt=>Rt.kultur===Ne)?.eppoCode||Sa?.eppoCode||null,or=rt?Z("notes")||null:P.notes||null,Da={flaecheTyp:x.typ,flaecheId:x.id,kultur:Ne,eppoCode:La,color:_t,menge:ge,einheit:Qe,kulturStammId:Sa?.id||P.kulturStammId||null,notes:or},mn=!L&&W.querySelector('[data-f="succOn"]')?.checked,$a=Math.max(2,Math.min(20,Number(W.querySelector('[data-f="succN"]')?.value)||2)),aa=Math.max(1,Number(W.querySelector('[data-f="succGap"]')?.value)||14),fn=Number(st().replace(/-/g,""));(async()=>{try{if(mn){const Rt="sg-"+Date.now().toString(36)+Math.random().toString(36).slice(2,6),lr={aussaatDatum:Ea,pflanzDatum:Ht,ernteVon:pn,ernteBis:ta};for(let na=0;na<$a;na++){const za=Od(lr,na*aa),i=za.pflanzDatum&&Le(za.pflanzDatum)>fn?"geplant":Ot;await Pi({...Da,...za,ernteDatum:null,status:i,satzGruppe:Rt})}B.success(`${$a} Sätze angelegt.`)}else await Pi({id:L?.id,...Da,aussaatDatum:Ea,pflanzDatum:Ht,ernteVon:pn,ernteBis:ta,ernteDatum:null,status:Ot,satzGruppe:P.satzGruppe||null});await D(),ee(),K()}catch{B.error("Speichern fehlgeschlagen.")}})()});let ae="pflanz";const fe=W=>G.querySelector(`[data-f="${W}"]`),xe=G.querySelector("[data-anchor-row]"),Be=G.querySelector("[data-stammhint]");let H=N;const ce=()=>{if(!H){Be.hidden=!0,xe.style.opacity="0.45";return}xe.style.opacity="1";const Z=[Td[H.anbauMethode==="anzucht"?"anzucht":"direkt"].short];H.kulturTage&&Z.push(`${H.kulturTage} T. Kultur`),H.anbauMethode==="anzucht"&&H.anzuchtTage&&Z.push(`${H.anzuchtTage} T. Anzucht`),H.familie&&Z.push(H.familie),Be.innerHTML=`<i class="bi bi-stars"></i> <b>Bibliothek:</b> ${g(Z.join(" · "))}`,Be.hidden=!1},we=()=>{if(!H)return;const Z=fe(ae==="ernte"?"ernteVon":ae).value||st(),Ne=Hd(H,ae,Z);Ne.aussaatDatum!=null&&(fe("aussaat").value=Ne.aussaatDatum||""),Ne.pflanzDatum!=null&&(fe("pflanz").value=Ne.pflanzDatum||""),Ne.ernteVon!=null&&(fe("ernteVon").value=Ne.ernteVon||""),Ne.ernteBis!=null&&(fe("ernteBis").value=Ne.ernteBis||"")},se=fe("kultur");se.addEventListener("input",()=>{H=En(l,se.value),ce()}),se.addEventListener("change",()=>{H=En(l,se.value),ce(),H&&(fe("pflanz").value||(fe("pflanz").value=st()),we())}),G.querySelectorAll("[data-anchor]").forEach(W=>W.addEventListener("click",()=>{G.querySelectorAll("[data-anchorseg] .km-segb").forEach(Z=>Z.classList.remove("on")),W.classList.add("on"),ae=W.dataset.anchor,we()})),["aussaat","pflanz","ernteVon"].forEach(W=>fe(W)?.addEventListener("change",()=>{W===(ae==="ernte"?"ernteVon":ae)&&we()})),ce();const Re=G.querySelector('[data-f="succOn"]');Re?.addEventListener("change",()=>{G.querySelector("[data-succ-box]").hidden=!Re.checked}),G.querySelectorAll(".km-sw").forEach(W=>W.addEventListener("click",()=>{G.querySelectorAll(".km-sw").forEach(Z=>Z.classList.remove("on")),W.classList.add("on")})),G.querySelector('[data-f="del"]')?.addEventListener("click",async()=>{if(L?.id)try{await sl({id:L.id}),await D(),ee(),K(),Ze()}catch{B.error("Löschen fehlgeschlagen.")}})}function wa(x,L,O){const T=L||{art:"bewaesserung",status:"geplant"},z=tu.map(J=>`<button type="button" class="km-tile${(T.art||"bewaesserung")===J.art?" on":""}" data-art="${J.art}" style="--ac:${Zn[J.art].color}"><i class="bi ${J.icon}"></i><span>${g(J.label)}</span></button>`).join(""),P=(T.status||"geplant")==="erledigt",N=(P?T.erledigtDatum:T.planDatum)||st(),ue=`
      ...
      ${L?'<button type="button" class="km-dangerlink" data-f="del"><i class="bi bi-trash"></i> Aufgabe löschen</button>':""}`,pe=un(L?"Aufgabe bearbeiten":"Aufgabe hinzufügen",ue,"Speichern",J=>{const G=J.querySelector(".km-tile.on")?.dataset.art||"bewaesserung",ae=J.querySelector(".km-segb.on")?.dataset.status||"geplant",fe=J.querySelector('[data-f="datum"]').value||st(),xe=!J.querySelector("[data-more-box]").hidden,Be=ce=>{const we=J.querySelector(`[data-f="${ce}"]`)?.value;return we?Number(we):null},H=ce=>J.querySelector(`[data-f="${ce}"]`)?.value.trim()||null;(async()=>{try{await Ai({id:L?.id,flaecheTyp:x.typ,flaecheId:x.id,anbauId:L?.anbauId||O?.id||null,art:G,status:ae,planDatum:ae==="geplant"?fe:L?.planDatum||null,erledigtDatum:ae==="erledigt"?fe:null,menge:xe?Be("menge"):L?.menge??null,einheit:xe?H("einheit"):L?.einheit||null,mittel:xe?H("mittel"):L?.mittel||null,historyId:L?.historyId||null,notes:xe?H("notes"):L?.notes||null}),await D(),ee(),K()}catch{B.error("Speichern fehlgeschlagen.")}})()});pe.querySelectorAll(".km-tile").forEach(J=>J.addEventListener("click",()=>{pe.querySelectorAll(".km-tile").forEach(G=>G.classList.remove("on")),J.classList.add("on")})),pe.querySelectorAll(".km-segb").forEach(J=>J.addEventListener("click",()=>{pe.querySelectorAll(".km-segb").forEach(G=>G.classList.remove("on")),J.classList.add("on")}));const me=pe.querySelector('[data-f="datum"]');pe.querySelectorAll("[data-day]").forEach(J=>J.addEventListener("click",()=>{const G=J.dataset.day;if(G==="x"){me.style.display="inline-block",me.showPicker?.();return}const ae=new Date;ae.setDate(ae.getDate()+Number(G)),me.value=ae.toISOString().slice(0,10),me.style.display="none"})),pe.querySelector('[data-f="del"]')?.addEventListener("click",async()=>{if(L?.id)try{await zi({id:L.id}),await D(),ee(),K(),Ze()}catch{B.error("Löschen fehlgeschlagen.")}})}e.querySelectorAll(".km-modebtn").forEach(x=>x.addEventListener("click",()=>ie(x.dataset.mode))),document.addEventListener("keydown",x=>{x.key==="Escape"&&(v&&Ze(),$t())}),window.addEventListener("psm:openKultur",x=>{const L=x?.detail;!L?.typ||!L?.id||(o=L.typ+":"+L.id,ie("flaechen"),m&&(ut(),Ce(),A()))}),t.state.subscribe(x=>{x?.app?.activeSection==="kultur"&&(m?(async()=>(a=await vs(t),ee(),A()))():(m=!0,q()))}),te()}function ru(){return`
  <style>
  ...
  </section>`}const iu=["pflanzenschutz.json","history.json","entries.json"];let ys=!1,R=null,wt=!1;const Qt=25,Dr=new Intl.NumberFormat("de-DE");let De=0,Dn=null,xs=null;const su=Vs({id:"import",label:"Import-Vorschau",budget:{initialLoad:20,maxItems:50}});let Vr=null;function ou(){const e=document.createElement("div");return e.className="section-inner",e.innerHTML=`
    <div class="card card-dark">
  ...
  `,e}function lu(e){if(!e)return"-";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString("de-DE",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function cu(e,t){const a=e.querySelector('[data-role="import-log-list"]');if(a){if(!t.length){a.innerHTML='<tr><td colspan="5" class="text-muted small">Noch keine Importe protokolliert.</td></tr>';return}a.innerHTML=t.map(n=>{const r=n.rangeStart||n.rangeEnd?`${Va(n.rangeStart)||n.rangeStart||"?"} – ${Va(n.rangeEnd)||n.rangeEnd||"?"}`:"-",s=[n.source,n.device].filter(Boolean),l=s.length?g(s.join(" · ")):"-";return`
        ...
        </tr>`}).join("")}}async function Fn(e){if(de()==="sqlite")try{const t=await ol(50);cu(e,t.items||[])}catch(t){console.warn("Import-Historie konnte nicht geladen werden",t)}}function St(e,t,a="info"){const n=e.querySelector('[data-role="import-hint"]');if(n){if(!t){n.classList.add("d-none"),n.textContent="";return}n.className=`alert alert-${a} small mt-3`,n.textContent=t}}function Ut(e,t){const a=e.querySelector('[data-role="import-feedback"]');a&&(a.textContent=t)}function Ft(e){const t=e.querySelector('[data-action="clear-import"]'),a=e.querySelector('[data-action="focus-import"]'),n=e.querySelector('[data-action="run-import"]'),r=!!R;if(t&&(t.disabled=!r||wt),a&&(a.disabled=!r||wt),n){const s=!!(R?.importableEntries?.length&&R.stats||R?.fotos?.length);n.disabled=!r||!s||wt}}function du(e){R=null,yu(e);const t=e.querySelector('[data-role="import-summary-card"]'),a=e.querySelector('[data-role="import-file"]');t&&t.classList.add("d-none"),a&&(a.value=""),Ut(e,""),St(e,"Bereit für eine neue Importdatei."),Ft(e),ca()}function ho(e){if(e.dateIso)return e.dateIso;if(e.datum){const t=new Date(e.datum);if(!Number.isNaN(t.getTime()))return t.toISOString()}if(e.date){const t=new Date(e.date);if(!Number.isNaN(t.getTime()))return t.toISOString()}if(e.savedAt){const t=new Date(e.savedAt);if(!Number.isNaN(t.getTime()))return t.toISOString()}return null}function Qn(e){return e?Va(e)||e.slice(0,10):"-"}function vo(e){return e.savedAt||(e.savedAt=e.createdAt||e.dateIso||new Date().toISOString()),e}function ks(e,t){if(!e)return;const a=new Date(e);if(!Number.isNaN(a.getTime()))return t==="start"?a.setHours(0,0,0,0):a.setHours(23,59,59,999),a.toISOString()}function uu(e){if(!e||typeof e!="object")return null;const t={...e};if(!Array.isArray(t.items)){const a=e.items;t.items=Array.isArray(a)?[...a]:[]}return vo(t),t}function yo(e,t){const a=e.map(n=>ho(n)).filter(n=>!!n).sort();return{startIso:a[0]||t?.filters?.startDate||null,endIso:a[a.length-1]||t?.filters?.endDate||null}}function pu(e){if(!e)return;const t=ks(e.startIso,"start"),a=ks(e.endIso,"end");if(!t&&!a)return;const n={};return t&&(n.startDate=t),a&&(n.endDate=a),n}async function xo(e,t){if(de()!=="sqlite"){const o=je(e.history);return new Set(o.map(d=>Jn(d)).filter(d=>!!d))}const n=pu(t);if(!n)return new Set;const r=new Set;let s=1;const l=500;try{for(;;){const o=await Ts({page:s,pageSize:l,filters:n,sortDirection:"asc"});if(o.items.forEach(d=>{const m=Jn(d);m&&r.add(m)}),s*l>=o.totalCount)break;s+=1}}catch(o){return console.warn("Konnte vorhandene Einträge für Duplikatprüfung nicht laden",o),new Set}return r}function Jn(e){const t=typeof e.clientUuid=="string"&&e.clientUuid?e.clientUuid:"";if(t)return`uuid:${t}`;const a=e.savedAt||e.dateIso||e.createdAt||e.datum||"",n=e.ersteller||"",r=e.kultur||"",s=e.invekos||e.standort||"";return[a,n,r,s].join("|")}function mu(e,t,a,n){const r=n||yo(e,a),s=r.startIso,l=r.endIso,o=new Set,d=new Set;return t.forEach(m=>{m.ersteller&&o.add(m.ersteller),m.kultur&&d.add(m.kultur)}),{startDateLabel:Qn(s),endDateLabel:Qn(l),startDateRaw:s,endDateRaw:l,entryCount:e.length,importableCount:t.length,duplicateCount:e.length-t.length,creators:Array.from(o).slice(0,5),crops:Array.from(d).slice(0,5)}}function fu(e,t){const a=e.querySelector('[data-role="import-stats"]');if(!a)return;if(!t){a.innerHTML="";return}const n=t.stats,r=t.metadata?.filters;a.innerHTML=`
  ...
  `}function ko(e){const t=e.entries.length;if(!t)return De=0,{start:0,end:0,total:0};const a=Math.max(Math.ceil(t/Qt),1);De>=a&&(De=a-1),De<0&&(De=0);const n=De*Qt,r=Math.min(n+Qt,t);return{start:n,end:r,total:t}}function bu(e){const t=e.querySelector('[data-role="import-pager"]');return t?((!Dn||xs!==t)&&(Dn?.destroy(),Dn=nn(t,{onPrev:()=>hu(e),onNext:()=>vu(e),labels:{prev:"Zurück",next:"Weiter",loading:"Vorschau wird geladen...",empty:"Keine Einträge verfügbar"}}),xs=t),Dn):null}function Ua(e,t){const a=bu(e);if(!a)return;if(!t){De=0,a.update({status:"hidden"});return}const n=t.entries.length;if(!n){De=0,a.update({status:"disabled",info:"Keine Einträge vorhanden."});return}const{start:r,end:s}=ko(t),l=`Einträge ${Dr.format(r+1)}–${Dr.format(s)} von ${Dr.format(n)}`;a.update({status:"ready",info:l,canPrev:De>0,canNext:s<n})}function hu(e){!R||De===0||(De=Math.max(De-1,0),gi(e,R))}function vu(e){if(!R)return;const t=R.entries.length;if(!t)return;const a=Math.max(Math.ceil(t/Qt)-1,0);De>=a||(De=Math.min(De+1,a),gi(e,R))}function yu(e){De=0,e&&Ua(e,R)}function gi(e,t){const a=e.querySelector('[data-role="import-preview-table"]');if(!a){ca();return}if(!t){a.innerHTML="",Ua(e,null),ca();return}if(!t.entries.length){a.innerHTML='<tr><td colspan="5" class="text-center text-muted">Keine Einträge</td></tr>',Ua(e,t),ca();return}const{start:r,end:s}=ko(t),o=t.entries.slice(r,s).map(d=>{const m=Qn(ho(d));return`
        <tr>
          <td>${g(m)}</td>
          <td>${g(d.kultur||"-")}</td>
          <td>${g(d.ersteller||"-")}</td>
      ...
      `}).join("");a.innerHTML=o,Ua(e,t),ca()}async function xu(e){const t=dl(e),a=Object.keys(t),n=a.find(m=>iu.some(u=>m.toLowerCase().endsWith(u)));if(!n)throw new Error("ZIP enthält keine 'pflanzenschutz.json'.");const r=JSON.parse(zr(t[n])),s=a.find(m=>m.toLowerCase().endsWith("metadata.json")),l=s?JSON.parse(zr(t[s])):null,o=Array.isArray(r)?r:Array.isArray(r.entries)?r.entries:Array.isArray(r.history)?r.history:[],d=Array.isArray(r?.fotos)?r.fotos:[];for(const m of d){if(m?.data)continue;const u=m?.file?String(m.file):null,f=u?a.find(v=>v===u||v.toLowerCase().endsWith(u.toLowerCase())):null;f&&t[f]&&(m.data=ku(t[f]),m.mime||(m.mime="image/jpeg"))}return{entries:o,metadata:l,fotos:d}}function ku(e){let t="";for(let n=0;n<e.length;n+=32768)t+=String.fromCharCode(...e.subarray(n,n+32768));return btoa(t)}async function wu(e){const t=zr(e),a=JSON.parse(t);if(Array.isArray(a))return{entries:a,metadata:null,fotos:[]};const n=Array.isArray(a.fotos)?a.fotos:[];if(Array.isArray(a.entries))return{entries:a.entries,metadata:a.metadata||null,fotos:n};if(Array.isArray(a.history))return{entries:a.history,metadata:a.metadata||null,fotos:n};if(n.length)return{entries:[],metadata:a.metadata||null,fotos:n};throw new Error("JSON enthält keine Eintragsliste.")}async function Su(e,t){const a=new Uint8Array(await e.arrayBuffer()),n=/\.zip$/i.test(e.name)||e.type==="application/zip",{entries:r,metadata:s,fotos:l}=n?await xu(a):await wu(a),o=Array.isArray(l)?l:[],d=(Array.isArray(r)?r:[]).map(w=>uu(w)).filter(w=>!!w);if(!d.length&&!o.length)throw new Error("Die Datei enthielt keine verwertbaren Einträge.");const m=yo(d,s),u=await xo(t,m),f=new Set,v=[];let k=0;d.forEach(w=>{const E=Jn(w);if(!E){v.push(w);return}if(u.has(E)||f.has(E)){k+=1;return}f.add(E),v.push(w)});const h=mu(d,v,s,m),S=[];return k&&S.push(`${k} Datensätze wurden wegen gleicher Kennung übersprungen.`),(!h.startDateRaw||!h.endDateRaw)&&S.push("Zeitraum konnte nicht eindeutig ermittelt werden."),{filename:e.name,entries:d,importableEntries:v,metadata:s,stats:h,warnings:S,lastImportRefs:[],fotos:o}}function ws(){if(!R)return"Keine Datei";const e=[];return wt&&e.push("Verarbeitung"),R.warnings.length&&e.push("Warnungen"),R.stats.importableCount<R.stats.entryCount&&e.push("Duplikate entfernt"),e.length?e.join(" · "):void 0}function Eu(){const e=!!R,t=e?Math.max(Math.ceil((R?.entries.length||0)/Qt),1):null,a=e?{items:R?.entries.length??0,totalCount:R?.stats.entryCount??null,cursor:R&&(R.entries.length||0)>Qt?`Seite ${De+1}${t?` / ${t}`:""}`:null,payloadKb:Qs(R?.entries.slice(0,Qt)),lastUpdated:Vr,note:ws()}:{items:0,totalCount:0,cursor:null,payloadKb:0,lastUpdated:Vr,note:ws()};Zs(su,a)}function ca(){Vr=new Date().toISOString(),Eu()}function Zr(e){const t=e.querySelector('[data-role="import-summary-card"]');if(!t)return;if(!R){t.classList.add("d-none"),Ua(e,null),Ft(e),ca();return}t.classList.remove("d-none"),De=0;const a=t.querySelector('[data-role="import-file-name"]'),n=t.querySelector('[data-role="import-summary-subline"]');a&&(a.textContent=R.filename),n&&(n.textContent=`${R.stats.importableCount} von ${R.stats.entryCount} Einträgen importierbar`),fu(e,R),gu(e,R),gi(e,R),Ft(e)}async function Lu(){const e=de();if(!e||e==="memory"||e==="sqlite")return;const t=Ye();await Xe(t)}function Ss(e,t){if(!t.length)return[];const a=typeof e.state.updateSlice=="function"?e.state.updateSlice:Ve,n=[];return a("history",r=>{const s=tn(r),l=s.items.slice(),o=l.length;return t.forEach((d,m)=>{n.push(o+m),l.push(d)}),{...s,items:l,totalCount:l.length,lastUpdatedAt:new Date().toISOString()}}),n}async function Du(e,t){if(!R){window.alert("Bitte zuerst eine Importdatei laden.");return}const a=R.fotos||[];if(!R.importableEntries.length&&!a.length){window.alert("Alle Einträge wurden bereits importiert oder als Duplikat erkannt.");return}wt=!0,Ft(e),Ut(e,"Import läuft ...");const n=t.state.getState(),r={startIso:R.stats.startDateRaw,endIso:R.stats.endDateRaw};let s=new Set;try{s=await xo(n,r)}catch(S){console.warn("Duplikatprüfung vor Import fehlgeschlagen",S)}const l=new Set(s),o=[];let d=0;if(R.importableEntries.forEach(S=>{const w=Jn(S);if(w&&l.has(w)){d+=1;return}w&&l.add(w),o.push(S)}),!o.length&&!a.length){Ut(e,"Keine neuen Einträge gefunden."),St(e,"Alle Datensätze sind bereits importiert worden.","warning"),wt=!1,Ft(e);return}const m=de(),u=[],f=[];let v=0,k=0;const h=o.map(S=>vo({...S}));try{if(m==="sqlite"){const I=[];for(const U of h)try{const K=await Ds(U);if(K?.duplicate){d+=1;continue}K?.id!=null&&(u.push({source:"sqlite",ref:K.id}),I.push(U))}catch(K){console.error("appendHistoryEntry failed",K),f.push(U.savedAt||"Unbekannter Eintrag")}Ss(t,I);for(const U of a)try{(await ll(U))?.duplicate?k+=1:v+=1}catch(K){console.error("appendFoto failed",K)}v&&window.dispatchEvent(new CustomEvent("fotos:changed"));try{await tt()}catch(U){console.warn("SQLite-Datei konnte nach dem Import nicht gespeichert werden",U)}}else Ss(t,h).forEach(U=>{u.push({source:"state",ref:U})}),await Lu();const S=u.length;if(S||v){m==="sqlite"&&S&&t.events?.emit?.("history:data-changed",{type:"created-bulk",count:S});const I=[];S&&I.push(`${S} Einträge`),v&&I.push(`${v} Foto(s)`),Ut(e,`${I.join(" und ")} importiert.${f.length?` ${f.length} Einträge konnten nicht übernommen werden.`:""}`.trim()),R.lastImportRefs=u,R.importableEntries=[],R.stats={...R.stats,importableCount:0},Zr(e)}else Ut(e,"Keine neuen Daten importiert.");const w=[];let E="success";if(f.length&&(w.push(`${f.length} Einträge konnten nicht gespeichert werden. Details siehe Konsole.`),E="warning"),d&&(w.push(`${d} Einträge wurden während des Imports als Duplikat übersprungen.`),E="warning"),k&&w.push(`${k} Foto(s) waren bereits vorhanden (übersprungen).`),w.length||w.push("Import abgeschlossen."),St(e,w.join(" "),E),m==="sqlite"&&(S||d||v||k))try{const I=[];f.length&&I.push(`${f.length} fehlgeschlagen`),v&&I.push(`${v} Fotos`),k&&I.push(`${k} Fotos doppelt`),await cl({source:R.filename||null,device:R.metadata?.device||R.metadata?.label||null,added:S,skipped:d,rangeStart:R.stats.startDateRaw,rangeEnd:R.stats.endDateRaw,note:I.length?I.join(", "):null}),await tt().catch(()=>{}),await Fn(e)}catch(I){console.warn("Import-Historie konnte nicht geschrieben werden",I)}}catch(S){console.error("Import fehlgeschlagen",S),Ut(e,"Import fehlgeschlagen. Siehe Konsole für Details."),St(e,"Import fehlgeschlagen. Bitte erneut versuchen.","danger")}finally{wt=!1,Ft(e)}}function $u(e,t,a){if(!e.events?.emit)return;const n=t.metadata?.label||t.metadata?.filters?.label||`Import ${t.filename}`;e.events.emit("documentation:focus-range",{startDate:t.stats.startDateRaw||void 0,endDate:t.stats.endDateRaw||void 0,label:n,reason:"import",entryIds:a,autoSelectFirst:!!a.length})}function zu(e,t){if(!R){window.alert("Bitte zuerst eine Importdatei laden.");return}if(!R.stats.startDateRaw||!R.stats.endDateRaw){window.alert("Zeitraum konnte nicht bestimmt werden.");return}$u(t,R,R.lastImportRefs),St(e,"Dokumentation wurde auf den Importzeitraum fokussiert.")}function Au(e,t){const a=e.querySelector('[data-role="import-file"]');a&&a.addEventListener("change",()=>{const n=a.files?.[0];n&&(wt=!0,St(e,"Datei wird analysiert ..."),Ft(e),Ut(e,""),Su(n,t.state.getState()).then(r=>{R=r,Zr(e),St(e,`${r.importableEntries.length} Einträge bereit zum Import.`)}).catch(r=>{console.error("Importdatei konnte nicht gelesen werden",r),St(e,r?.message||"Importdatei konnte nicht gelesen werden.","danger"),R=null,Zr(e)}).finally(()=>{wt=!1,Ft(e)}))}),e.addEventListener("click",n=>{const r=n.target?.closest("[data-action]");if(!r)return;const s=r.dataset.action;if(s){if(s==="clear-import"){du(e);return}if(s==="focus-import"){zu(e,t);return}s==="run-import"&&Du(e,t)}})}function Pu(e,t){if(!e||ys)return;const a=e;a.innerHTML="";const n=ou();a.appendChild(n),Au(n,t),St(n,"Wähle eine Datei aus, um den Import zu starten."),Fn(n),ct("database:connected",()=>void Fn(n)),ct("app:sectionChanged",r=>{(r==="daten"||r==="documentation"||r==="import")&&Fn(n)}),ys=!0}const jt=(e,t=0)=>Number.isFinite(e)?e.toLocaleString("de-DE",{minimumFractionDigits:t,maximumFractionDigits:t}):"–";function Mu(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString("de-DE")}function ia(e,t,a,n){return`
  ...
  </section>`}function Iu(e,t){if(!(e instanceof HTMLElement))return;e.innerHTML=Cu();const a=e.querySelector('[data-role="dash-cards"]'),n=e.querySelector('[data-role="dash-warn"]'),r=e.querySelector('[data-role="dash-recent"]');e.addEventListener("click",l=>{const o=l.target?.closest("[data-goto]");if(!o)return;const d=o.getAttribute("data-goto");d&&t.state.updateSlice("app",m=>({...m,activeSection:d}))});const s=async()=>{if(de()!=="sqlite"){a&&(a.innerHTML='<div class="dash-empty">Bitte zuerst eine Datenbank öffnen.</div>');return}const l=t.state.getState(),o=(je(l.gps?.points)||[]).length;let d=0,m=0,u=0,f=0,v=[],k=[],h=0;try{d=(await Qr())?.rows?.length||0}catch{}try{m=(await Fs())?.rows?.length||0}catch{}try{const S=(await Jr())?.rows||[];u=S.length,f=S.reduce((w,E)=>w+(E.plants||0),0)}catch{}try{v=(await Ns())?.rows||[]}catch{}try{const S=await Ts({}),w=S?.entries||S?.rows||[];h=S?.totalCount??w.length,k=w.slice(0,6)}catch{}if(a&&(a.innerHTML=[ia("bi-geo-alt","Standorte",jt(o)),ia("bi-flower1","Kulturen",jt(d)),ia("bi-droplet","Mittel im Sortiment",jt(m),"lager"),ia("bi-journal-check","Anwendungen",jt(h),"documentation"),ia("bi-map","Acker-Flächen",jt(u),"acker"),ia("bi-flower3","Pflanzen (Acker)",jt(f),"acker")].join("")),n){const S=[];v.forEach(E=>{E.bestand<=0&&(E.verbraucht>0||E.zugang>0)&&S.push(`<div class="dash-row"><span><i class="bi bi-box-seam me-1" style="color:#ef4444"></i>${g(E.name)}</span><span style="color:#ef4444">Bestand ${jt(E.bestand)} ${g(E.einheit||"")}</span></div>`)}),v.forEach(E=>{if(!E.zulEnde)return;const I=Math.round((new Date(E.zulEnde).getTime()-Date.now())/864e5);I<0?S.push(`<div class="dash-row"><span><i class="bi bi-calendar-x me-1" style="color:#ef4444"></i>${g(E.name)}</span><span style="color:#ef4444">Zulassung abgelaufen</span></div>`):I<180&&S.push(`<div class="dash-row"><span><i class="bi bi-calendar-event me-1" style="color:#f59e0b"></i>${g(E.name)}</span><span style="color:#f59e0b">Zulassung endet in ${I} T</span></div>`)});const w=S.length>6?`<div class="dash-row" style="color:var(--color-text-muted)"><span>+ ${S.length-6} weitere</span></div>`:"";n.innerHTML=S.length?S.slice(0,6).join("")+w:'<div class="dash-empty">Alles im grünen Bereich. ✓</div>'}r&&(r.innerHTML=k.length?k.map(S=>{const w=Mu(S.datum||S.dateIso||S.created_at||S.createdAt||null),E=S.kultur||"",I=S.standort||"";return`<div class="dash-row"><span>${g(I)}${E?" · "+g(E):""}</span><span class="dash-empty" style="padding:0">${g(w)}</span></div>`}).join(""):'<div class="dash-empty">Noch keine Anwendungen erfasst.</div>')};t.state.subscribe(l=>{l?.app?.activeSection==="dashboard"&&s()}),s()}function Es(e){document.querySelectorAll(".content-section").forEach(a=>{a.style.display="none"});const t=document.getElementById(`section-${e}`);t instanceof HTMLElement&&(t.style.display="block")}function Ls(){ul(),zs();const e={state:{getState:j,updateSlice:Ve,subscribe:qn},events:{emit:(w,E)=>{It(async()=>{const{emit:I}=await import("./index.CA5PA6Pp.js").then(U=>U.aS);return{emit:I}},[]).then(({emit:I})=>{I(w,E)})},subscribe:ct}},t=document.querySelector('[data-region="startup"]'),a=document.querySelector('[data-region="shell"]'),n=document.querySelector('[data-region="main"]'),r=document.querySelector('[data-region="footer"]');Rl(t,e);const s=document.querySelector('[data-feature="calculation"]');pl(s,e);const l=document.querySelector('[data-feature="documentation"]');qc(l,e);const o=document.querySelector('[data-feature="settings"]');Pd(o,e);const d=document.querySelector('[data-feature="lager"]');Id(d,e);const m=document.querySelector('[data-feature="acker"]');Rd(m,e);const u=document.querySelector('[data-feature="kultur"]');nu(u,e);const f=document.querySelector('[data-feature="fotos"]');ml(f,e,{archiveMode:!0});const v=document.querySelector('[data-feature="import-page"]');Pu(v,{state:{getState:j,updateSlice:Ve},events:e.events});const k=document.querySelector('[data-feature="dashboard"]');Iu(k,e);const h=w=>{const E=document.body;E&&(E.classList.toggle("bg-app",w),E.classList.toggle("bg-startup",!w))},S=w=>{const E=!!w.app?.hasDatabase;if(h(E),t instanceof HTMLElement&&t.classList.toggle("d-none",E),a instanceof HTMLElement&&a.classList.toggle("d-none",!E),n instanceof HTMLElement&&n.classList.toggle("d-none",!E),r instanceof HTMLElement&&r.classList.toggle("d-none",!E),E){const I=w.app?.activeSection??"dashboard";Es(I)}};S(e.state.getState()),qn((w,E)=>{w.app?.hasDatabase!==E.app?.hasDatabase&&S(w),w.app?.activeSection!==E.app?.activeSection&&w.app?.hasDatabase&&Es(w.app.activeSection)}),ct("app:sectionChanged",()=>{})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ls,{once:!0}):Ls();
